...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E03BC73503
	for <lists+freedreno@lfdr.de>; Wed, 24 Jul 2019 19:17:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7644D6E56E;
...
Subject: Re: [Freedreno] [PATCH v5 17/24] drm/mgag200: Provide ddc symlink
...
Content-Type: multipart/mixed; boundary="===============0253291927=="
