...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45D4057A4D5
	for <lists+freedreno@lfdr.de>; Tue, 19 Jul 2022 19:18:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0446890FA4;
...
Subject: [Freedreno] [PATCH v2 03/13] drm/msm: Split out idr_lock
