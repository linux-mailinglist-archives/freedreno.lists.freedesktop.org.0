...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A6464FA0D1
	for <lists+freedreno@lfdr.de>; Sat,  9 Apr 2022 02:54:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F46E10F245;
...
Subject: [Freedreno] [PATCH v7 2/4] drm: introduce
