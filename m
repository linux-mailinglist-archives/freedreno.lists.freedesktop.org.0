...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DE144D2E2F
	for <lists+freedreno@lfdr.de>; Wed,  9 Mar 2022 12:36:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A226510E483;
...
Subject: Re: [Freedreno] [PATCH v1 06/10] drm/msm/a6xx: Propagate OOB set
 error
