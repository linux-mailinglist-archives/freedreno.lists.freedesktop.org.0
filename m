...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 05A12176A6B
	for <lists+freedreno@lfdr.de>; Tue,  3 Mar 2020 03:03:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB9EE6E044;
...
Subject: Re: [Freedreno] [PATCH v4 1/2] dt-bindings: display: msm: Convert
