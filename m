...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC2B445CF21
	for <lists+freedreno@lfdr.de>; Wed, 24 Nov 2021 22:37:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7B4D6EDBE;
...
Subject: [Freedreno] [PATCH 0/7] drm/msm: Improve GMU debugging
