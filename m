...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B1AE14D578C
	for <lists+freedreno@lfdr.de>; Fri, 11 Mar 2022 02:50:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 07BC710E65E;
...
Subject: [Freedreno] [PATCH 2/6] drm/komeda: use drm_encoder pointer for
