...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4587A292FA8
	for <lists+freedreno@lfdr.de>; Mon, 19 Oct 2020 22:45:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD00D6EA94;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 01/23] drm/msm: Fix a couple incorrect usages
 of get_vaddr_active()
