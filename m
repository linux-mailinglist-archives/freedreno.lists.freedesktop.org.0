...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F67C570377
	for <lists+freedreno@lfdr.de>; Mon, 11 Jul 2022 14:57:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1B568E533;
...
Subject: [Freedreno] [PATCH v6 06/10] drm/bridge: use atomic enable/disable
