...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84C836534CF
	for <lists+freedreno@lfdr.de>; Wed, 21 Dec 2022 18:15:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B6D810E473;
	Wed, 21 Dec 2022 17:14:56 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v4 4/5] drm/msm/a6xx: Remove cx gdsc polling
 using 'reset'
