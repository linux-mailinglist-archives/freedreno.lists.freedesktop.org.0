...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A36596181FE
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:17:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 533AB10E694;
...
Subject: [Freedreno] [PATCH v3 12/23] drm/fb_helper: Rename field fbdev to
