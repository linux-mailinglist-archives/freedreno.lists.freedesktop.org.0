...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F3792F8057
	for <lists+freedreno@lfdr.de>; Fri, 15 Jan 2021 17:12:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 940FF6E459;
	Fri, 15 Jan 2021 16:12:41 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from new1-smtp.messagingengine.com (new1-smtp.messagingengine.com
 [66.111.4.221])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0BCF489D02
 for <freedreno@lists.freedesktop.org>; Fri, 15 Jan 2021 13:16:04 +0000 (UTC)
Received: from compute6.internal (compute6.nyi.internal [10.202.2.46])
 by mailnew.nyi.internal (Postfix) with ESMTP id BF4205807B3;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
 ...
 fm1; bh=XOaKcu9p4ZkelvDHPLJieyuR1LS0kjlNO/86GR0mzW4=; b=NXtOAnki
 
X-ME-Sender: <xms:NpEBYD_LL8phtKpSUBJK5WmX-rZlTKFSy6FZ52H_fqF_aBI5jrhdnQ>
 <xme:NpEBYPs__k6p8RCrvkcSP6cfp1FP9YFMBeVAVLbYFNwKxMyfoiiAnAPHBPTOBvvB8
 mi-0lJ2D9A7vxyKLKc>
...
X-ME-Proxy: <xmx:NpEBYBAYgay_-1o2-fD6o476wVjNmoSellxHSs9SIZG3bdkTOJMykQ>
 <xmx:NpEBYPcKOcIubyw1cEcAfJP30zR5QMVxBBHpR7ZJQIA9fVNdu9HQOA>
 <xmx:NpEBYINZG3yaBlI0IXG-FRytI09G2dawjTDFnsxhH4r7ghSKG7Kwyg>
 <xmx:NpEBYOGfzRM8h6QbDV2MhAUcSzzbZnkkpNH_GjA_KG4fF2RAPEfsMA>
...
MIME-Version: 1.0
X-Mailman-Approved-At: Fri, 15 Jan 2021 16:12:40 +0000
Subject: [Freedreno] [PATCH 08/10] drm: Rename plane->state variables in
 atomic update and disable
...
Cc: =?UTF-8?q?Heiko=20St=C3=BCbner?= <heiko@sntech.de>,
 ...
 Daniel Vetter <daniel@ffwll.ch>, Alexandre Torgue <alexandre.torgue@st.com>,
