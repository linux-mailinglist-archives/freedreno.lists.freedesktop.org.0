...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19E56320C84
	for <lists+freedreno@lfdr.de>; Sun, 21 Feb 2021 19:22:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E9D46E42A;
...
Subject: Re: [Freedreno] [PATCH 19/30] drm/dp: Pass drm_dp_aux to
