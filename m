...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A645673BB1
	for <lists+freedreno@lfdr.de>; Thu, 19 Jan 2023 15:27:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85FF410E953;
	Thu, 19 Jan 2023 14:27:00 +0000 (UTC)
...
Subject: [Freedreno] [PATCH Resend v11 01/15] drm: add helper functions to
