...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 550523FF1B9
	for <lists+freedreno@lfdr.de>; Thu,  2 Sep 2021 18:43:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D86FB6E7D5;
...
Subject: [Freedreno] [PATCH 2/2] drm/msm/mdp5: Add configuration for MDP
 v1.16
