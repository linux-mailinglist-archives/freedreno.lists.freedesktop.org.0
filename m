...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C51B871F5A6
	for <lists+freedreno@lfdr.de>; Fri,  2 Jun 2023 00:09:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94A8710E5EB;
...
Subject: [Freedreno] [PATCH v2 2/2] drm/msm/dpu: remove struct
