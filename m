...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 286645189CF
	for <lists+freedreno@lfdr.de>; Tue,  3 May 2022 18:25:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A031110FD25;
...
Subject: [Freedreno] [PATCH v3] drm/msm/dp: fix event thread stuck in
