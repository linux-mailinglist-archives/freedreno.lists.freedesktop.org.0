...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5AA835093C8
	for <lists+freedreno@lfdr.de>; Thu, 21 Apr 2022 01:50:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C67DD10F2C7;
...
Subject: [Freedreno] [PATCH v3 08/18] drm/msm/dpu: add writeback blocks to
 DPU RM
