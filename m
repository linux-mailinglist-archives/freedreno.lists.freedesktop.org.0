...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E8757BC144
	for <lists+freedreno@lfdr.de>; Fri,  6 Oct 2023 23:39:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96A8C10E574;
...
Subject: [Freedreno] [PATCH v6 4/7] drm/msm/dp: move parser->parse() and
