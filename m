...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6BD43586FF
	for <lists+freedreno@lfdr.de>; Thu,  8 Apr 2021 16:20:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3909B6EB08;
...
Subject: Re: [Freedreno] [PATCH v15 1/4] dt-bindings: msm: disp: add yaml
