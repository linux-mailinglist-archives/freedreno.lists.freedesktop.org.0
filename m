...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83491678497
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:25:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CDA810E535;
...
Subject: [Freedreno] [PATCH v1 03/14] drm/msm/dp: add configure
