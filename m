...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A25DF71669C
	for <lists+freedreno@lfdr.de>; Tue, 30 May 2023 17:13:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB9D710E406;
...
Subject: [Freedreno] [PATCH v5 11/13] drm/msm: Use regular fbdev I/O helpers
