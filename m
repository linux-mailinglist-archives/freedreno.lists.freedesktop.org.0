...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E2636E028B
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 01:27:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A811410E9F1;
	Wed, 12 Apr 2023 23:27:28 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v6 1/7] drm/msm/dsi: use new helpers for DSC
 setup
