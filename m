...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1418CECFCE
	for <lists+freedreno@lfdr.de>; Sat,  2 Nov 2019 17:53:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE1DA6E122;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 HETA==
Subject: Re: [Freedreno] [PATCH v4 2/7] dt-bindings: msm/mdp5: Document
 optional TBU and TBU_RT clocks
