...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D2126B16D0
	for <lists+freedreno@lfdr.de>; Thu,  9 Mar 2023 00:51:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EF3B10E764;
...
Subject: Re: [Freedreno] [PATCH v4 10/11] arm64: dts: qcom: sm8350-hdk:
