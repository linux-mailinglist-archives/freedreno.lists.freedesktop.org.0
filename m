...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 046FC74A4DE
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 22:28:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7535D10E4B3;
...
Subject: [Freedreno] [PATCH v3 2/6] drm/msm/dpu: Drop unused num argument
