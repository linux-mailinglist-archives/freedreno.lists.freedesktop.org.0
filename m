...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C95B372A66E
	for <lists+freedreno@lfdr.de>; Sat, 10 Jun 2023 01:01:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B58E110E0EC;
...
Subject: [Freedreno] [PATCH v6 3/6] drm/msm/dpu: Add DPU_INTF_DATA_COMPRESS
