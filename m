...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1D3A7D9E4D
	for <lists+freedreno@lfdr.de>; Fri, 27 Oct 2023 18:59:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E432410EA18;
...
Subject: [Freedreno] [PATCH 2/7] drm/msm/gem: Remove submit_unlock_unpin_bo()
