...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A5DD5093D3
	for <lists+freedreno@lfdr.de>; Thu, 21 Apr 2022 01:50:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5FADE10ED91;
...
Subject: [Freedreno] [PATCH v3 16/18] drm/msm/dpu: initialize dpu encoder
