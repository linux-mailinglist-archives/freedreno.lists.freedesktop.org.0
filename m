...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05BCE64BFAD
	for <lists+freedreno@lfdr.de>; Tue, 13 Dec 2022 23:56:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B9AD10E371;
	Tue, 13 Dec 2022 22:56:48 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v13 0/5] Add data-lanes and link-frequencies to
 dp_out endpoint
