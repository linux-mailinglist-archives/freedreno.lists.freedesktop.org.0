...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C34C354C08
	for <lists+freedreno@lfdr.de>; Tue,  6 Apr 2021 07:10:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 130B3899DB;
...
Subject: [Freedreno] [PATCH v1 1/4] drm/msm/disp/dpu1: add support for
 display for SC7280 target
