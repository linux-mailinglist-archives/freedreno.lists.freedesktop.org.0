...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D35C13E811
	for <lists+freedreno@lfdr.de>; Thu, 16 Jan 2020 18:30:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E63996EE4A;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.14 322/371] drm/msm/dsi: Implement
 reset correctly
