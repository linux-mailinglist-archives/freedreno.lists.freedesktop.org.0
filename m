...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28ACC452A87
	for <lists+freedreno@lfdr.de>; Tue, 16 Nov 2021 07:23:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8BE86EA21;
...
Subject: [Freedreno] [PATCH v3 06/13] drm/msm/disp/dpu1: Add DSC support in
 hw_ctl
