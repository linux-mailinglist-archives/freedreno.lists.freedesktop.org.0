...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A533A6543BA
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:06:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A79210E548;
...
Subject: [Freedreno] [PATCH v10 08/15] drm/bridge: add psr support for panel
 bridge callbacks
