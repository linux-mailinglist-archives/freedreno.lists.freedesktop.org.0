...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFB1D70F271
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 11:22:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DA2010E636;
...
Subject: [Freedreno] [PATCH v4 07/13] drm/fbdev-dma: Use regular fbdev I/O
 helpers
