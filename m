...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C715060E752
	for <lists+freedreno@lfdr.de>; Wed, 26 Oct 2022 20:29:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7051510E6F3;
...
Subject: [Freedreno] [PATCH v4 06/10] drm/msm/dsi: Migrate to
