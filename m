...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D3BA2E8CD8
	for <lists+freedreno@lfdr.de>; Sun,  3 Jan 2021 16:25:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4FB7899E7;
...
Subject: [Freedreno] [PATCH 26/31] PM / devfreq: tegra30: convert to use
 devm_pm_opp_* API
