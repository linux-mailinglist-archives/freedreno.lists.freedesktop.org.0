...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A940D507E61
	for <lists+freedreno@lfdr.de>; Wed, 20 Apr 2022 03:46:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF84C10F03F;
...
Subject: [Freedreno] [PATCH v2 04/17] drm/msm/dpu: add writeback blocks to
