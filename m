...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7024143FC59
	for <lists+freedreno@lfdr.de>; Fri, 29 Oct 2021 14:30:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D0476E10B;
	Fri, 29 Oct 2021 12:30:40 +0000 (UTC)
...
In-Reply-To: <y>
References: <y>
Subject: [Freedreno] [v2] drm/msm/disp/dpu1: set default group ID for CTL.
