...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C45102EAF7B
	for <lists+freedreno@lfdr.de>; Tue,  5 Jan 2021 16:56:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 717EF6E1BC;
...
Subject: Re: [Freedreno] [PATCH 30/31] PM / devfreq: exynos: convert to use
 devm_pm_opp_* API
