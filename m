...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02C4A771D9B
	for <lists+freedreno@lfdr.de>; Mon,  7 Aug 2023 11:56:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 39A7E10E062;
	Mon,  7 Aug 2023 09:56:13 +0000 (UTC)
...
Subject: Re: [Freedreno] [RFC] PM / QoS: Decouple request alloc from
 dev_pm_qos_mtx (alternative solution)
