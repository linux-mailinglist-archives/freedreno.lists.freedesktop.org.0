...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E697C806157
	for <lists+freedreno@lfdr.de>; Tue,  5 Dec 2023 23:05:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A49B210E633;
...
Subject: [Freedreno] [PATCH 1/5] drm/msm/adreno: Split up giant device table
