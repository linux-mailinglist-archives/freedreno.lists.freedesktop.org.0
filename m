...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A65872E69A
	for <lists+freedreno@lfdr.de>; Tue, 13 Jun 2023 17:04:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CBD710E39C;
...
Subject: [Freedreno] [PATCH 1/2] drm/msm: Initialize mmap offset after
 constructing the buffer object
