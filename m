...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A9C350CEDF
	for <lists+freedreno@lfdr.de>; Sun, 24 Apr 2022 05:24:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B49C911273D;
...
Subject: [Freedreno] [PATCH v2] drm/msm/dp: fix error check return value of
...
Cc: sean@poorly.run, quic_abhinavk@quicinc.com, airlied@linux.ie,
 ...
 robdclark@gmail.com, linux-arm-msm@vger.kernel.org, swboyd@chromium.org,
