...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE7742599F8
	for <lists+freedreno@lfdr.de>; Tue,  1 Sep 2020 18:46:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 833436E880;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v16 00/20] iommu/arm-smmu + drm/msm: per-process
 GPU pgtables
