...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B26B643924
	for <lists+freedreno@lfdr.de>; Tue,  6 Dec 2022 00:09:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8914910E2C1;
...
Subject: [Freedreno] [PATCH v9 4/5] drm/msm/dp: parser link-frequencies as
