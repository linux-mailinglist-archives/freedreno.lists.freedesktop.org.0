...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B61560A152
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:22:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BABB10E486;
...
Subject: [Freedreno] [PATCH v2 12/21] drm/fb_helper: Rename field fbdev to
