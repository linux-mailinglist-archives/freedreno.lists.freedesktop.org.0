...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90D2170F230
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 11:22:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C01D10E5DD;
...
Subject: [Freedreno] [PATCH v4 04/13] drm/exynos: Use regular fbdev I/O
 helpers
