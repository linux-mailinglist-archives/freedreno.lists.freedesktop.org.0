...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A0A652F42C
	for <lists+freedreno@lfdr.de>; Fri, 20 May 2022 22:06:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD02210E11E;
...
Subject: [Freedreno] [PATCH v9 1/3] phy: qcom-edp: add regulator_set_load to
 edp phy
