...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 346444ECE34
	for <lists+freedreno@lfdr.de>; Wed, 30 Mar 2022 22:48:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F92F10E95F;
...
Subject: [Freedreno] [PATCH v2 03/10] drm/msm/gem: Convert some missed
 GEM_WARN_ON()s
