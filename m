...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38B92711291
	for <lists+freedreno@lfdr.de>; Thu, 25 May 2023 19:41:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6FC7C10E72B;
...
Subject: [Freedreno] [PATCH v14 04/10] drm/msm/dpu: Guard PINGPONG DSC ops
