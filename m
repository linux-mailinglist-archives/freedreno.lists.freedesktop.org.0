...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9371ACDA3D
	for <lists+freedreno@lfdr.de>; Mon,  7 Oct 2019 03:45:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9713289CDB;
...
Subject: [Freedreno] [PATCH RFC v2 3/5] ARM: dts: qcom: pm8941: add 5vs2
 regulator node
