...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 704C572EF0A
	for <lists+freedreno@lfdr.de>; Wed, 14 Jun 2023 00:19:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C13BD10E3E8;
	Tue, 13 Jun 2023 22:19:23 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 1/2] drm/msm/dpu: retrieve DSI DSC struct
 through priv->dsi[0]
