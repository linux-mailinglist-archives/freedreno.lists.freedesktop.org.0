...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51D6F4A38C4
	for <lists+freedreno@lfdr.de>; Sun, 30 Jan 2022 20:56:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D43A5113819;
...
Subject: [Freedreno] [v4 3/3] drm/msm/dsi: Add 10nm dsi phy tuning
