...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74A10169C5
	for <lists+freedreno@lfdr.de>; Tue,  7 May 2019 20:02:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 043946E81E;
...
Subject: [Freedreno] [PATCH v1 2/3] drm/msm: Print all 64 bits of the
