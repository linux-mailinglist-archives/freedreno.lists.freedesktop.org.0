...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4ABA57093C
	for <lists+freedreno@lfdr.de>; Mon, 11 Jul 2022 19:41:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BCB99032F;
...
Subject: Re: [Freedreno] [PATCH v2 1/4] drm/mipi-dsi: pass DSC data through
