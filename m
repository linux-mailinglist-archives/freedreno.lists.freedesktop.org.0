...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 53F4741EE05
	for <lists+freedreno@lfdr.de>; Fri,  1 Oct 2021 14:59:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2A0A6ECB5;
	Fri,  1 Oct 2021 12:59:25 +0000 (UTC)
...
Subject: [Freedreno] [PATCH] drm/msm/a3xx: fix error handling in
 a3xx_gpu_init()
