...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB98B708C4D
	for <lists+freedreno@lfdr.de>; Fri, 19 May 2023 01:34:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DC4E10E580;
...
Subject: [Freedreno] [PATCH v11 1/9] drm/msm/dpu: add dsc blocks to the
