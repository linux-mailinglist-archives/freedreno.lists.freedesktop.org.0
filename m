...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A8B635F9EA
	for <lists+freedreno@lfdr.de>; Wed, 14 Apr 2021 19:36:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0EB86E4CA;
...
Subject: [Freedreno] [v1 3/3] drm/bridge: ti-sn65dsi86: Add DisplayPort aux
 backlight support
