...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8096344B260
	for <lists+freedreno@lfdr.de>; Tue,  9 Nov 2021 19:06:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB833897EE;
...
Subject: [Freedreno] [PATCH 2/5] drm/msm: Drop priv->lastctx
