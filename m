...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E4817C43D2
	for <lists+freedreno@lfdr.de>; Wed, 11 Oct 2023 00:26:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F344510E3EF;
...
Subject: [Freedreno] [PATCH 1/3] drm/ci: Add SM8250 job to CI
