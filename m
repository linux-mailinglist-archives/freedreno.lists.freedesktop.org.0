...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A4CABF037
	for <lists+freedreno@lfdr.de>; Thu, 26 Sep 2019 12:53:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3CD56ED17;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 QR0Q==
Subject: [Freedreno] [PATCH v2 2/5] drm/msm/mdp5: Add configuration for
 msm8x56
