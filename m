...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C26B93B3B46
	for <lists+freedreno@lfdr.de>; Fri, 25 Jun 2021 05:42:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B12E56EC08;
...
Subject: Re: [Freedreno] [PATCH 11/17] drm/msm/dpu: drop src_split and
