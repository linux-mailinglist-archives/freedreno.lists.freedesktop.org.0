...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A0B6E5371F8
	for <lists+freedreno@lfdr.de>; Sun, 29 May 2022 20:02:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC93C10F4AB;
...
Subject: [Freedreno] [PATCH] drm/msm/adreno: Allow larger address space size
