...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58E7B67BBE6
	for <lists+freedreno@lfdr.de>; Wed, 25 Jan 2023 21:04:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E16310E887;
...
Subject: [Freedreno] [PATCH v3 09/10] drm/fbdev-generic: Inline clean-up
