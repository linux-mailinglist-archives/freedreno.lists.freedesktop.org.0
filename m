...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA79553B069
	for <lists+freedreno@lfdr.de>; Thu,  2 Jun 2022 02:06:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABEF010E0D2;
...
Subject: [Freedreno] [GIT PULL] drm/msm: drm-msm-fixes-2022-06-01
