...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EB7B574604A
	for <lists+freedreno@lfdr.de>; Mon,  3 Jul 2023 18:01:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACB9C10E0A9;
...
Subject: Re: [Freedreno] [PATCH v4 09/19] drm/msm/dpu: correct indentation
 for CTL definitions
