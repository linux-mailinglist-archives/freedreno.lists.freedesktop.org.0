...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1234D139987
	for <lists+freedreno@lfdr.de>; Mon, 13 Jan 2020 20:02:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78E746E141;
...
Subject: Re: [Freedreno] [PATCH 17/23] drm/radeon: Convert to CRTC VBLANK
 callbacks
