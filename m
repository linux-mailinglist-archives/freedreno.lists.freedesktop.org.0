...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6E18430456
	for <lists+freedreno@lfdr.de>; Sat, 16 Oct 2021 20:43:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3EE376E4A6;
...
Subject: [Freedreno] [PATCH v2 00/13] replace drm_detect_hdmi_monitor() with
