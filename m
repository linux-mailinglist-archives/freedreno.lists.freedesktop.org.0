...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFA2C41F3F7
	for <lists+freedreno@lfdr.de>; Fri,  1 Oct 2021 19:54:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D65846EE9C;
...
Subject: [Freedreno] [PATCH 2/2] drm/msm: One sched entity per process per
 priority
