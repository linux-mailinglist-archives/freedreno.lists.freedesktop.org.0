...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B895F6D3D76
	for <lists+freedreno@lfdr.de>; Mon,  3 Apr 2023 08:41:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DD3B10E13D;
...
Subject: Re: [Freedreno] [PATCH v8 06/10] drm/i915/hdcp: Retain hdcp_capable
 return codes
