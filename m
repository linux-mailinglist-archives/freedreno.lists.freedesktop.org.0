...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48D0C6CFD1C
	for <lists+freedreno@lfdr.de>; Thu, 30 Mar 2023 09:42:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1007210ED27;
	Thu, 30 Mar 2023 07:42:03 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 5/6] drm/msm: Initialize fbdev DRM client
