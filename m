...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8498452A89
	for <lists+freedreno@lfdr.de>; Tue, 16 Nov 2021 07:23:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B4386EA27;
...
Subject: [Freedreno] [PATCH v3 07/13] drm/msm/disp/dpu1: Add support for DSC
 in encoder
