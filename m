...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B987859EE77
	for <lists+freedreno@lfdr.de>; Tue, 23 Aug 2022 23:53:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E387710E1A1;
...
Subject: Re: [Freedreno] [PATCH] drm/msm/dsi: drop the hpd worker
