...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F3B04B319A
	for <lists+freedreno@lfdr.de>; Sat, 12 Feb 2022 00:59:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A539510EB78;
	Fri, 11 Feb 2022 23:59:49 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH 6/7] drm/msm/dpu: switch dpu_encoder to use
 atomic_mode_set
