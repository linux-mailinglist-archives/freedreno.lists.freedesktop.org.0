...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E26ECDA3F
	for <lists+freedreno@lfdr.de>; Mon,  7 Oct 2019 03:45:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37D6989CFA;
...
Subject: [Freedreno] [PATCH RFC v2 4/5] ARM: dts: qcom: msm8974: add HDMI
 nodes
