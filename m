...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B56D2BE7774
	for <lists+freedreno@lfdr.de>; Fri, 17 Oct 2025 11:12:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7093110EB7A;
	Fri, 17 Oct 2025 09:11:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=amazon.com header.i=@amazon.com header.b="Ps7rFXVX";
	dkim-atps=neutral
...
Received: from pdx-out-010.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9E4A110EB7A
 for <freedreno@lists.freedesktop.org>; Fri, 17 Oct 2025 09:11:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 mPe/PbQmMc+w7aFXpwXyYerMUKEGdZD0W4wX2G0eeKiV5WPDJweoMZDBv w==;
...
Received: from ip-10-5-12-219.us-west-2.compute.internal (HELO
 ...
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Oct 2025 09:11:51 +0000
...
Subject: [PATCH v2 19/27 5.10.y] minmax: improve macro expansion and type
 checking
