...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90A9570BD9C
	for <lists+freedreno@lfdr.de>; Mon, 22 May 2023 14:22:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7172610E323;
...
Subject: [Freedreno] [PATCH v3 02/12] drm/armada: Use regular fbdev I/O
 helpers
