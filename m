...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 617FD1F3453
	for <lists+freedreno@lfdr.de>; Tue,  9 Jun 2020 08:48:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D91B989CAF;
...
Subject: Re: [Freedreno] [PATCH v6 3/5] drm/msm/dp: add displayPort driver
 support
...
Cc: kbuild-all@lists.01.org, freedreno@lists.freedesktop.org,
 ...
 nganji@codeaurora.org, seanpaul@chromium.org, sam@ravnborg.org,
