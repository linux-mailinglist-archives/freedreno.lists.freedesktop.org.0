...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 140A644DC12
	for <lists+freedreno@lfdr.de>; Thu, 11 Nov 2021 20:19:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42CFC6E8F3;
...
Subject: [Freedreno] [PATCH 1/2] drm/msm: Fix wait_fence submitqueue leak
