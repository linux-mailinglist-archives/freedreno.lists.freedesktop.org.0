...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 23C167028FE
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 11:40:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC9F310E198;
...
Subject: [Freedreno] [PATCH v2 02/12] drm/armada: Use regular fbdev I/O
 helpers
