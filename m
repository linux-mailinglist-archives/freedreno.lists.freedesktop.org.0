...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A342354C05
	for <lists+freedreno@lfdr.de>; Tue,  6 Apr 2021 07:10:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C814689220;
	Tue,  6 Apr 2021 05:10:21 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v1 0/4] Add display support for SC7280 target
