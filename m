...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 574E136319E
	for <lists+freedreno@lfdr.de>; Sat, 17 Apr 2021 19:49:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE7E06E5D4;
...
Subject: Re: [Freedreno] [PATCH] drm/msm: always parse interconnects
...
Cc: Rob Clark <robdclark@chromium.org>,
 ...
 Sean Paul <sean@poorly.run>, Kalyan Thota <kalyant@codeaurora.org>
