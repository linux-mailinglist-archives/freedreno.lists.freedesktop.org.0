...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60D732B3028
	for <lists+freedreno@lfdr.de>; Sat, 14 Nov 2020 20:28:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18B406E952;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 2/3] drm/msm/shrinker: We can vmap shrink
 active_list too
