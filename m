...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6924678BBD9
	for <lists+freedreno@lfdr.de>; Tue, 29 Aug 2023 02:06:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75AB510E391;
...
Subject: [Freedreno] [PATCH RFC v6 10/10] drm/msm/dpu: Add solid fill and
