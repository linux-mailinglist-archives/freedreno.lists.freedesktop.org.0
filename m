...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32493585434
	for <lists+freedreno@lfdr.de>; Fri, 29 Jul 2022 19:07:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C33C210E3C1;
	Fri, 29 Jul 2022 17:07:32 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 1/3] dma-buf: Add ioctl to query mmap info
