...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 500BA4304B3
	for <lists+freedreno@lfdr.de>; Sat, 16 Oct 2021 21:18:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87F636E50B;
...
Subject: [Freedreno] [PATCH v2 08/13] drm/sun4i: replace
