...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF3AD552892
	for <lists+freedreno@lfdr.de>; Tue, 21 Jun 2022 02:18:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43F6D10E82D;
...
Subject: Re: [Freedreno] [PATCH v1 4/4] drm/msm/dpu: move struct dpu_hw_blk
