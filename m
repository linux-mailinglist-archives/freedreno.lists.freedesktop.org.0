...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71F016A21EE
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 20:01:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 065C010E5D0;
...
Subject: [Freedreno] [PATCH v1 1/2] drm/msm/dpu: add dsc helper functions
