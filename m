...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F4717308B6
	for <lists+freedreno@lfdr.de>; Wed, 14 Jun 2023 21:46:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49ACE10E165;
...
Subject: Re: [Freedreno] [PATCH v8 15/18] drm/msm/a6xx: Use "else if" in GPU
