...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 37BC3275B01
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA3AC6E9E2;
...
Subject: [Freedreno] [PATCH v3 12/22] drm/pl111: Introduce GEM object
 functions
