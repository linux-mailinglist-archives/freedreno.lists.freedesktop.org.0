...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EB2C176AFD
	for <lists+freedreno@lfdr.de>; Tue,  3 Mar 2020 03:47:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB0E06E923;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.4 11/58] drm/msm/mdp5: rate limit pp
