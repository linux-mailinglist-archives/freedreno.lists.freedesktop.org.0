...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22F4A43048C
	for <lists+freedreno@lfdr.de>; Sat, 16 Oct 2021 21:18:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 219A86E4CF;
...
Subject: [Freedreno] [PATCH v2 07/13] drm/msm: replace
