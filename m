...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A94B78D1A7
	for <lists+freedreno@lfdr.de>; Wed, 30 Aug 2023 03:21:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85ACF10E4AD;
...
Subject: Re: [Freedreno] [PATCH 2/3] drm/msm/dpu: split
