...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 468A7CDA3C
	for <lists+freedreno@lfdr.de>; Mon,  7 Oct 2019 03:45:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C09E89CA2;
...
Subject: [Freedreno] [PATCH RFC v2 1/5] drm/bridge: analogix-anx78xx: add
