...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 664BF6F2142
	for <lists+freedreno@lfdr.de>; Sat, 29 Apr 2023 01:45:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D71CE10E06A;
	Fri, 28 Apr 2023 23:45:34 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 0/7] add DSC 1.2 dpu supports
