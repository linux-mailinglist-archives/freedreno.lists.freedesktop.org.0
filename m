...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5885D643172
	for <lists+freedreno@lfdr.de>; Mon,  5 Dec 2022 20:15:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C721010E283;
...
Subject: [Freedreno] [PATCH v8 5/5] drm/msm/dp: add support of max dp link
 rate
