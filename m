...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFA12611DDA
	for <lists+freedreno@lfdr.de>; Sat, 29 Oct 2022 01:00:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E43AD10E8F9;
...
Subject: [Freedreno] [RFC PATCH 2/3] drm: Adjust atomic checks for solid
 fill color
