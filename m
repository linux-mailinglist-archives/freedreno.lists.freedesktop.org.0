...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D4C7678961
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 22:20:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 68BAF10E58C;
...
Subject: Re: [Freedreno] [PATCH] dt-bindings: drop type for
 operating-points-v2
...
Cc: Ulf Hansson <ulf.hansson@linaro.org>, devicetree@vger.kernel.org,
 ...
 Kevin Hilman" <khilman@kernel.org>, "Rafael J. Wysocki" <rafael@kernel.org>,
 ...
 Sowjanya Komatineni <skomatineni@nvidia.com>, Daniel Vetter <daniel@ffwll.ch>,
