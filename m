...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B1DA8142517
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 09:24:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE8866E5D2;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 00/22] drm: Clean up VBLANK callbacks in
 struct drm_driver
