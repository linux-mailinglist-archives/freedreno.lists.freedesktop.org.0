...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED84D74A521
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 22:49:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9E0810E4B5;
...
Subject: [Freedreno] [PATCH v4 2/6] drm/msm/dpu: Drop unused num argument
