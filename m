...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C5E7A4ECE2E
	for <lists+freedreno@lfdr.de>; Wed, 30 Mar 2022 22:47:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5ECEC10E905;
...
Subject: [Freedreno] [PATCH v2 00/10] drm/msm: Userspace allocated GPU
 addresses
