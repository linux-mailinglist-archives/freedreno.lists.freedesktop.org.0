...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22B3A545330
	for <lists+freedreno@lfdr.de>; Thu,  9 Jun 2022 19:42:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83ABF12B3E6;
...
Subject: [Freedreno] [PATCH v3 1/2] drm: Add DRM_GEM_FOPS
