...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C20E1387FF
	for <lists+freedreno@lfdr.de>; Sun, 12 Jan 2020 20:54:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EB0689F01;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 1/4] drm/msm: support firmware-name for zap
 fw (v2)
