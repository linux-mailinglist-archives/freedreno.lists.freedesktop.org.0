...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5603C6DE7A1
	for <lists+freedreno@lfdr.de>; Wed, 12 Apr 2023 00:57:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28A8E10E26F;
...
Subject: [Freedreno] [PATCH v3 1/7] drm: Add common fdinfo helper
