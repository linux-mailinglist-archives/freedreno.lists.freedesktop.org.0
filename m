...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A2EF64E4FF
	for <lists+freedreno@lfdr.de>; Fri, 16 Dec 2022 01:09:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACA9010E5A3;
...
Subject: [Freedreno] [PATCH v5 0/2] do not complete dp_aux_cmd_fifo_tx() if
