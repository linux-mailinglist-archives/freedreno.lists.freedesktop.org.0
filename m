...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB0A063C9C5
	for <lists+freedreno@lfdr.de>; Tue, 29 Nov 2022 21:47:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 365BC10E3E5;
...
Subject: [Freedreno] [PATCH 06/12] arm64: dts: qcom: sm6115: Add rpm-stats
 node
