...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87C0E6E5170
	for <lists+freedreno@lfdr.de>; Mon, 17 Apr 2023 22:12:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 61A7D10E5CA;
...
Subject: [Freedreno] [RFC 2/3] drm/msm: Rework get_comm_cmdline() helper
