...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FA1246A949
	for <lists+freedreno@lfdr.de>; Mon,  6 Dec 2021 22:13:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C3F76E8E5;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.15 03/24] drm/msm/dsi: set default
 num_data_lanes
