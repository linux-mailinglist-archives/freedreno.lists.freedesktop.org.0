...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D9830D4153
	for <lists+freedreno@lfdr.de>; Fri, 11 Oct 2019 15:33:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 004C86EC3B;
	Fri, 11 Oct 2019 13:33:02 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mail-yw1-xc41.google.com (mail-yw1-xc41.google.com
 [IPv6:2607:f8b0:4864:20::c41])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5CADB6EC34
 for <freedreno@lists.freedesktop.org>; Fri, 11 Oct 2019 13:33:01 +0000 (UTC)
Received: by mail-yw1-xc41.google.com with SMTP id m7so3476954ywe.4
 for <freedreno@lists.freedesktop.org>; Fri, 11 Oct 2019 06:33:01 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to:user-agent;
 bh=TZTffmmupDFz1doz+bHhDhbAscp+GEPuUpXNsilC2Ho=;
 b=
X-Gm-Message-State: APjAAAXEWRCHKKPMw6/suuqLnI3J4f1Q+xrcLpRAhTnsydkf+zU4F5qd
 +eA64ZSOc/Saol2X/Xa9FI27qQ==
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 5zyA==
Subject: Re: [Freedreno] [PATCH 0/4] drm/msm: Remove four set but not used
 variables
