...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5520F244370
	for <lists+freedreno@lfdr.de>; Fri, 14 Aug 2020 04:42:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCBBB6EAE3;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 14/19] drm/msm: Add support to create a local
 pagetable
