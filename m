...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 57B5370F25F
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 11:22:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2559110E63C;
...
Subject: [Freedreno] [PATCH v4 12/13] drm/fbdev-generic: Implement dedicated
 fbdev I/O helpers
