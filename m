...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EE56553865
	for <lists+freedreno@lfdr.de>; Tue, 21 Jun 2022 19:02:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7049F10E9F3;
...
Subject: [Freedreno] [PATCH v15 2/3] phy: qcom-qmp: add regulator_set_load
 to dp phy
