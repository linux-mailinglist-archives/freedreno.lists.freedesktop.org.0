...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3F657CB854
	for <lists+freedreno@lfdr.de>; Tue, 17 Oct 2023 04:18:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B89C410E250;
...
Subject: [Freedreno] [PATCH v4 3/6] dt-bindings: display: msm: Add SDM670
 MDSS
