...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 902C45A5A0E
	for <lists+freedreno@lfdr.de>; Tue, 30 Aug 2022 05:33:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7950010E9CB;
...
Subject: [Freedreno] [RFC PATCH 1/3] drm/msm/dpu: add max external pixel
 clock for all targets
