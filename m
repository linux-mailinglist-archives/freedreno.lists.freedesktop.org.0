...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7805A53D39A
	for <lists+freedreno@lfdr.de>; Sat,  4 Jun 2022 00:28:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 734E1113FCA;
...
Subject: Re: [Freedreno] [PATCH v4 7/7] drm/msm/dpu: make dpu hardware
