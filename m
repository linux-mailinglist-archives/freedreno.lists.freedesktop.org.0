...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7362E14865F
	for <lists+freedreno@lfdr.de>; Fri, 24 Jan 2020 14:50:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 247D272AAF;
...
Subject: Re: [Freedreno] [PATCH v4 14/22] drm/stm: Convert to struct
 drm_crtc_helper_funcs.get_scanout_position()
