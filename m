...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75435679989
	for <lists+freedreno@lfdr.de>; Tue, 24 Jan 2023 14:40:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 670E910E69A;
...
Subject: [Freedreno] [PATCH v2 00/10] drm/fb-helper: Various cleanups
