...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E080434EDA
	for <lists+freedreno@lfdr.de>; Wed, 20 Oct 2021 17:17:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD0516E9E7;
...
Subject: [Freedreno] [PATCH v2 4/4] arm64: dts: qcom: sc7280: add edp
 display dt nodes
