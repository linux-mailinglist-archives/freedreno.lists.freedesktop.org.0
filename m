...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7877D618206
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:17:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D249B10E6A0;
...
Subject: [Freedreno] [PATCH v3 11/23] drm/fb-helper: Cleanup include
