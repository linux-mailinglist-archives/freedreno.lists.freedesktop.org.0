...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6EB07DACEA
	for <lists+freedreno@lfdr.de>; Sun, 29 Oct 2023 16:07:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7393F10E175;
...
Subject: [Freedreno] [PATCH v2 0/2] drm/msm/gem: Add metadata uapi
