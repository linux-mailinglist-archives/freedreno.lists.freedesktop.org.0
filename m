...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7202A2479BD
	for <lists+freedreno@lfdr.de>; Tue, 18 Aug 2020 00:03:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 017EC6E13C;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 18/20] arm: dts: qcom: sc7180: Set the
