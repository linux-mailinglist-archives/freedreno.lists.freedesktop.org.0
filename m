...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FAEC64E960
	for <lists+freedreno@lfdr.de>; Fri, 16 Dec 2022 11:23:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7098710E5B7;
	Fri, 16 Dec 2022 10:22:36 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 4/5] drm/msm/a6xx: Remove cx gdsc polling
 using 'reset'
