...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1E75A2145
	for <lists+freedreno@lfdr.de>; Thu, 29 Aug 2019 18:49:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A39BC6E134;
	Thu, 29 Aug 2019 16:49:07 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 Mpxw==
Subject: [Freedreno] [PATCH 00/10] drm/msm: async commit support (v2)
...
Cc: Rob Clark <robdclark@chromium.org>,
 ...
 Jeykumar Sankaran <jsanka@codeaurora.org>, Enrico Weigelt <info@metux.net>,
 Georgi Djakov <georgi.djakov@linaro.org>, Allison Randal <allison@lohutok.net>
