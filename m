...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D81F2E8559
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D204D89622;
	Fri,  1 Jan 2021 18:55:18 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 16/31] drm/msm: convert to use devm_pm_opp_* API
 and remove dp_ctrl_put
