...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BCF432129E
	for <lists+freedreno@lfdr.de>; Mon, 22 Feb 2021 10:05:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BE1F6E916;
...
Subject: Re: [Freedreno] [PATCH v3 05/11] drm: Use the state pointer
...
Content-Type: multipart/mixed; boundary="===============0316532917=="
