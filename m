...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 233D5629DEF
	for <lists+freedreno@lfdr.de>; Tue, 15 Nov 2022 16:46:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B528310E417;
...
Subject: [Freedreno] [PATCH v3] drm/msm/a6xx: Fix speed-bin detection vs
 probe-defer
