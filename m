...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFE1E44AACB
	for <lists+freedreno@lfdr.de>; Tue,  9 Nov 2021 10:47:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81C836EB17;
	Tue,  9 Nov 2021 09:47:46 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3] drm/msm: use compatible lists to find mdp
 node
