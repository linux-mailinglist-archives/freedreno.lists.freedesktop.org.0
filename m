...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AFCF5B6A26
	for <lists+freedreno@lfdr.de>; Tue, 13 Sep 2022 10:59:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7136A10E682;
...
Subject: [Freedreno] [PATCH v2 10/10] drm/msm/dsi: drop modeset sanity checks
