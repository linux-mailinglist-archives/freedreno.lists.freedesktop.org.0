...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC888410116
	for <lists+freedreno@lfdr.de>; Sat, 18 Sep 2021 00:07:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE4166E082;
...
Subject: Re: [Freedreno] [PATCH 01/15] dmr: cleanup:
