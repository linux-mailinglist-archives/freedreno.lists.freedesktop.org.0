...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 00595552583
	for <lists+freedreno@lfdr.de>; Mon, 20 Jun 2022 22:12:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A1DB10EFD3;
...
Subject: [Freedreno] [PATCH v14 2/3] phy: qcom-qmp: add regulator_set_load
 to dp phy
