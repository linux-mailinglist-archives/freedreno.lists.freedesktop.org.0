...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1174647248E
	for <lists+freedreno@lfdr.de>; Mon, 13 Dec 2021 10:37:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A51710E71B;
...
Subject: [Freedreno] [PATCH 1/3] drm/dp_mst: Remove trailing whitespace.
