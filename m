...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A078D4FC6FD
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 23:58:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FF4F89D81;
...
Subject: [Freedreno] [PATCH v4 02/10] drm/msm/gpu: Drop duplicate fence
 counter
