...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 50E16641993
	for <lists+freedreno@lfdr.de>; Sat,  3 Dec 2022 23:42:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD37B10E203;
...
Subject: [Freedreno] [PATCH 4/4] drm/msm/a6xx: Update ROQ size in coredump
