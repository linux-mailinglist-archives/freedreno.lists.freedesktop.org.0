...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 253FE6C1532
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:45:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF87E10E5BC;
...
Subject: [Freedreno] [PATCH v2 18/23] PM / QoS: Decouple request alloc from
 dev_pm_qos_mtx
