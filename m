...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6565941ED92
	for <lists+freedreno@lfdr.de>; Fri,  1 Oct 2021 14:33:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F1E26E52F;
...
Subject: [Freedreno] [PATCH 1/3] drm/msm/dsi: Fix an error code in
