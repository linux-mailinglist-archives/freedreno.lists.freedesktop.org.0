...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54AF5452A8B
	for <lists+freedreno@lfdr.de>; Tue, 16 Nov 2021 07:23:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9A196EA34;
...
Subject: [Freedreno] [PATCH v3 08/13] drm/msm: Add missing structure
 documentation
