...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56DE4707743
	for <lists+freedreno@lfdr.de>; Thu, 18 May 2023 03:14:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5162E10E4CD;
...
Subject: [Freedreno] [PATCH v13 4/9] drm/msm/dsi: use DRM DSC helpers for
 DSC setup
