...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A14B42F13D
	for <lists+freedreno@lfdr.de>; Fri, 15 Oct 2021 14:45:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA0EB6EDA7;
...
Subject: Re: [Freedreno] [PATCH 15/15] drm/i915: replace
