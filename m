...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDEA264198A
	for <lists+freedreno@lfdr.de>; Sat,  3 Dec 2022 23:42:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2276910E1FE;
...
Subject: [Freedreno] [PATCH 2/4] drm/msm: Fix failure paths in msm_drm_init()
...
Cc: Sean Paul <sean@poorly.run>, Akhil P Oommen <quic_akhilpo@quicinc.com>,
 ...
 Rob Clark <robdclark@gmail.com>, Duoming
 Zhou <duoming@zju.edu.cn>, Daniel Vetter <daniel@ffwll.ch>,
 Dmitry Baryshkov <dmitry.baryshkov@linaro.org>,
 Johannes Berg <johannes@sipsolutions.net>, David Airlie <airlied@gmail.com>
