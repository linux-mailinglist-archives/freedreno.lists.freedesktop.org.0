...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E73F142554
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 09:24:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 44CC86E869;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 16/22] drm/sti: Convert to CRTC VBLANK
 callbacks
