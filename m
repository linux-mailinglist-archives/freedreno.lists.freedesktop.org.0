...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 714DC50DF28
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 13:45:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00E9410E4FC;
...
Subject: [Freedreno] [PATCH v10 1/4] drm/msm/dp: Add eDP support via aux_bus
