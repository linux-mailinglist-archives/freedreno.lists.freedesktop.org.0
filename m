...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC97E6799A0
	for <lists+freedreno@lfdr.de>; Tue, 24 Jan 2023 14:40:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33C4310E6BB;
...
Subject: [Freedreno] [PATCH v2 08/10] drm/fbdev-generic: Minimize client
 unregistering
