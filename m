...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A97C7A29A2
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 23:39:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72E0510E692;
...
Subject: [Freedreno] [PATCH v3 7/7] drm/msm/dp: move
