...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE4B931FC0B
	for <lists+freedreno@lfdr.de>; Fri, 19 Feb 2021 16:34:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 41D7F6EB59;
...
Subject: [Freedreno] [PATCH v3 10/11] drm: Use state helper instead of the
 plane state pointer
