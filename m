...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74CF54E5A22
	for <lists+freedreno@lfdr.de>; Wed, 23 Mar 2022 21:48:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C5C610E12E;
...
Subject: Re: [Freedreno] [PATCH 0/3] drm/msm/dp: simplify
