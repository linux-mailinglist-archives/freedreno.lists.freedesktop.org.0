...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A37F537208
	for <lists+freedreno@lfdr.de>; Sun, 29 May 2022 20:04:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD23A10E439;
...
Subject: [Freedreno] [PATCH v2] drm/msm/adreno: Allow larger address space
 size
