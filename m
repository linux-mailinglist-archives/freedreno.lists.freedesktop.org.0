...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFE1F587F78
	for <lists+freedreno@lfdr.de>; Tue,  2 Aug 2022 17:52:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DEC8906C5;
...
Subject: [Freedreno] [PATCH v4 14/15] drm/msm/gem: Add
