...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62BB8257C4F
	for <lists+freedreno@lfdr.de>; Mon, 31 Aug 2020 17:29:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56DF689DC7;
	Mon, 31 Aug 2020 15:29:44 +0000 (UTC)
...
Subject: [Freedreno] [PATCH AUTOSEL 5.8 05/42] drm/msm/dpu: Fix scale params
 in plane validation
