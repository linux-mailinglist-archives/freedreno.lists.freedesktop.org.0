...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F05F65E7D
	for <lists+freedreno@lfdr.de>; Thu, 11 Jul 2019 19:27:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA4026E26C;
...
Subject: Re: [Freedreno] [PATCH v4 17/23] drm/ast: Provide ddc symlink in
...
Content-Type: multipart/mixed; boundary="===============0734267354=="
