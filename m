...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2A197A299F
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 23:39:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 926A810E69A;
...
Subject: [Freedreno] [PATCH v3 0/7] incorporate pm runtime framework and eDP
 clean up
