...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A50AB2E8555
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 193258957D;
...
Subject: [Freedreno] [PATCH 05/31] opp: Add devres wrapper for
