...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2510174FC9A
	for <lists+freedreno@lfdr.de>; Wed, 12 Jul 2023 03:20:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D093410E47B;
...
Subject: [Freedreno] [PATCH v5 3/5] drm/msm/dpu: rename all hw_intf structs
 to have dpu_hw prefix
