...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1702E4B0CBF
	for <lists+freedreno@lfdr.de>; Thu, 10 Feb 2022 12:48:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 741D210E81F;
...
Subject: [Freedreno] [PATCH 2/3] drm/msm/dpu: Update the comment style
