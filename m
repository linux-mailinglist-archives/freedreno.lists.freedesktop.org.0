...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F4A3FF93C
	for <lists+freedreno@lfdr.de>; Sun, 17 Nov 2019 12:48:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045B76E44B;
...
Subject: [Freedreno] [PATCH 2/4] drm/msm/gpu: add support for ocmem
 interconnect path
