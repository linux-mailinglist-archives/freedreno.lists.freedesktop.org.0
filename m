...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B75576F1E5
	for <lists+freedreno@lfdr.de>; Thu,  3 Aug 2023 20:32:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E70F610E11D;
...
Subject: [Freedreno] [PATCH] drm/msm: Disallow relocs on a6xx+
