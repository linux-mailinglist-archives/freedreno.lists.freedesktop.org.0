...
Received: from gabe.freedesktop.org (unknown [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 835A15BB3C8
	for <lists+freedreno@lfdr.de>; Fri, 16 Sep 2022 23:04:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DC0610EDA5;
...
Subject: [Freedreno] [PATCH v2 7/7] drm/msm/dp: HPD handling relates to
 next_bridge
