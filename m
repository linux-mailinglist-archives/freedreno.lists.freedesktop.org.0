...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2338B7B0DA9
	for <lists+freedreno@lfdr.de>; Wed, 27 Sep 2023 22:54:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D41B110E5B5;
...
Subject: [Freedreno] [PATCH v4 2/8] drm/msm/dp: rename is_connected with
 link_ready
