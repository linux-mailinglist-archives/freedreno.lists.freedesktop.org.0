...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E55E139909F
	for <lists+freedreno@lfdr.de>; Wed,  2 Jun 2021 18:49:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCD086ED94;
...
MIME-Version: 1.0
Subject: [Freedreno] [RESEND PATCH v4 4/6] iommu/arm-smmu-qcom: Add stall
 support
