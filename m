...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BDB7257C5E
	for <lists+freedreno@lfdr.de>; Mon, 31 Aug 2020 17:29:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1D0C6E2CA;
	Mon, 31 Aug 2020 15:29:51 +0000 (UTC)
...
Subject: [Freedreno] [PATCH AUTOSEL 5.8 09/42] drm/msm: add shutdown support
