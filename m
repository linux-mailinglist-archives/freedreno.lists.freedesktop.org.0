...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8569540ECC7
	for <lists+freedreno@lfdr.de>; Thu, 16 Sep 2021 23:43:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9157B6E5C8;
...
Subject: [Freedreno] [PATCH 05/15] drm/vmwgfx: cleanup:
