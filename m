...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51D326543C2
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:06:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C18010E53A;
	Thu, 22 Dec 2022 15:05:51 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v10 02/15] drm: add helper functions to retrieve
 old and new crtc
