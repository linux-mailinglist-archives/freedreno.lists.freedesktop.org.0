...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6624536686
	for <lists+freedreno@lfdr.de>; Fri, 27 May 2022 19:23:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25C6C10E09D;
...
Subject: [Freedreno] [PATCH] drm/msm/gem: Separate object and vma unpin
