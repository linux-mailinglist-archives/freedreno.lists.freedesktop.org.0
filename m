...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 155A1559F27
	for <lists+freedreno@lfdr.de>; Fri, 24 Jun 2022 19:15:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A12BA10E3C8;
...
Subject: [Freedreno] [PATCH v1 0/3] fix primary corruption issue
