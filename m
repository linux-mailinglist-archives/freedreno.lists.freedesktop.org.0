...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 336DE4AA1F6
	for <lists+freedreno@lfdr.de>; Fri,  4 Feb 2022 22:17:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9A0710E2C6;
...
Subject: [Freedreno] [PATCH 00/12] Add writeback block support for DPU
