...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C5BF4FC709
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 23:58:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E382C10E0B5;
...
Subject: [Freedreno] [PATCH v4 06/10] drm/msm: Drop msm_gem_iova()
