...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CB0964BEAC
	for <lists+freedreno@lfdr.de>; Tue, 13 Dec 2022 22:44:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6D3310E367;
	Tue, 13 Dec 2022 21:44:26 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v12 0/5] Add data-lanes and link-frequencies to
 dp_out endpoint
