...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0D5424796F
	for <lists+freedreno@lfdr.de>; Tue, 18 Aug 2020 00:02:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB29C89FED;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 01/20] drm/msm: remove dangling submitqueue
 references
