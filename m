...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D65F5674F4
	for <lists+freedreno@lfdr.de>; Tue,  5 Jul 2022 19:01:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01A469271E;
...
Subject: [Freedreno] [PATCH v4 6/7] drm/msm/disp/dpu1: use atomic
