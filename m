...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A0609425BD6
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:38:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D2226F4C3;
...
Subject: [Freedreno] [PATCH v3 05/20] drm/vmwgfx: cleanup:
