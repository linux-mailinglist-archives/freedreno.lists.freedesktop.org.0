...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 837666FE76A
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:46:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7347D10E56F;
...
Subject: [Freedreno] [PATCH v8 7/8] drm/msm/dsi: Use MSM and DRM DSC helper
 methods
