...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11D48435D3
	for <lists+freedreno@lfdr.de>; Thu, 13 Jun 2019 14:23:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77C15899AB;
...
Subject: [Freedreno] [PATCH] msm: adreno: no need to check return value of
