...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4684C69BC36
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 465D210E0A1;
...
Subject: [Freedreno] [PATCH v4 11/14] drm/atomic-helper: Set fence deadline
 for vblank
