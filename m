...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7248E605DBC
	for <lists+freedreno@lfdr.de>; Thu, 20 Oct 2022 12:41:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E98D10EBC1;
...
Subject: [Freedreno] [PATCH 11/21] drm/fb-helper: Cleanup include statements
 in header file
