...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8021438C6E0
	for <lists+freedreno@lfdr.de>; Fri, 21 May 2021 14:50:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C9F66F629;
	Fri, 21 May 2021 12:50:16 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Freedreno] [RFC PATCH 03/13] drm/msm/disp/dpu1: Add support for DSC
