...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C83870D04B
	for <lists+freedreno@lfdr.de>; Tue, 23 May 2023 03:15:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A50610E3B5;
	Tue, 23 May 2023 01:15:35 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 0/3] drm/msm/adreno: GPU support on SC8280XP
