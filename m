...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 320F22E855D
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D033896E4;
...
Subject: [Freedreno] [PATCH 11/31] mmc: sdhci-msm: fix potential mem leak in
 sdhci_msm_probe()
