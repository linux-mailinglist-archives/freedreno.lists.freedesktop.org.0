...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E93586FE7A2
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:55:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F06F210E55D;
...
Subject: [Freedreno] [PATCH v9 2/8] drm/display/dsc: add helper to set
