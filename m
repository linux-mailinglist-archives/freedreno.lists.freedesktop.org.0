...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E50B51BD33
	for <lists+freedreno@lfdr.de>; Thu,  5 May 2022 12:28:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4871A10EA79;
...
Subject: [Freedreno] [PATCH] drm/msm: return an error pointer in
