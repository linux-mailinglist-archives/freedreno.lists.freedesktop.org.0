...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A93E567BBF0
	for <lists+freedreno@lfdr.de>; Wed, 25 Jan 2023 21:04:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0149A10E86A;
...
Subject: [Freedreno] [PATCH v3 08/10] drm/fbdev-generic: Minimize client
 unregistering
