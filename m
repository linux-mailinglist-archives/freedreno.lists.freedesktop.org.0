...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBE75534588
	for <lists+freedreno@lfdr.de>; Wed, 25 May 2022 23:02:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27E7A10EAA9;
...
Subject: [Freedreno] [PATCH v13 1/3] phy: qcom-edp: add regulator_set_load
 to edp phy
