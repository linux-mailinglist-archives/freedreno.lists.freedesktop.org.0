...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C08C72AB4F6
	for <lists+freedreno@lfdr.de>; Mon,  9 Nov 2020 11:32:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D187089893;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 1/2] drm/msm: Use struct dma_buf_map in GEM vmap
 ops
