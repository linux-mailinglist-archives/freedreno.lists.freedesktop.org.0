...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F347D7002D4
	for <lists+freedreno@lfdr.de>; Fri, 12 May 2023 10:42:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 342AA10E641;
...
Subject: [Freedreno] [PATCH 10/11] drm/fbdev-generic: Implement dedicated
 fbdev I/O helpers
