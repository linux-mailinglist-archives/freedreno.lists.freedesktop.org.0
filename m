...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C1FD425C3A
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:39:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A546C6F4CC;
...
Subject: [Freedreno] [PATCH v3 18/20] drm/amd: cleanup:
