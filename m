...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CF7C416C42
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:52:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E0346EE29;
...
Subject: [Freedreno] [PATCH v2 05/17] drm/vmwgfx: cleanup:
