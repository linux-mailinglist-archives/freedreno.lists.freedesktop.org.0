...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FF8D617178
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 00:11:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00E4210E51A;
	Wed,  2 Nov 2022 23:11:28 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v4 1/2] drm/msm: move domain allocation into
 msm_iommu_new()
