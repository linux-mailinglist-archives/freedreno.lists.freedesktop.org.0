...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F31466181DA
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:16:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0778210E657;
...
Subject: [Freedreno] [PATCH v3 14/23] drm/fb-helper: Rename
