...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 427155093D8
	for <lists+freedreno@lfdr.de>; Thu, 21 Apr 2022 01:50:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A55910F2D3;
...
Subject: [Freedreno] [PATCH v3 17/18] drm/msm/dpu: gracefully handle null fb
