...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C455465E105
	for <lists+freedreno@lfdr.de>; Thu,  5 Jan 2023 00:41:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1474310E47B;
	Wed,  4 Jan 2023 23:41:07 +0000 (UTC)
...
Subject: [Freedreno] [RFC PATCH v3 2/3] drm: Adjust atomic checks for solid
 fill color
