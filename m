...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B9E4425BBC
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:38:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C02F6F40D;
...
Subject: [Freedreno] [PATCH v3 03/20] drm/msm: cleanup:
