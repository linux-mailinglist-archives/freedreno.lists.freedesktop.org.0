...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 674217A2873
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 22:48:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2687D10E67B;
...
Subject: [Freedreno] [PATCH v2 0/7] incorporate pm runtime framework and eDP
 clean up
