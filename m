...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 591EF3DE95A
	for <lists+freedreno@lfdr.de>; Tue,  3 Aug 2021 11:07:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6122A6E5B6;
...
Subject: [Freedreno] [PATCH v2 07/14] drm/msm: Convert to Linux IRQ
 interfaces
