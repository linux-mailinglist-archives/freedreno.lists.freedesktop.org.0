...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC42265AFCB
	for <lists+freedreno@lfdr.de>; Mon,  2 Jan 2023 11:49:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BEE110E304;
...
Subject: [Freedreno] [PATCH v5 3/5] drm/msm/a6xx: Vote for cx gdsc from gpu
 driver
