...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 316DB3E5894
	for <lists+freedreno@lfdr.de>; Tue, 10 Aug 2021 12:50:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B9D289FEA;
...
X-QQ-Bgrelay: 1
Subject: [Freedreno] [PATCH v3] drm/msm: Remove initialization of static
 variables
