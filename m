...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A4DF6CC192
	for <lists+freedreno@lfdr.de>; Tue, 28 Mar 2023 15:59:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8EC410E747;
...
Subject: Re: [Freedreno] [PATCH v10 07/15] dma-buf/sw_sync: Add fence
 deadline support
