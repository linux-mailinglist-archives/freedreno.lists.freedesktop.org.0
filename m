...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ADA5725E9E3
	for <lists+freedreno@lfdr.de>; Sat,  5 Sep 2020 22:04:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD3156E24B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v17 00/20] iommu/arm-smmu + drm/msm: per-process
 GPU pgtables
