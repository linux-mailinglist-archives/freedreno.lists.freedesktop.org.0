...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D9B7547986
	for <lists+freedreno@lfdr.de>; Sun, 12 Jun 2022 11:22:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F01A7112579;
...
Subject: [Freedreno] [PATCH v2 3/4] drm/msm/mdp5: Add perf data for MDP v1.16
