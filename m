...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E207E3ED1C2
	for <lists+freedreno@lfdr.de>; Mon, 16 Aug 2021 12:15:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E4958944A;
...
Subject: Re: [Freedreno] [PATCH v2 1/5] dma-fence: Add deadline awareness
