...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B7CC4B317F
	for <lists+freedreno@lfdr.de>; Sat, 12 Feb 2022 00:49:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E25E910EB40;
...
Subject: Re: [Freedreno] [PATCH 4/7] drm/msm/dpu: drop bus_scaling_client
 field
