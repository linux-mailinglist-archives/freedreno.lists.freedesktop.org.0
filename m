...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E43FFCD380
	for <lists+freedreno@lfdr.de>; Sun,  6 Oct 2019 18:31:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A9356E06D;
...
Subject: [Freedreno] [PATCH 3/6] drm/msm/dpu: Remove set but not used
 variable 'priv' in dpu_core_irq.c
