...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AF0C4CBA75
	for <lists+freedreno@lfdr.de>; Thu,  3 Mar 2022 10:40:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1CCC710EC31;
...
Subject: [Freedreno] [PATCH v4 1/4] arm64/dts/qcom/sc7280: remove
