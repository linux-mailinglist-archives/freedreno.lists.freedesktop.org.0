...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 782DE395CA2
	for <lists+freedreno@lfdr.de>; Mon, 31 May 2021 15:34:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0AF296E4C7;
...
Subject: [Freedreno] [v1 2/3] drm/msm/dsi: Add PHY configuration for SC7280
