...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FB916F35B1
	for <lists+freedreno@lfdr.de>; Mon,  1 May 2023 20:13:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 917E510E19F;
...
Subject: [Freedreno] [PATCH v2] drm/msm: Fix submit error-path leaks
