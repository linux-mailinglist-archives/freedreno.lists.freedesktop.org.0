...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25C2D4399FD
	for <lists+freedreno@lfdr.de>; Mon, 25 Oct 2021 17:16:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D521B6E10C;
...
Subject: [Freedreno] [PATCH v6 09/21] drm/bridge: lt9611uxc: Switch to devm
 MIPI-DSI helpers
