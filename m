...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13C35196943
	for <lists+freedreno@lfdr.de>; Sat, 28 Mar 2020 21:40:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 723B56E15B;
...
Subject: Re: [Freedreno] [PATCH v10 1/2] dt-bindings: display: add visionox
