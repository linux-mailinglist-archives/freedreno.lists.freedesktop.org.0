...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B0D7ED72DB
	for <lists+freedreno@lfdr.de>; Tue, 15 Oct 2019 12:11:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5310E6E34E;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 S62Q==
Subject: [Freedreno] [PATCH v3 2/7] dt-bindings: msm/mdp5: Document optional
 TBU and TBU_RT clocks
