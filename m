...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5612A55A5FC
	for <lists+freedreno@lfdr.de>; Sat, 25 Jun 2022 04:08:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 374C510E99E;
...
Subject: Re: [Freedreno] [PATCH v2] drm/msm/dpu: simplify and unify
