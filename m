...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 765DC968ED
	for <lists+freedreno@lfdr.de>; Tue, 20 Aug 2019 21:06:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D66E6E85B;
...
Subject: [Freedreno] [PATCH 7/7] drm/msm: Use per-target functions to set up
 address spaces
...
Cc: Daniel Vetter <daniel@ffwll.ch>, Jonathan Marek <jonathan@marek.ca>,
