...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FA8B717410
	for <lists+freedreno@lfdr.de>; Wed, 31 May 2023 05:10:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D54F10E45F;
...
Subject: [Freedreno] [PATCH v3 0/3] drm/msm/adreno: GPU support on SC8280XP
