...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D4FB67BC28B
	for <lists+freedreno@lfdr.de>; Sat,  7 Oct 2023 00:55:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 001B810E57B;
...
Subject: [Freedreno] [PATCH v7 4/7] drm/msm/dp: move parser->parse() and
