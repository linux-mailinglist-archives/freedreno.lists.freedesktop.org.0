...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56FB56BF4B2
	for <lists+freedreno@lfdr.de>; Fri, 17 Mar 2023 22:54:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1944C10E288;
...
MIME-Version: 1.0
Subject: [Freedreno] Reminder: Only 2 days left to nominate candidates for
