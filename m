...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6EBA605E0B
	for <lists+freedreno@lfdr.de>; Thu, 20 Oct 2022 12:43:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09D8D10EC88;
...
Subject: [Freedreno] [PATCH 14/21] drm/fb-helper: Rename
