...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDA8C55302F
	for <lists+freedreno@lfdr.de>; Tue, 21 Jun 2022 12:53:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E5B910F641;
...
Subject: [Freedreno] [v3 3/5] drm/bridge: add psr support during panel
