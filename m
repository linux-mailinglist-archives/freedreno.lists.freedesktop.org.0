...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 146EE50C289
	for <lists+freedreno@lfdr.de>; Sat, 23 Apr 2022 01:07:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E51810EC25;
...
Subject: [Freedreno] [PATCH v4 12/20] drm/msm/dpu: add encoder operations to
