...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 205504E71EE
	for <lists+freedreno@lfdr.de>; Fri, 25 Mar 2022 12:07:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CA7210E986;
...
Subject: [Freedreno] [PATCH v5 11/13] drm/msm/disp/dpu1: Add DSC support in
 RM
