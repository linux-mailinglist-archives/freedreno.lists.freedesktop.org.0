...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E0397751A2
	for <lists+freedreno@lfdr.de>; Wed,  9 Aug 2023 05:45:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30EA110E3FA;
...
Subject: [Freedreno] [PATCH -next 6/7] drm/format-helper: Remove unnecessary
 NULL values
