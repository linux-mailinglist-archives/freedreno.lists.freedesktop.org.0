...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04EEF350BD5
	for <lists+freedreno@lfdr.de>; Thu,  1 Apr 2021 03:24:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB9DE6EC07;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 4/4] drm/msm: Improved debugfs gem stats
