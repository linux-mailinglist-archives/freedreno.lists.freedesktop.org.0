...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 439734F5A2F
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E92D310F2C5;
...
Subject: [Freedreno] [PATCH v7 08/14] drm/msm/dpu: don't use merge_3d if DSC
