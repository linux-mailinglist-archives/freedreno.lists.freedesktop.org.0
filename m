...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26D0A4F5A25
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC5EE10F299;
...
Subject: [Freedreno] [PATCH v7 03/14] drm/msm/disp/dpu1: Add support for DSC
