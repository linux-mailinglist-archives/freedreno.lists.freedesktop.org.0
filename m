...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F85942CBAA
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 22:49:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BFD86EB30;
...
Subject: [Freedreno] [PATCH v4 07/20] drm/shmobile: cleanup:
