...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5FBF7B1AED
	for <lists+freedreno@lfdr.de>; Thu, 28 Sep 2023 13:25:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2A1810E622;
	Thu, 28 Sep 2023 11:25:07 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v7 2/5] drm/panfrost: Add fdinfo support GPU
 load metrics
