...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5615E1FDD9E
	for <lists+freedreno@lfdr.de>; Thu, 18 Jun 2020 03:27:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C42BC6EA56;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.14 064/108] drm/msm/mdp5: Fix
 mdp5_init error path for failed mdp5_kms allocation
