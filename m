...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB1BD76D485
	for <lists+freedreno@lfdr.de>; Wed,  2 Aug 2023 19:01:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ACBA10E0E3;
...
Subject: [Freedreno] [PATCH v2] drm/msm/dpu: Drop encoder vsync_event
