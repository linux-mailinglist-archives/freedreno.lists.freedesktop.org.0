...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 880DF7BEF34
	for <lists+freedreno@lfdr.de>; Tue, 10 Oct 2023 01:34:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8280110E2FE;
...
Subject: [Freedreno] [PATCH v3 3/6] dt-bindings: display: msm: Add SDM670
 MDSS
