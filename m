...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 61D51492F7B
	for <lists+freedreno@lfdr.de>; Tue, 18 Jan 2022 21:39:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2EA210E55C;
	Tue, 18 Jan 2022 20:39:15 +0000 (UTC)
...
Subject: [Freedreno] [v3 1/3] dt-bindings: msm/dsi: Add 10nm dsi phy tuning
 properties
