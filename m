...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B86769BC26
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CB9010E568;
...
Subject: [Freedreno] [PATCH v4 06/14] dma-buf/sync_file: Support (E)POLLPRI
