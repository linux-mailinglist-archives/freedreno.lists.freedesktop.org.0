...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27B804B0AB6
	for <lists+freedreno@lfdr.de>; Thu, 10 Feb 2022 11:34:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B048A10E7D6;
...
Subject: [Freedreno] [REPOST PATCH v4 02/13] drm/msm/dsi: Pass DSC params to
 drm_panel
