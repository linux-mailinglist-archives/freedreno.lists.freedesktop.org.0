...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D40B1D20FC
	for <lists+freedreno@lfdr.de>; Thu, 10 Oct 2019 08:48:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 683A66EA9C;
...
Subject: [Freedreno] [PATCH 3/4] drm/msm/dsi: Remove set but not used
 variable 'lpx'
