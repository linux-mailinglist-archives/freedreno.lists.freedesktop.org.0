...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F6CA29B019
	for <lists+freedreno@lfdr.de>; Tue, 27 Oct 2020 15:16:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6FF76EB7B;
...
Subject: Re: [Freedreno] [PATCH 2/4] disp/msm/dpu: add support to dump dpu
 registers
