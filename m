...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9D0E751179
	for <lists+freedreno@lfdr.de>; Wed, 12 Jul 2023 21:43:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C30810E627;
...
Subject: Re: [Freedreno] [PATCH v3 09/11] drm/msm/dpu: core_perf: remove
 extra clk_round_rate() call
