...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C98F24FA0CF
	for <lists+freedreno@lfdr.de>; Sat,  9 Apr 2022 02:54:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3756510F240;
	Sat,  9 Apr 2022 00:54:13 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v7 1/4] drm: allow passing possible_crtcs to
