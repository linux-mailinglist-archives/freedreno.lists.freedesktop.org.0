...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 163B77DA385
	for <lists+freedreno@lfdr.de>; Sat, 28 Oct 2023 00:34:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D23210EA69;
	Fri, 27 Oct 2023 22:34:03 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v7 07/10] drm/atomic: Loosen FB atomic checks
