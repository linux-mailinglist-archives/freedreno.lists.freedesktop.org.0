...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1493292FAC
	for <lists+freedreno@lfdr.de>; Mon, 19 Oct 2020 22:45:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 770F96EA97;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 02/23] drm/msm/gem: Add obj->lock wrappers
