...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E09A54B3240
	for <lists+freedreno@lfdr.de>; Sat, 12 Feb 2022 02:02:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 100FB10EB30;
...
Subject: Re: [Freedreno] [PATCH 7/7] drm/msm/dpu: pull connector from
