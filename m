...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 055EA6A22C1
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 21:02:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C5C410E5DB;
...
Subject: [Freedreno] [PATCH v6 05/15] dma-buf/sync_file: Add SET_DEADLINE
 ioctl
