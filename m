...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B727D702922
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 11:41:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9979210E1BE;
...
Subject: [Freedreno] [PATCH v2 07/12] drm/msm: Use regular fbdev I/O helpers
