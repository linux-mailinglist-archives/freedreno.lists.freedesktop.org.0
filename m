...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 536427F2258
	for <lists+freedreno@lfdr.de>; Tue, 21 Nov 2023 01:40:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6574810E012;
...
Subject: [Freedreno] [PATCH v2 5/7] drm/msm/gem: Cleanup submit_cleanup_bo()
