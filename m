...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A32AF6A6305
	for <lists+freedreno@lfdr.de>; Tue, 28 Feb 2023 23:58:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE3D610E137;
...
Subject: [Freedreno] [PATCH v8 07/16] dma-buf/sync_file: Support (E)POLLPRI
