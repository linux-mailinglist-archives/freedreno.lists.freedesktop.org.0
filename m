...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0592354625
	for <lists+freedreno@lfdr.de>; Mon,  5 Apr 2021 19:42:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90D9289EBD;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 5/8] drm/msm: Add $debugfs/gem stats on resident
 objects
