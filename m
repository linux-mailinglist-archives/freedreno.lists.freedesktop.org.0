...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7572771F004
	for <lists+freedreno@lfdr.de>; Thu,  1 Jun 2023 19:00:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5382610E592;
...
Subject: [Freedreno] [PATCH v3 6/7] drm/msm/dsi: Add phy configuration for
 MSM8226
