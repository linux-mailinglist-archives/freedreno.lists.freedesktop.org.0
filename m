...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2D48249B27
	for <lists+freedreno@lfdr.de>; Wed, 19 Aug 2020 12:52:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 520F46E219;
...
Subject: Re: [Freedreno] [PATCH 10/20] drm/omapdrm: Introduce GEM object
 functions
