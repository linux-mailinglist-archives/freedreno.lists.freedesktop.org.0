...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3359243899
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 12:33:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96BC16E9A8;
...
Subject: Re: [Freedreno] [PATCH 20/20] drm: Remove obsolete GEM and PRIME
...
Content-Type: multipart/mixed; boundary="===============0135991872=="
