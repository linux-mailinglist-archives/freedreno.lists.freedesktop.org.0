...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8041716C37
	for <lists+freedreno@lfdr.de>; Tue, 30 May 2023 20:24:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC94310E3EF;
...
Subject: [Freedreno] [PATCH v2 3/7] dt-bindings: display/msm: qcom,
