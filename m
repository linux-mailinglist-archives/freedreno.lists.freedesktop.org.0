...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF26560D9B4
	for <lists+freedreno@lfdr.de>; Wed, 26 Oct 2022 05:26:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCDB410E375;
...
Subject: [Freedreno] [PATCH v3 08/12] drm/msm/dp: Don't enable HPD
 interrupts for edp
