...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F16A96A22C8
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 21:02:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AABA10ED16;
...
Subject: [Freedreno] [PATCH v6 08/15] drm/scheduler: Add fence deadline
 support
