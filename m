...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7947955AD1D
	for <lists+freedreno@lfdr.de>; Sun, 26 Jun 2022 00:55:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0F2410F075;
...
Subject: [Freedreno] [PATCH 11/15] drm/gem: Add LRU/shrinker helper
