...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 221F9297507
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 18:50:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5EE96F8FD;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 15/23] drm/msm: Protect ring->submits with
 it's own lock
