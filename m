...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9636510DEA
	for <lists+freedreno@lfdr.de>; Wed, 27 Apr 2022 03:32:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6156610E11C;
...
Subject: Re: [Freedreno] [PATCH 02/25] drm/msm/dpu: do not limit the zpos
 property
