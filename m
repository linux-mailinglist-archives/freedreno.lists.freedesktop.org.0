...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20F706543C1
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:06:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D434C10E549;
...
Subject: [Freedreno] [PATCH v10 06/15] drm/msm/dp: disable
