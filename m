...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6652C64C699
	for <lists+freedreno@lfdr.de>; Wed, 14 Dec 2022 11:07:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B7A710E3A8;
	Wed, 14 Dec 2022 10:06:45 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v9 03/15] drm/msm/dp: use atomic callbacks for
 DP bridge ops
