...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C34AC6C1510
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:44:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C58B10E1E1;
...
Subject: [Freedreno] [PATCH v2 01/23] drm/msm: Pre-allocate hw_fence
