...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5600F6BA242
	for <lists+freedreno@lfdr.de>; Tue, 14 Mar 2023 23:18:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A32A10E2CD;
...
Subject: [Freedreno] [PATCH] drm: msm: adreno: Disable preemption on Adreno
 510
