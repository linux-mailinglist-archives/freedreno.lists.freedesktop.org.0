...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AAB81DC760
	for <lists+freedreno@lfdr.de>; Thu, 21 May 2020 09:11:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 218BE6E909;
...
Subject: [Freedreno] [RFC PATCH linux-next] drm/msm/dpu:
 dpu_setup_dspp_pcc() can be static
