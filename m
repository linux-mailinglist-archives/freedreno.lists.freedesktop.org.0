...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CFEB492F7A
	for <lists+freedreno@lfdr.de>; Tue, 18 Jan 2022 21:39:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F42010E491;
...
Subject: [Freedreno] [v3 0/3] drm/msm/dsi: Add 10nm dsi phy tuning
