...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CECE4DA614
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 00:12:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D6D010E423;
...
Subject: [Freedreno] [PATCH v2 4/6] drm/vc4: change vc4 driver to use
