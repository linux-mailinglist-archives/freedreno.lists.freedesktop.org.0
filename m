...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 68D19416C40
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:52:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CF586EE1E;
...
Subject: [Freedreno] [PATCH v2 01/17] drm: cleanup:
