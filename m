...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B894B6EB52F
	for <lists+freedreno@lfdr.de>; Sat, 22 Apr 2023 00:47:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76E8510E3B9;
...
Subject: [Freedreno] [PATCH 1/2] drm/msm/dpu: remove DPU_DSPP_GC handling in
 dspp flush
