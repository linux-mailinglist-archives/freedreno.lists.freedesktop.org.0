...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D818631FC09
	for <lists+freedreno@lfdr.de>; Fri, 19 Feb 2021 16:34:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26B0C6E059;
...
Subject: [Freedreno] [PATCH v3 02/11] drm: Rename plane atomic_check state
 names
