...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6918E21797A
	for <lists+freedreno@lfdr.de>; Tue,  7 Jul 2020 22:36:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFC796E348;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 0/2] drm/msm/adreno: cleanup some packet building
