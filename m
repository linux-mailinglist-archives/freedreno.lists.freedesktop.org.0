...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A5A9570954
	for <lists+freedreno@lfdr.de>; Mon, 11 Jul 2022 19:42:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7AFAF903A9;
...
Subject: Re: [Freedreno] [PATCH v2 2/4] drm/msm/dsi: fetch DSC pps payload
 from struct mipi_dsi_device
