...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE0BB7BC136
	for <lists+freedreno@lfdr.de>; Fri,  6 Oct 2023 23:39:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A01910E576;
...
Subject: [Freedreno] [PATCH v6 3/7] drm/msm/dp: use drm_bridge_hpd_notify()
