...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 81A41546B94
	for <lists+freedreno@lfdr.de>; Fri, 10 Jun 2022 19:20:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80FE610E474;
...
Subject: [Freedreno] [PATCH] drm/msm/gem: Drop early returns in close/purge
 vma
