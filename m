...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E0792B4DDD
	for <lists+freedreno@lfdr.de>; Mon, 16 Nov 2020 18:47:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33B6F6EA11;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 2/3] drm/msm/shrinker: We can vmap shrink
 active_list too
