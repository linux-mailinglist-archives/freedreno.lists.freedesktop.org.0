...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AA65677869
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 11:06:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A86C10E348;
...
Subject: [Freedreno] [PATCH 04/10] drm/fbdev-generic: Initialize fb-helper
