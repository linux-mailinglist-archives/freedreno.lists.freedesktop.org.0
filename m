...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A8B764C69D
	for <lists+freedreno@lfdr.de>; Wed, 14 Dec 2022 11:07:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C03C10E3B2;
...
Subject: [Freedreno] [PATCH v9 09/15] drm/msm/disp/dpu: use atomic
