...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB1E9EADB2
	for <lists+freedreno@lfdr.de>; Thu, 31 Oct 2019 11:44:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99D4E6EE1B;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 RDfA==
Subject: [Freedreno] [PATCH v4 0/7] DRM/MSM: Add support for MSM8956 and
 Adreno 510
