...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41E645077BB
	for <lists+freedreno@lfdr.de>; Tue, 19 Apr 2022 20:15:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 88AA710E177;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.19 10/12] drm/msm/mdp5: check the
 return of kzalloc()
