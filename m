...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1E259F588
	for <lists+freedreno@lfdr.de>; Tue, 27 Aug 2019 23:50:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6365389AB7;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 2S2w==
Subject: [Freedreno] [PATCH 6/9] drm/msm: add kms->flush_commit()
