...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C0F55B18C
	for <lists+freedreno@lfdr.de>; Sun, 30 Jun 2019 22:37:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 05ACB89DDF;
	Sun, 30 Jun 2019 20:36:58 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 TkEQ==
Subject: [Freedreno] [PATCH 3/4] drm: add helper to lookup panel-id
