...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5ED2A60A054
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:20:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52B1B10E3AA;
...
Subject: [Freedreno] [PATCH v2 01/21] drm/komeda: Don't set struct
