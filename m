...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E23370A1A0
	for <lists+freedreno@lfdr.de>; Fri, 19 May 2023 23:20:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A842510E621;
	Fri, 19 May 2023 21:20:55 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v2 1/4] drm/msm/dsi: Adjust pclk rate for
 compression
