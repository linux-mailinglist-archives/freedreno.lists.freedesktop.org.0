...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 586386543BB
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:06:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 16C7D10E52B;
...
Subject: [Freedreno] [PATCH v10 09/15] drm/msm/disp/dpu: use atomic
