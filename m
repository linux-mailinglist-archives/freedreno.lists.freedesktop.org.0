...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44D466F0B8F
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 19:54:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6091F10EBB8;
...
Subject: [Freedreno] [PATCH v2 7/9] drm/doc: Relax fdinfo string constraints
