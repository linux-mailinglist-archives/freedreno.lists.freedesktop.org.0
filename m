...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA7507DA382
	for <lists+freedreno@lfdr.de>; Sat, 28 Oct 2023 00:34:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D7AD10EA85;
	Fri, 27 Oct 2023 22:33:56 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v7 01/10] drm: Introduce pixel_source DRM
 plane property
