...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79105416C20
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 661C06EE14;
...
Subject: [Freedreno] [PATCH v2 14/17] drm/gma500: cleanup:
