...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0BB0474B4
	for <lists+freedreno@lfdr.de>; Sun, 16 Jun 2019 15:29:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B05189127;
...
Subject: [Freedreno] [PATCH 2/6] dt-bindings: display: msm: gmu: add
