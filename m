...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ACA3C30BED
	for <lists+freedreno@lfdr.de>; Fri, 31 May 2019 11:46:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 675EA892CD;
...
Subject: [Freedreno] [PATCH v3 2/6] drm/msm: add support for per-CRTC
