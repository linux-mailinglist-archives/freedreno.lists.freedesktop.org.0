...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 911B84AA1FE
	for <lists+freedreno@lfdr.de>; Fri,  4 Feb 2022 22:17:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA92610E31A;
...
Subject: [Freedreno] [PATCH 05/12] drm/msm/dpu: add an API to reset the
