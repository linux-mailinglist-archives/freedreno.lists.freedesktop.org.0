...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A7CE6EFAFA
	for <lists+freedreno@lfdr.de>; Wed, 26 Apr 2023 21:23:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 905D410EA23;
...
Subject: [Freedreno] [PATCH v2 2/4] drm/msm/dpu: remove DPU_DSPP_IGC
