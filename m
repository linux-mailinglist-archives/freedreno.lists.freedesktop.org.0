...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B407A4F1956
	for <lists+freedreno@lfdr.de>; Mon,  4 Apr 2022 18:35:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58DE310E88F;
...
Subject: [Freedreno] [PATCH v6 10/14] drm/msm/disp/dpu1: Add support for DSC
 in topology
