...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2504F69BC30
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFFF710E56F;
...
Subject: [Freedreno] [PATCH v4 09/14] drm/syncobj: Add deadline support for
 syncobj waits
