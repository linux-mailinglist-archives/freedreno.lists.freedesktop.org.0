...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FFEA7B5EA0
	for <lists+freedreno@lfdr.de>; Tue,  3 Oct 2023 03:21:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 585B810E23C;
...
Subject: [Freedreno] [PATCH v2 4/6] drm/msm: mdss: add support for SDM670
