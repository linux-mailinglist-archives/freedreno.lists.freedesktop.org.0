...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6492A5A3F5A
	for <lists+freedreno@lfdr.de>; Sun, 28 Aug 2022 21:22:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA5F410EFAF;
	Sun, 28 Aug 2022 19:22:40 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v5 6/6] arm64: dts: qcom: sc7280: Add Reset
 support for gpu
