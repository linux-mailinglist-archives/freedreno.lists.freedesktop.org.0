...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 493D356C769
	for <lists+freedreno@lfdr.de>; Sat,  9 Jul 2022 08:00:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B603110ECDE;
...
Subject: [Freedreno] [PATCH v2 7/7] drm/msm/a6xx: Handle GMU prepare-slumber
 hfi failure
