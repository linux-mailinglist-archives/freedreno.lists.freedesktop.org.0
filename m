...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C564A6478EF
	for <lists+freedreno@lfdr.de>; Thu,  8 Dec 2022 23:38:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BDCD10E4E0;
...
Subject: [Freedreno] [PATCH v11 2/5] dt-bindings: msm/dp: add data-lanes and
