...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B17F4FCBFF
	for <lists+freedreno@lfdr.de>; Tue, 12 Apr 2022 03:53:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D808A10FB3E;
...
Subject: Re: [Freedreno] [Intel-gfx] [PATCH v5 04/10] drm/hdcp: Expand HDCP
