...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B98669C69F
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 09:29:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA8B310E5F2;
...
Subject: Re: [Freedreno] [PATCH v4 07/14] dma-buf/sw_sync: Add fence
 deadline support
