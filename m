...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C49C70FB26
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 18:00:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01EED10E67E;
...
Subject: [Freedreno] [PATCH v5 5/7] drm: Add fdinfo memory stats
