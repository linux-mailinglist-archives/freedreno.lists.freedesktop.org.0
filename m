...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10A5D2406AD
	for <lists+freedreno@lfdr.de>; Mon, 10 Aug 2020 15:38:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA44989FDD;
	Mon, 10 Aug 2020 13:38:34 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 1/2] dt-bindings: msm: disp: add yaml schemas
 for DPU and DSI bindings
...
Cc: Krishna Manikandan <mkrishn@codeaurora.org>, robh@kernel.org,
