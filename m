...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41B8660A10E
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:21:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E55F010E424;
...
Subject: [Freedreno] [PATCH v2 07/21] drm/logicvc: Don't set struct
