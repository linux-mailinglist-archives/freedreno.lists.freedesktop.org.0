...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25DCE243693
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 10:37:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A7836E9D1;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 14/20] drm/tegra: Introduce GEM object functions
