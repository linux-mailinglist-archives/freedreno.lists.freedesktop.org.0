...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A9B56F360C
	for <lists+freedreno@lfdr.de>; Mon,  1 May 2023 20:45:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1B4810E442;
...
Subject: [Freedreno] [PATCH v3 6/9] drm/msm: Add memory stats to fdinfo
