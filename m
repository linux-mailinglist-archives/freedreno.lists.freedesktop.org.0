...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA076416C2F
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72E586EE2A;
...
Subject: [Freedreno] [PATCH v2 08/17] drm/radeon: cleanup:
