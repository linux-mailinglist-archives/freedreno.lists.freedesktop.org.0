...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79525553055
	for <lists+freedreno@lfdr.de>; Tue, 21 Jun 2022 12:59:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 892421122C4;
	Tue, 21 Jun 2022 10:58:47 +0000 (UTC)
...
Subject: [Freedreno] [v3 2/5] drm/bridge: use atomic enable/disable
