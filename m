...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 273AE2EBDC5
	for <lists+freedreno@lfdr.de>; Wed,  6 Jan 2021 13:34:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BADA89C84;
...
Subject: Re: [Freedreno] [PATCH RESEND 0/7] iommu: Permit modular builds of
 io-pgtable drivers
...
Cc: robh@kernel.org, kernel-team@android.com, tomeu.vizoso@collabora.com,
 pdaly@codeaurora.org, airlied@linux.ie, robin.murphy@arm.com, joro@8bytes.org,
 iommu@lists.linux-foundation.org, dri-devel@lists.freedesktop.org,
 steven.price@arm.com, robdclark@gmail.com, alyssa.rosenzweig@collabora.com,
 daniel@ffwll.ch, freedreno@lists.freedesktop.org, sean@poorly.run,
