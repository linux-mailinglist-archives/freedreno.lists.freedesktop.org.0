...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D501B520EC8
	for <lists+freedreno@lfdr.de>; Tue, 10 May 2022 09:41:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 68A1D10F5AB;
...
Subject: [Freedreno] [PATCH 1/2] drm/msm/a6xx: Add support for a new 7c3 sku
