...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E18D654839
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 23:15:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0413B10E189;
...
Subject: [Freedreno] [RFC PATCH v2 2/3] drm: Adjust atomic checks for solid
 fill color
