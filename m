...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A179102B72
	for <lists+freedreno@lfdr.de>; Tue, 19 Nov 2019 19:05:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 392246E249;
...
Subject: Re: [Freedreno] [PATCH v1] msm:disp:dpu1: add support for display
 for SC7180 target
