...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A15E416C1B
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3EC626EE09;
...
Subject: [Freedreno] [PATCH v2 15/17] drm/amd: cleanup:
