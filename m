...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 367BF41ED95
	for <lists+freedreno@lfdr.de>; Fri,  1 Oct 2021 14:34:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80CF46E52F;
...
Subject: [Freedreno] [PATCH 2/3] drm/msm/dsi: fix off by one in
