...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC09B7A2878
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 22:48:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FCCD10E684;
...
Subject: [Freedreno] [PATCH v2 3/7] drm/msm/dp: use drm_bridge_hpd_notify()
