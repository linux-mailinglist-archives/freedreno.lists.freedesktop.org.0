...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B55EB587F72
	for <lists+freedreno@lfdr.de>; Tue,  2 Aug 2022 17:52:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F2EE90521;
...
Subject: [Freedreno] [PATCH v4 07/15] drm/msm/gem: Consolidate pin/unpin
 paths
