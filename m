...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B174493332
	for <lists+freedreno@lfdr.de>; Wed, 19 Jan 2022 03:56:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7E0610E3EC;
...
Subject: Re: [Freedreno] [v3 1/3] dt-bindings: msm/dsi: Add 10nm dsi phy
 tuning properties
