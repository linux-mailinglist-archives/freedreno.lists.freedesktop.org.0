...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1021F3B04F8
	for <lists+freedreno@lfdr.de>; Tue, 22 Jun 2021 14:43:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CA256E4EC;
...
Subject: [Freedreno] [v2 3/3] drm/msm/dsi: Add DSI support for SC7280
