...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD9775100B3
	for <lists+freedreno@lfdr.de>; Tue, 26 Apr 2022 16:42:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2207E10E3C2;
	Tue, 26 Apr 2022 14:42:18 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v6 07/19] drm/msm/dpu: add writeback blocks to
 DPU RM
