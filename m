...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EE4A6FE6E3
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:08:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06C1310E55E;
...
Subject: [Freedreno] [PATCH v6 1/8] drm/msm/dpu: add dsc blocks for
