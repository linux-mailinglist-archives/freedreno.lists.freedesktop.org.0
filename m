...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7067554BC9A
	for <lists+freedreno@lfdr.de>; Tue, 14 Jun 2022 23:14:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD1DC112F22;
...
Subject: [Freedreno] [PATCH v2 0/3] Expand CRC to support interface blocks
