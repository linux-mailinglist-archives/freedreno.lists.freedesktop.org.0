...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 85D614DD285
	for <lists+freedreno@lfdr.de>; Fri, 18 Mar 2022 02:46:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B85A10E90C;
...
Subject: [Freedreno] [PATCH v4 3/4] drm: introduce
