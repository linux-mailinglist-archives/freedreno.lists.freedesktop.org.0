...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C86DE5A5A0C
	for <lists+freedreno@lfdr.de>; Tue, 30 Aug 2022 05:33:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A07310E8A2;
	Tue, 30 Aug 2022 03:33:29 +0000 (UTC)
...
Subject: [Freedreno] [RFC PATCH 2/3] drm/msm: filter out modes for DSI
