...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EF3E54BC97
	for <lists+freedreno@lfdr.de>; Tue, 14 Jun 2022 23:13:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAACA112F54;
...
Subject: [Freedreno] [PATCH v2 2/3] drm/msm/dpu: Add MISR register support
 for interface
