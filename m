...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BF695818FE
	for <lists+freedreno@lfdr.de>; Tue, 26 Jul 2022 19:51:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E100D96400;
...
Subject: [Freedreno] [PATCH v3 09/15] drm/gem: Add LRU/shrinker helper
