...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[0.0.0.0:email,linaro.org:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,outlook.com:email,outlook.com:dkim]
X-Rspamd-Queue-Id: 2403D68164
