...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9281A5235D6
	for <lists+freedreno@lfdr.de>; Wed, 11 May 2022 16:42:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BBCD10FB56;
...
Subject: Re: [Freedreno] [RFC] drm/msm: Add initial ci/ subdirectory
