...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE42642F6CC
	for <lists+freedreno@lfdr.de>; Fri, 15 Oct 2021 17:15:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B21AD6EDDB;
...
Subject: Re: [Freedreno] [PATCH 02/15] drm/amdgpu: use drm_* functions
