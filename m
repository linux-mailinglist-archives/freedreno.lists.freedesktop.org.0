...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 243524F3C9F
	for <lists+freedreno@lfdr.de>; Tue,  5 Apr 2022 18:29:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C22F010EB3D;
	Tue,  5 Apr 2022 16:29:21 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH] drm/msm/dsi: fix error checks and return
 values for DSI xmit functions
...
Cc: David Airlie <airlied@linux.ie>, linux-arm-msm@vger.kernel.org,
 ...
 Daniel Vetter <daniel@ffwll.ch>, freedreno@lists.freedesktop.org, Dan
