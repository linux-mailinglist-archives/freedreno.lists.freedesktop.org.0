...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B0572E854E
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB312893EA;
...
Subject: [Freedreno] [PATCH 19/31] drm/panfrost: convert to use
 devm_pm_opp_* API
