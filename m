...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 906AD7DA37F
	for <lists+freedreno@lfdr.de>; Sat, 28 Oct 2023 00:34:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 137A410EA74;
	Fri, 27 Oct 2023 22:33:53 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v7 03/10] drm: Add solid fill pixel source
