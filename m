...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04BA42E854F
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A150589354;
...
Subject: [Freedreno] [PATCH 14/31] spi: spi-qcom-qspi: convert to use
 devm_pm_opp_* API
