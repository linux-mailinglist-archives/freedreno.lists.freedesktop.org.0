...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9602C74FC28
	for <lists+freedreno@lfdr.de>; Wed, 12 Jul 2023 02:34:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 62BCA10E46C;
...
Subject: [Freedreno] [PATCH v4 2/4] drm/msm/dpu: use dpu core's major
