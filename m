...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A93A4EB64C
	for <lists+freedreno@lfdr.de>; Wed, 30 Mar 2022 01:00:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B40A210F0D4;
	Tue, 29 Mar 2022 23:00:25 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 2/9] drm/msm/gpu: Drop duplicate fence counter
