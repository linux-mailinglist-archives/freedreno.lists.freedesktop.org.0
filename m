...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 93CE946C42C
	for <lists+freedreno@lfdr.de>; Tue,  7 Dec 2021 21:06:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 313056E58B;
...
Subject: Re: [Freedreno] [PATCH v2 4/4] drm/msm/dpu: fix CDP setup to
