...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAE46275AF4
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA2576E9D0;
...
Subject: Re: [Freedreno] [PATCH v3 07/22] drm/imx/dcss: Initialize DRM
