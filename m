...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6866A50EC4F
	for <lists+freedreno@lfdr.de>; Tue, 26 Apr 2022 00:56:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D80D010ED5A;
...
Subject: [Freedreno] [PATCH v2] drm/msm/dp: tear down main link at unplug
 handle immediately
