...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EBD4F6FF8C3
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 19:53:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 139B610E5C0;
...
Subject: [Freedreno] [PATCH v7 1/8] drm/msm/dpu: add dsc blocks for
