...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B85F969BC38
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECB6F10E56E;
...
Subject: [Freedreno] [PATCH v4 12/14] drm/msm: Add deadline based boost
 support
