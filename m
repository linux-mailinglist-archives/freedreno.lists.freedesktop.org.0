...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A1972E8CD0
	for <lists+freedreno@lfdr.de>; Sun,  3 Jan 2021 16:25:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 354288991A;
...
Subject: [Freedreno] [PATCH 28/31] PM / devfreq: imx8m-ddrc: convert to use
 devm_pm_opp_* API
