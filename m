...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C49C748DDF
	for <lists+freedreno@lfdr.de>; Wed,  5 Jul 2023 21:32:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E400C10E3B9;
...
Subject: [Freedreno] [PATCH v2 2/5] drm/msm/dpu: Drop unused num argument
