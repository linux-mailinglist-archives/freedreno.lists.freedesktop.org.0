...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 42E756C1505
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:44:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0666410E1CA;
...
Subject: [Freedreno] [PATCH v2 00/23] drm/msm+PM+icc: Make job_run()
 reclaim-safe
