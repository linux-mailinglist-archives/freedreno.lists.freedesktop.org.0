...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 85ABB42CBEA
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 22:50:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4D426EB65;
...
Subject: [Freedreno] [PATCH v4 20/20] drm: cleanup: remove acquire_ctx from
 drm_mode_config
