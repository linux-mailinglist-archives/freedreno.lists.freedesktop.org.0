...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75201107B86
	for <lists+freedreno@lfdr.de>; Sat, 23 Nov 2019 00:38:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FD8C6F568;
...
Subject: [Freedreno] [PATCH v2 6/8] drm/msm: Refactor address space
 initialization
