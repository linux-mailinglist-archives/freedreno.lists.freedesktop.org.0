...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 178096A6310
	for <lists+freedreno@lfdr.de>; Tue, 28 Feb 2023 23:59:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5190010E156;
...
Subject: [Freedreno] [PATCH v8 06/16] dma-buf/sync_file: Add SET_DEADLINE
 ioctl
