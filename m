...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AC0142F5D1
	for <lists+freedreno@lfdr.de>; Fri, 15 Oct 2021 16:42:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A134A6E9F9;
...
Subject: [Freedreno] [PATCH 08/15] drm/msm: replace
