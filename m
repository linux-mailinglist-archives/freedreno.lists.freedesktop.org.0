...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D523DA5C0D9
	for <lists+freedreno@lfdr.de>; Tue, 11 Mar 2025 13:25:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E03D10E59B;
	Tue, 11 Mar 2025 12:25:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=quicinc.com header.i=@quicinc.com header.b="ih5sBx86";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com
 [205.220.180.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D05710E59B;
...
Subject: [PATCH v2 09/10] drm/bridge: anx7625: update bridge_ops and sink
 detect logic
...
X-Authority-Analysis: v=2.4 cv=fZ9Xy1QF c=1 sm=1 tr=0 ts=67d02b96 cx=c_pps
 ...
 a=Vs1iUdzkB0EA:10 a=COk6AnOGAAAA:8 a=KzNNLWg-im-pYHkXERoA:9
