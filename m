...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C9C35FC4C5
	for <lists+freedreno@lfdr.de>; Wed, 12 Oct 2022 14:03:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB66310E44B;
...
Subject: [Freedreno] [PATCH v8 03/15] drm/msm/dp: use atomic callbacks for
 DP bridge ops
