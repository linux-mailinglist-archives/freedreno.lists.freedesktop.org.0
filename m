...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3904E6FF54D
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 16:59:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F096310E4F7;
...
Subject: [Freedreno] [PATCH v3 1/2] iommu/arm-smmu-qcom: Fix missing
 adreno_smmu's
