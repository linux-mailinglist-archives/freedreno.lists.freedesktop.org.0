...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB45B996EC
	for <lists+freedreno@lfdr.de>; Thu, 22 Aug 2019 16:37:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9A236EB6A;
	Thu, 22 Aug 2019 14:37:35 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v6 6/7] drm/msm/gpu: add ocmem init/cleanup
 functions
