...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CF424756C0
	for <lists+freedreno@lfdr.de>; Wed, 15 Dec 2021 11:43:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 489CC10E44A;
...
Subject: [Freedreno] [PATCH v2 2/5] drm/dp: Move DP declarations into
