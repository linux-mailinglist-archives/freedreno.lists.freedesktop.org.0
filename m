...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB4696E027F
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 01:25:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0774910E9F4;
...
Subject: [Freedreno] [PATCH v6 2/7] drm/msm: Add MSM-specific DSC helper
 methods
