...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA16C6DA0D
	for <lists+freedreno@lfdr.de>; Fri, 19 Jul 2019 05:59:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8D6D6E4CE;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.2 076/171] drm/msm/adreno: Ensure that
 the zap shader region is big enough
