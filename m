...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE61E6814D5
	for <lists+freedreno@lfdr.de>; Mon, 30 Jan 2023 16:21:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EF1110E284;
...
Subject: [Freedreno] [v1 3/3] drm/msm/disp/dpu1: reserve the resources on
 topology change
