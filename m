...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3D951010A5
	for <lists+freedreno@lfdr.de>; Tue, 19 Nov 2019 02:23:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 62B4A6E866;
...
Subject: Re: [Freedreno] [PATCH v1] msm:disp:dpu1: setup display datapath
 for SC7180 target
