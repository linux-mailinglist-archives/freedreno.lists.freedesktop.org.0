...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51AB42E8CD3
	for <lists+freedreno@lfdr.de>; Sun,  3 Jan 2021 16:25:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F37C89950;
...
Subject: [Freedreno] [PATCH 29/31] PM / devfreq: imx-bus: convert to use
 devm_pm_opp_* API
