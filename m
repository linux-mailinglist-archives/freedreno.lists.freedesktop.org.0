...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4618F296BC7
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 11:09:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6C746E4E6;
...
Subject: Re: [Freedreno] [PATCH v3 07/23] drm/msm/submit: Move
 copy_from_user ahead of locking bos
