...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6AEA26F5FC0
	for <lists+freedreno@lfdr.de>; Wed,  3 May 2023 22:11:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDC9B10E359;
...
Subject: [Freedreno] [PATCH v4 3/7] drm/msm/dpu: add DPU_PINGPONG_DSC bits
