...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E45DF673BBE
	for <lists+freedreno@lfdr.de>; Thu, 19 Jan 2023 15:27:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9F25110E95B;
...
Subject: [Freedreno] [PATCH Resend v11 04/15] drm/msm/dp: use the eDP bridge
 ops to validate eDP modes
