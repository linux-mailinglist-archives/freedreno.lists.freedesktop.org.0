...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 387DE424DBF
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 09:09:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E82E6F390;
...
Subject: [Freedreno] [PATCH v2 01/11] drm/msm/dsi: add support for dsc data
