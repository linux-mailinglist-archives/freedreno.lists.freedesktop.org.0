...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 98FFDBC855
	for <lists+freedreno@lfdr.de>; Tue, 24 Sep 2019 14:59:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD11C6EA21;
...
Subject: [Freedreno] [PATCH v2 0/9] drm/print: add and use
 drm_debug_enabled()
