...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFD5C651BE2
	for <lists+freedreno@lfdr.de>; Tue, 20 Dec 2022 08:45:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3A4B10E344;
	Tue, 20 Dec 2022 07:45:20 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 4/5] drm/msm/a6xx: Remove cx gdsc polling
 using 'reset'
