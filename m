...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A614C38FBC7
	for <lists+freedreno@lfdr.de>; Tue, 25 May 2021 09:31:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BCF96E9B7;
	Tue, 25 May 2021 07:31:35 +0000 (UTC)
...
Subject: [Freedreno] [v4 2/4] drm/panel-simple: Support for delays between
 GPIO & regulator
