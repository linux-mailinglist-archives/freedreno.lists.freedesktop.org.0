...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF4B26EFD6A
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 00:37:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 719B110EA61;
...
X-Mailer: b4 0.12.2
Subject: [Freedreno] [PATCH v4 08/22] drm/msm/dpu: Remove duplicate register
 defines from INTF
