...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C6F04F5A32
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A21B610F2CD;
...
Subject: [Freedreno] [PATCH v7 10/14] drm/msm/disp/dpu1: Add support for DSC
 in topology
