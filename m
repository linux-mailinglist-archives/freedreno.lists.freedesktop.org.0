...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6AEB64FA0CE
	for <lists+freedreno@lfdr.de>; Sat,  9 Apr 2022 02:54:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3CBD10E034;
	Sat,  9 Apr 2022 00:54:11 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v7 0/4] Allow drm_writeback_connector to accept
