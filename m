...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0FBF50AA4B
	for <lists+freedreno@lfdr.de>; Thu, 21 Apr 2022 22:49:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BBE010E010;
...
Subject: [Freedreno] [RFC 2/4] drm/msm/dpu: start using wb_idx in
 dpu_encoder_phys_wb
