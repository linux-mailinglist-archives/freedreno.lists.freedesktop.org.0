...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F010946C3AE
	for <lists+freedreno@lfdr.de>; Tue,  7 Dec 2021 20:30:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AE7B6ECAE;
...
Subject: Re: [Freedreno] [PATCH v2 1/4] drm/msm/dpu: drop scaler config from
 plane state
