...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CF9E78BBD3
	for <lists+freedreno@lfdr.de>; Tue, 29 Aug 2023 02:06:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6A1E10E385;
...
Subject: [Freedreno] [PATCH RFC v6 03/10] drm: Add solid fill pixel source
