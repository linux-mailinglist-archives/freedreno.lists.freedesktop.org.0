...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F0BD146A4D
	for <lists+freedreno@lfdr.de>; Thu, 23 Jan 2020 15:00:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB7896FCFD;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 08/22] drm/nouveau: Convert to struct
