...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9B805EFE4E
	for <lists+freedreno@lfdr.de>; Thu, 29 Sep 2022 22:04:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F74D10EC9C;
...
Subject: Re: [Freedreno] [PATCH v8 08/12] dt-bindings: display/msm: split
