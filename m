...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E68448853D
	for <lists+freedreno@lfdr.de>; Sat,  8 Jan 2022 19:09:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7390410F2B1;
...
Subject: [Freedreno] [PATCH v3 1/2] drm/msm/gpu: Wait for idle before
 suspending
