...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B2E94003E5
	for <lists+freedreno@lfdr.de>; Fri,  3 Sep 2021 19:09:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB8FB6E8B9;
...
Subject: [Freedreno] [PATCH v2 2/3] drm/msm/dsi: Add phy configuration for
 MSM8953
