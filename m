...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2F8025552
	for <lists+freedreno@lfdr.de>; Tue, 21 May 2019 18:15:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5593F89503;
...
Subject: [Freedreno] [PATCH v2 09/15] drm/msm/gpu: Move address space setup
 to the GPU targets
