...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C06CF1DC896
	for <lists+freedreno@lfdr.de>; Thu, 21 May 2020 10:30:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71A0C6E915;
...
Subject: [Freedreno] [RFC PATCH linux-next] drm/msm/a6xx:
 a6xx_hfi_send_start() can be static
