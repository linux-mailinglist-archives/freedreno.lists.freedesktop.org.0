...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6809C6A6316
	for <lists+freedreno@lfdr.de>; Tue, 28 Feb 2023 23:59:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C330C10E18F;
...
Subject: [Freedreno] [PATCH v8 12/16] drm/atomic-helper: Set fence deadline
 for vblank
