...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B05A2555229
	for <lists+freedreno@lfdr.de>; Wed, 22 Jun 2022 19:18:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3ECE4112468;
...
Subject: [Freedreno] [PATCH v4 3/4] drm/msm/dpu: Add MISR register support
 for interface
