...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 988946181EE
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:16:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20E5310E638;
...
Subject: [Freedreno] [PATCH v3 20/23] drm/fb-helper: Set flag in struct
