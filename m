...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C58D25AFDD
	for <lists+freedreno@lfdr.de>; Sun, 30 Jun 2019 15:15:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C48589C05;
	Sun, 30 Jun 2019 13:15:45 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 KQDw==
Subject: [Freedreno] [PATCH 2/3] drm/msm/dpu: remove dpu_mdss:hwversion
