...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 471D66EFD44
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 00:37:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 443E410EA59;
...
X-Mailer: b4 0.12.2
Subject: [Freedreno] [PATCH v4 02/22] drm/msm/dpu: Remove TE2 block and
