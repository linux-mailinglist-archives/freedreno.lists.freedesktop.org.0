...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4552E26D426
	for <lists+freedreno@lfdr.de>; Thu, 17 Sep 2020 09:05:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25FD56E13D;
...
Subject: Re: [Freedreno] [PATCH v2 00/21] Convert all remaining drivers to
...
Content-Type: multipart/mixed; boundary="===============2127883152=="
