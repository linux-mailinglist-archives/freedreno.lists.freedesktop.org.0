...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1ECE64B012
	for <lists+freedreno@lfdr.de>; Wed, 19 Jun 2019 04:32:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C2D76E285;
...
Subject: [Freedreno] [PATCH v2 4/6] firmware: qcom: scm: add support to
