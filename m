...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6A1A605E01
	for <lists+freedreno@lfdr.de>; Thu, 20 Oct 2022 12:42:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E2A510EDA8;
...
Subject: [Freedreno] [PATCH 12/21] drm/fb_helper: Rename field fbdev to info
