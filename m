...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05BF914254D
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 09:24:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CEC286E84A;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 13/22] drm/msm: Convert to CRTC VBLANK
 callbacks
