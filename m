...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF675425BFA
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:39:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C04D6F4CC;
...
Subject: [Freedreno] [PATCH v3 09/20] drm/omapdrm: cleanup:
