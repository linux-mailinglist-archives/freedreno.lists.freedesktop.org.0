...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 372C8643160
	for <lists+freedreno@lfdr.de>; Mon,  5 Dec 2022 20:14:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD05B10E111;
	Mon,  5 Dec 2022 19:14:50 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v8 0/5] Add data-lanes and link-frequencies to
 dp_out endpoint
