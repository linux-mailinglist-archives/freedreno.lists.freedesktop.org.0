...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DEB376F553
	for <lists+freedreno@lfdr.de>; Fri,  4 Aug 2023 00:02:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99EE210E684;
...
Subject: [Freedreno] [PATCH v3 4/9] PM / QoS: Decouple request alloc from
 dev_pm_qos_mtx
