...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7DA36F4BB9
	for <lists+freedreno@lfdr.de>; Tue,  2 May 2023 23:03:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D5E1210E091;
...
Subject: [Freedreno] [PATCH v3 0/7]  add DSC 1.2 dpu supports
