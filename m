...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C445274A5A1
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 23:11:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 41BBC10E4D8;
...
Subject: [Freedreno] [PATCH 09/12] drm/msm/adreno: Add adreno family
