...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66ECF42CB64
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 22:49:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A87D56EB15;
...
Subject: [Freedreno] [PATCH v4 01/20] drm: cleanup:
