...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 550DA74048E
	for <lists+freedreno@lfdr.de>; Tue, 27 Jun 2023 22:14:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A655010E32F;
...
X-Mailer: b4 0.12.3
Subject: [Freedreno] [PATCH v2 09/15] drm/msm/mdss: Add SM6125 support
