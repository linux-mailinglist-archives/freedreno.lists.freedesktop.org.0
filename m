...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FA7F996E3
	for <lists+freedreno@lfdr.de>; Thu, 22 Aug 2019 16:37:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09BE46EB6F;
...
Subject: [Freedreno] [PATCH v6 2/7] dt-bindings: display: msm: gmu: add
