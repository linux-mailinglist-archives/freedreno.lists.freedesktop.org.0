...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74EBC4B9397
	for <lists+freedreno@lfdr.de>; Wed, 16 Feb 2022 23:05:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0ED510E263;
...
Subject: [Freedreno] [PATCH v7 3/4] drm/msm/dpu: replace BIT(x) with
