...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B8F070F278
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 11:22:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8F6310E637;
...
Subject: [Freedreno] [PATCH v4 11/13] drm/fb-helper: Export helpers for
