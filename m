...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C92D7D7A79
	for <lists+freedreno@lfdr.de>; Thu, 26 Oct 2023 03:50:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3538610E72D;
...
Subject: Re: [Freedreno] [PATCH v5 5/6] soc: qcom: pmic-glink: switch to
 DRM_AUX_HPD_BRIDGE
