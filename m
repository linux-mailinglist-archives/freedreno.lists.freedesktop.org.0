...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66E53452A72
	for <lists+freedreno@lfdr.de>; Tue, 16 Nov 2021 07:23:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E59996E064;
...
Subject: [Freedreno] [PATCH v3 00/13] drm/msm: Add Display Stream
 Compression Support
