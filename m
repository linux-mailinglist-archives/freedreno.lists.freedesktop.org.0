...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SL7qBBYbr2lOOAIAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:10:14 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75B8223F3D5
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:10:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AAD510E5C2;
	Mon,  9 Mar 2026 19:10:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=nxp.com header.i=@nxp.com header.b="HCuGLTIW";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from DUZPR83CU001.outbound.protection.outlook.com
 (mail-northeuropeazon11012061.outbound.protection.outlook.com [52.101.66.61])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AEE5010E591;
...
Cc: Vinod Koul <vkoul@kernel.org>, Neil Armstrong <neil.armstrong@linaro.org>,
 ...
 UNGLinuxDriver@microchip.com, Geert Uytterhoeven <geert+renesas@glider.be>,
...
Subject: [PATCH v3 phy-next 18/24] net: renesas: rswitch: include PHY provider
 header
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Mar 2026 19:10:07.3201 (UTC)
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	TAGGED_RCPT(0.00)[freedreno,renesas,netdev,kernel];
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,lunn.ch:email,renesas.com:email,glider.be:email,nxp.com:dkim,nxp.com:email,nxp.com:mid,davemloft.net:email,armlinux.org.uk:email]
