...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE94424A75
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 01:20:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 136DB6E56D;
...
Subject: Re: [Freedreno] [PATCH v2 33/34] component: Remove
 component_master_ops and friends
