...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 314D1275B02
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3525B6E9E5;
...
Subject: [Freedreno] [PATCH v3 11/22] drm/omapdrm: Introduce GEM object
 functions
