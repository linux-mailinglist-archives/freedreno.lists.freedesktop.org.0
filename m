...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 628366C1522
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:44:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D09210E5A7;
...
Subject: [Freedreno] [PATCH v2 09/23] drm/msm/gem: Avoid obj lock in
 job_run()
