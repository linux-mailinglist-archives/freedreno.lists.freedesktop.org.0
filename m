...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E64F664FB4
	for <lists+freedreno@lfdr.de>; Wed, 11 Jan 2023 00:14:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEEC210E692;
...
Subject: [Freedreno] [PATCH v2 2/3] drm/msm/gpu: Bypass PM QoS constraint
 for idle clamp
