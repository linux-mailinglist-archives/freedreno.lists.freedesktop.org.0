...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7642379CBC3
	for <lists+freedreno@lfdr.de>; Tue, 12 Sep 2023 11:29:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3265510E3D1;
	Tue, 12 Sep 2023 09:29:33 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v4 3/6] drm/panfrost: Add fdinfo support for
 memory stats
