...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 86C0C416C2D
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6140D6EE1D;
...
Subject: [Freedreno] [PATCH v2 09/17] drm/omapdrm: cleanup:
