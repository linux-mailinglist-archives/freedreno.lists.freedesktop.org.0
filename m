...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D38928BC8
	for <lists+freedreno@lfdr.de>; Thu, 23 May 2019 22:47:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29D426E069;
...
Subject: Re: [Freedreno] [PATCH v2 2/6] drm/msm/a6xx: Remove duplicate irq
 disable from remove
