...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95C99707137
	for <lists+freedreno@lfdr.de>; Wed, 17 May 2023 20:52:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 39C1710E45E;
...
Subject: [Freedreno] [PATCH v11 6/9] drm/msm/dpu: Use fixed DRM DSC helper
