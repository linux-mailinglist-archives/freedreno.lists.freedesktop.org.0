...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A8EF41FD69
	for <lists+freedreno@lfdr.de>; Sat,  2 Oct 2021 19:28:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D9E86F501;
	Sat,  2 Oct 2021 17:28:11 +0000 (UTC)
...
Subject: Re: [Freedreno] [Intel-gfx] [PATCH v2 00/17] drm: cleanup: Use
