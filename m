...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FA627F224B
	for <lists+freedreno@lfdr.de>; Tue, 21 Nov 2023 01:40:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8421410E202;
...
Subject: [Freedreno] [PATCH v2 1/7] drm/msm/gem: Remove "valid" tracking
