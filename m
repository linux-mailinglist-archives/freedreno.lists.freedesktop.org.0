...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D65796D7186
	for <lists+freedreno@lfdr.de>; Wed,  5 Apr 2023 02:42:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C184810E815;
...
Subject: [Freedreno] [PATCH v4 2/6] drm/msm/dpu: Use DRM DSC helper for
 det_thresh_flatness
