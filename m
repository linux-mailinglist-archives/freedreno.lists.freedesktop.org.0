...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B9C56543CA
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:06:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F6F910E546;
...
Subject: [Freedreno] [PATCH v10 05/15] drm/msm/dp: use the eDP bridge ops to
 validate eDP modes
