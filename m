...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32511673BB6
	for <lists+freedreno@lfdr.de>; Thu, 19 Jan 2023 15:27:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE4D410E957;
...
Subject: [Freedreno] [PATCH Resend v11 02/15] drm/msm/dp: use atomic
 callbacks for DP bridge ops
