...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2A82618196
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:15:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A56C710E3C4;
...
Subject: [Freedreno] [PATCH v3 01/23] drm/komeda: Don't set struct
