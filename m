...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14805743F9B
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 18:20:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B785010E4B1;
...
Subject: [Freedreno] [PATCH] drm/msm/a6xx: Fix misleading comment
