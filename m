...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DD2ABEADB9
	for <lists+freedreno@lfdr.de>; Thu, 31 Oct 2019 11:44:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A01236EE22;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 B2Cg==
Subject: [Freedreno] [PATCH v4 4/7] drm/msm/dsi: Add configuration for 28nm
 PLL on family B
