...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B60F0351C0F
	for <lists+freedreno@lfdr.de>; Thu,  1 Apr 2021 20:42:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 300306E037;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH] drm/msm: Drop mm_lock in scan loop
