...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F0615B0CDF
	for <lists+freedreno@lfdr.de>; Wed,  7 Sep 2022 21:08:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 471F610E837;
	Wed,  7 Sep 2022 19:08:08 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v2 5/5] drm/msm/hdmi: move
 msm_hdmi_get_phy() to msm_hdmi_dev_probe()
