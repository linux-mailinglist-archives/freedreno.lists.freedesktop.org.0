...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C8FA4F1952
	for <lists+freedreno@lfdr.de>; Mon,  4 Apr 2022 18:35:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF4B210E607;
...
Subject: [Freedreno] [PATCH v6 08/14] drm/msm/dpu: don't use merge_3d if DSC
