...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 68DBE6FE76F
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:46:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96EBE10E571;
...
Subject: [Freedreno] [PATCH v8 8/8] drm/msm/dsi: update hdisplay calculation
