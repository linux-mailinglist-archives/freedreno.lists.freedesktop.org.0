...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB17D7B0DA6
	for <lists+freedreno@lfdr.de>; Wed, 27 Sep 2023 22:54:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 935A510E5B1;
...
Subject: [Freedreno] [PATCH v4 1/8] drm/msm/dp: tie dp_display_irq_handler()
 with dp driver
