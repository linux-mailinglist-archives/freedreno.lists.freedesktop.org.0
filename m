...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9846874319A
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C744C10E41F;
	Fri, 30 Jun 2023 00:25:59 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v4 1/7] drm: Introduce solid fill DRM plane
 property
