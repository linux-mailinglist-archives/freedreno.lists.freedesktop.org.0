...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B59667849A
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:25:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B28C10E52B;
...
Subject: [Freedreno] [PATCH v1 04/14] drm/msm/dp: correct configure
