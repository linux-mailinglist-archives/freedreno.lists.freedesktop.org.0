...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B7625F59B3
	for <lists+freedreno@lfdr.de>; Wed,  5 Oct 2022 20:17:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 497FB10E743;
...
Subject: [Freedreno] [PATCH v2 5/7] drm/msm/dsi: Account for DSC's
