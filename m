...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 108282F805A
	for <lists+freedreno@lfdr.de>; Fri, 15 Jan 2021 17:12:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D4CC6E46B;
...
Subject: Re: [Freedreno] [PATCH 02/10] drm: Rename plane atomic_check state
 names
...
Content-Type: multipart/mixed; boundary="===============1835017004=="
