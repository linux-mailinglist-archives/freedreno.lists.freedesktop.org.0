...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC8E756A793
	for <lists+freedreno@lfdr.de>; Thu,  7 Jul 2022 18:11:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 527C311B1F4;
...
Subject: [Freedreno] [PATCH 3/7] drm/msm: Fix cx collapse issue during
 recovery
