...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E97AA53D337
	for <lists+freedreno@lfdr.de>; Fri,  3 Jun 2022 23:28:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A0D510F057;
...
Subject: [Freedreno] [PATCH v1 1/2] drm/msm: enable msm irq after all
