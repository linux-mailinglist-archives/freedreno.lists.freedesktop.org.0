...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 538B3416C18
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 68B1C6EDF3;
...
Subject: [Freedreno] [PATCH v2 10/17] drm/nouveau: cleanup:
