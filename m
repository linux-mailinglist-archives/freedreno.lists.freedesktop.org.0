...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73DC26F4BC3
	for <lists+freedreno@lfdr.de>; Tue,  2 May 2023 23:03:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4371110E0F0;
...
Subject: [Freedreno] [PATCH v3 4/7] drm/msm/dpu: add PINGPONG_NONE to
