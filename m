...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3482275AF7
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5152E6E9D6;
...
Subject: [Freedreno] [PATCH v3 02/22] drm/armada: Introduce GEM object
 functions
