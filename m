...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C95EBD0402
	for <lists+freedreno@lfdr.de>; Wed,  9 Oct 2019 01:20:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30EBA6E8B2;
	Tue,  8 Oct 2019 23:20:07 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 E1bA==
Subject: Re: [Freedreno] [PATCH] drm/msm: Use the correct dma_sync calls
 harder
