...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEFEF5B0D76
	for <lists+freedreno@lfdr.de>; Wed,  7 Sep 2022 21:51:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB50E10E85C;
...
Subject: Re: [Freedreno] [PATCH v6 03/12] dt-bindings: display/msm: add
