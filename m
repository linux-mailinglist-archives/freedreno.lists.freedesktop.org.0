...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9E3E486F3C
	for <lists+freedreno@lfdr.de>; Fri,  7 Jan 2022 01:57:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75A4510EB2E;
...
Subject: [Freedreno] [PATCH v4] drm/msm/dp: add support of tps4 (training
 pattern 4) for HBR3
