...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F88471F003
	for <lists+freedreno@lfdr.de>; Thu,  1 Jun 2023 19:00:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7724E10E58B;
...
Subject: [Freedreno] [PATCH v3 5/7] drm/msm/dsi: Add configuration for
 MSM8226
