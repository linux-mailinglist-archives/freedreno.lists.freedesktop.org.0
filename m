...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 663ED702904
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 11:41:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFCEA10E1A6;
...
Subject: [Freedreno] [PATCH v2 01/12] fbdev: Add Kconfig options to select
