...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFF923DCEDA
	for <lists+freedreno@lfdr.de>; Mon,  2 Aug 2021 05:11:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67D4F6E3BB;
...
Subject: [Freedreno] [PATCH v2] drm:Fixes the following checkpatch error:
