...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3DB72E8551
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBE3D8941D;
...
Subject: [Freedreno] [PATCH 15/31] drm/msm: fix potential mem leak
