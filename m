...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 175DCD72D8
	for <lists+freedreno@lfdr.de>; Tue, 15 Oct 2019 12:11:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A91588958E;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 5wGw==
Subject: [Freedreno] [PATCH v3 0/7] DRM/MSM: Add support for MSM8956 and
 Adreno 510
