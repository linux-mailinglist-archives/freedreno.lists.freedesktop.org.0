...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FFA570291E
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 11:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01CA010E1BF;
...
Subject: [Freedreno] [PATCH v2 10/12] drm/fb-helper: Export helpers for
