...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B90113C005
	for <lists+freedreno@lfdr.de>; Wed, 15 Jan 2020 13:17:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D50B6E955;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 05/21] drm/amdgpu: Convert to CRTC VBLANK
 callbacks
