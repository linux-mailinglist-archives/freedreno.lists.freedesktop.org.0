...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 258207BC142
	for <lists+freedreno@lfdr.de>; Fri,  6 Oct 2023 23:39:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA36C10E57A;
	Fri,  6 Oct 2023 21:39:07 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v6 6/7] drm/msm/dp: delete EV_HPD_INIT_SETUP
