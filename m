...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 32D49397C86
	for <lists+freedreno@lfdr.de>; Wed,  2 Jun 2021 00:44:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3EC389FCA;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 0/6] iommu/arm-smmu: adreno-smmu page fault
 handling
