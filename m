...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A88D5B182
	for <lists+freedreno@lfdr.de>; Sun, 30 Jun 2019 22:36:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FBCC89DBC;
	Sun, 30 Jun 2019 20:36:41 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 sg1w==
Subject: [Freedreno] [PATCH 1/4] dt-bindings: chosen: document panel-id
 binding
