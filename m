...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6587587F5B
	for <lists+freedreno@lfdr.de>; Tue,  2 Aug 2022 17:52:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BB6290480;
...
Subject: [Freedreno] [PATCH v4 02/15] drm/msm: Small submit cleanup
