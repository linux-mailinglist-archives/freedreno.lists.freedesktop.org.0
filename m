...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A2AD471B9A
	for <lists+freedreno@lfdr.de>; Sun, 12 Dec 2021 17:39:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 441B910E5F1;
...
Subject: [Freedreno] [PATCH v2 1/2] drm/msm/a5xx: Add support for Adreno 506
 GPU
