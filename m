...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0ACEE54BC96
	for <lists+freedreno@lfdr.de>; Tue, 14 Jun 2022 23:13:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 033D3112F51;
...
Subject: [Freedreno] [PATCH v2 1/3] drm/msm/dpu: Move LM CRC code into
 separate method
