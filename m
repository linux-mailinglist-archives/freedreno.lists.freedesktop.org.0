...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63ED2717413
	for <lists+freedreno@lfdr.de>; Wed, 31 May 2023 05:10:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64C4110E462;
...
Subject: [Freedreno] [PATCH v3 2/3] arm64: dts: qcom: sc8280xp: Add GPU
 related nodes
