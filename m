...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC1F369BC3E
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3B5D10E582;
...
Subject: [Freedreno] [PATCH v4 05/14] dma-buf/sync_file: Add SET_DEADLINE
 ioctl
