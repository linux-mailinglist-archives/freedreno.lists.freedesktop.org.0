...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22F4E7CB850
	for <lists+freedreno@lfdr.de>; Tue, 17 Oct 2023 04:18:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2E7D10E0C2;
...
Subject: [Freedreno] [PATCH v4 1/6] dt-bindings: display/msm:
