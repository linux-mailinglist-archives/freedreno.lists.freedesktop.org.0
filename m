...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A9584B3133
	for <lists+freedreno@lfdr.de>; Sat, 12 Feb 2022 00:23:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89BBB10EB74;
...
Subject: [Freedreno] [PATCH] drm/msm: populate intf_audio_select() base on
 hardware capability
