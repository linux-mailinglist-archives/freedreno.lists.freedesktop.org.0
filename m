...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED78C707133
	for <lists+freedreno@lfdr.de>; Wed, 17 May 2023 20:52:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAFA310E26B;
...
Subject: [Freedreno] [PATCH v11 5/9] drm/msm: Add MSM-specific DSC helper
 methods
