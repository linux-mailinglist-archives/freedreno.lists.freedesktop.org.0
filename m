...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05BF6354621
	for <lists+freedreno@lfdr.de>; Mon,  5 Apr 2021 19:42:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C318F89EAC;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 3/8] drm/msm: Clear msm_obj->sgt in put_pages()
