...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 069702132B2
	for <lists+freedreno@lfdr.de>; Fri,  3 Jul 2020 06:20:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABEA66E8B7;
	Fri,  3 Jul 2020 04:20:00 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH] drm/msm/dpu: fix wrong return value in
 dpu_encoder_init()
...
Cc: David Airlie <airlied@linux.ie>, Sean Paul <sean@poorly.run>,
 ...
 Chen Tao <chentao107@huawei.com>, Rob Clark <robdclark@gmail.com>,
