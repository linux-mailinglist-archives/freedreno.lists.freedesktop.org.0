...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B092B176ACA
	for <lists+freedreno@lfdr.de>; Tue,  3 Mar 2020 03:46:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C68A6E93F;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.5 18/66] drm/msm/dsi/pll: call vco set
 rate explicitly
