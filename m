...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 02DD350EB6C
	for <lists+freedreno@lfdr.de>; Tue, 26 Apr 2022 00:11:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A84E10ED5A;
...
Subject: [Freedreno] [PATCH v1 0/2]  fix DP phy compliance test
