...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CD1B2AC92B
	for <lists+freedreno@lfdr.de>; Tue, 10 Nov 2020 00:15:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E8ECF894C9;
...
Subject: Re: [Freedreno] [RFC PATCH v1 3/3] drm/msm: Improve the a6xx page
 fault handler
