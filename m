...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FBBA42F5DC
	for <lists+freedreno@lfdr.de>; Fri, 15 Oct 2021 16:42:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C8186EDCC;
...
Subject: [Freedreno] [PATCH 03/15] drm/vc4: replace
