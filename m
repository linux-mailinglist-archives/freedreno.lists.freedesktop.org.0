...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E2DC24369C
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 10:37:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 518AF6E9B1;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 16/20] drm/vgem: Introduce GEM object functions
