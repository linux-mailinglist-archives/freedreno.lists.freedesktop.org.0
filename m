...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E06F3B7396
	for <lists+freedreno@lfdr.de>; Tue, 29 Jun 2021 15:58:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD249898B7;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH] drm/aperture: Pass DRM driver structure instead
 of driver name
