...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13BAC54E9B9
	for <lists+freedreno@lfdr.de>; Thu, 16 Jun 2022 21:01:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E26011A4E2;
...
Subject: [Freedreno] [PATCH v3 2/3] drm/msm/dpu: fix maxlinewidth for
 writeback block
