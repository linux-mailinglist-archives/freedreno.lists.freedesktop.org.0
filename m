...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 400DA64C6B4
	for <lists+freedreno@lfdr.de>; Wed, 14 Dec 2022 11:08:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECF0D10E3C0;
...
Subject: [Freedreno] [PATCH v9 14/15] drm/msm/disp/dpu: reset the datapath
