...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 621CA536729
	for <lists+freedreno@lfdr.de>; Fri, 27 May 2022 20:54:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C245C10E810;
...
Subject: [Freedreno] [PATCH 1/3] drm/msm/dpu: Move LM CRC code into separate
 method
