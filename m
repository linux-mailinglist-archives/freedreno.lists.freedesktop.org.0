...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CBA816B70C
	for <lists+freedreno@lfdr.de>; Wed, 17 Jul 2019 08:59:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E5EF6E241;
...
Subject: Re: [Freedreno] [PATCH v3 2/3] drm: plumb attaching dev thru to
 prime_pin/unpin
