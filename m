...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6A8560A11E
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:22:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4971E10E428;
...
Subject: [Freedreno] [PATCH v2 13/21] drm/fb-helper: Rename
