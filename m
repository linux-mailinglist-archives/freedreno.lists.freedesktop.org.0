...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F14C64E959
	for <lists+freedreno@lfdr.de>; Fri, 16 Dec 2022 11:22:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4621610E5C1;
...
Subject: [Freedreno] [PATCH v2 5/5] drm/msm/a6xx: Use genpd notifier to
