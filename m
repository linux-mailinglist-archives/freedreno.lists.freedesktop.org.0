...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AA5296CF9
	for <lists+freedreno@lfdr.de>; Wed, 21 Aug 2019 01:15:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D027488894;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 U6/g==
Subject: [Freedreno] [PATCH] drm/msm/dpu: fix "frame done" timeouts
