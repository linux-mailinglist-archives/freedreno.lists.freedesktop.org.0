...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE4C86F20E7
	for <lists+freedreno@lfdr.de>; Sat, 29 Apr 2023 00:37:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98F7510E161;
...
Subject: [Freedreno] [PATCH v3 3/4] drm/msm/dpu: remove GC and IGC related
 code from dpu catalog
