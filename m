...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8MlKKOiMqWl3/AAAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:16 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E571212F1B
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E864A10EC0F;
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[andre.draszik.linaro.org:server fail];
	DKIM_TRACE(0.00)[nxp.com:+];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,sntech.de:email,linaro.org:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,glider.be:email]
