...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C505135461F
	for <lists+freedreno@lfdr.de>; Mon,  5 Apr 2021 19:42:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C945889E8C;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 2/8] drm/msm: Reorganize msm_gem_shrinker_scan()
