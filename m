...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EC9A7BEF32
	for <lists+freedreno@lfdr.de>; Tue, 10 Oct 2023 01:34:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D00710E1F1;
...
Subject: [Freedreno] [PATCH v3 2/6] dt-bindings: display/msm: sdm845-dpu:
 Describe SDM670
