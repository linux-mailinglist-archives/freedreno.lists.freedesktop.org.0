...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFAA628ABAA
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F6286E210;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 06/22] drm/msm/submit: Move copy_from_user
