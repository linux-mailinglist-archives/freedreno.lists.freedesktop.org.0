...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D053C63E5C4
	for <lists+freedreno@lfdr.de>; Thu,  1 Dec 2022 00:52:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2A9C10E4EF;
...
Subject: [Freedreno] [PATCH v6 1/4] arm64: dts: qcom: add data-lanes and
