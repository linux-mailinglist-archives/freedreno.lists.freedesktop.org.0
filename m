...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DDC45B7278
	for <lists+freedreno@lfdr.de>; Tue, 13 Sep 2022 16:57:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C828210E606;
...
Subject: [Freedreno] [PATCH v7 02/15] drm: add helper functions to retrieve
 old and new crtc
