...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EE7E65483C
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 23:15:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3ACF10E58D;
...
Subject: [Freedreno] [RFC PATCH v2 1/3] drm: Introduce solid fill property
 for drm plane
