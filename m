...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[maarten.lankhorst.linux.intel.com:server fail,jonas.kwiboo.se:server fail,claudiu.beznea.tuxon.dev:server fail];
