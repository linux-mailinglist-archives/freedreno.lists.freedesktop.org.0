...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C66E75EFE5D
	for <lists+freedreno@lfdr.de>; Thu, 29 Sep 2022 22:05:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85FFB10ECAC;
...
Subject: Re: [Freedreno] [PATCH v8 10/12] dt-bindings: display/msm: split
