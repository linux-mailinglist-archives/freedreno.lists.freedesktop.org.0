...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 255EE342C99
	for <lists+freedreno@lfdr.de>; Sat, 20 Mar 2021 12:56:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93E3B6EB5D;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 1/2] drm/msm: fix shutdown hook in case GPU
