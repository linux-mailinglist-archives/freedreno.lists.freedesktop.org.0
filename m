...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 521DB36ABF4
	for <lists+freedreno@lfdr.de>; Mon, 26 Apr 2021 08:00:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C8AA89FC9;
...
Subject: [Freedreno] [v3 2/2] backlight: Add DisplayPort aux backlight driver
