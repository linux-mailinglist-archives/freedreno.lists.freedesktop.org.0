...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62EEF42B9FC
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 10:13:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC8726EA0F;
...
Subject: [Freedreno] [PATCH 2/2] drm/msm: uninitialized variable in
 msm_gem_import()
