...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD48F4D1DE4
	for <lists+freedreno@lfdr.de>; Tue,  8 Mar 2022 17:55:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 05DCF10E52C;
...
Subject: [Freedreno] [PATCH v5 2/5] arm64/dts/qcom/sc7180: remove
