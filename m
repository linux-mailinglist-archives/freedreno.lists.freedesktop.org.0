...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 047536784B6
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:25:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C06A910E548;
...
Subject: [Freedreno] [PATCH v1 11/14] drm/msm/disp/dpu1: add supports of new
 flush mechanism
