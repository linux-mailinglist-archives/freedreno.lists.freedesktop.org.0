...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 104716B4139
	for <lists+freedreno@lfdr.de>; Fri, 10 Mar 2023 14:50:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD19610E2B6;
	Fri, 10 Mar 2023 13:50:41 +0000 (UTC)
...
Subject: Re: [Freedreno] [Intel-gfx] [PATCH v6 01/10] drm/hdcp: Add
 drm_hdcp_atomic_check()
