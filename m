...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46FB276F55F
	for <lists+freedreno@lfdr.de>; Fri,  4 Aug 2023 00:02:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA0CB10E68F;
...
Subject: [Freedreno] [PATCH v3 7/9] interconnect: Teach lockdep about
 icc_bw_lock order
