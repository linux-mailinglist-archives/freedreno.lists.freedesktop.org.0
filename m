...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EE33FEADB4
	for <lists+freedreno@lfdr.de>; Thu, 31 Oct 2019 11:44:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE7F16EE1C;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 jFwg==
Subject: [Freedreno] [PATCH v4 1/7] drm/msm/mdp5: Add optional TBU and
 TBU_RT clocks
