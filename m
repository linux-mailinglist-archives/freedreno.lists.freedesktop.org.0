...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 807BC292FCF
	for <lists+freedreno@lfdr.de>; Mon, 19 Oct 2020 22:46:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1683C6EA9B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 13/23] drm/msm: Add priv->mm_lock to protect
