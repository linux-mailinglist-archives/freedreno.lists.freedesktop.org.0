...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2949638C6F0
	for <lists+freedreno@lfdr.de>; Fri, 21 May 2021 14:50:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 167856F629;
...
MIME-Version: 1.0
Subject: [Freedreno] [RFC PATCH 05/13] drm/msm/dsi: add support for dsc data
