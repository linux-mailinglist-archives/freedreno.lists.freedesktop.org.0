...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AFB3352BB2
	for <lists+freedreno@lfdr.de>; Fri,  2 Apr 2021 17:21:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E68A6EE66;
	Fri,  2 Apr 2021 15:21:09 +0000 (UTC)
...
Subject: Re: [Freedreno] [v1] drm/msm/disp/dpu1: program 3d_merge only if
 block is attached
