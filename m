...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C0976A9C16
	for <lists+freedreno@lfdr.de>; Fri,  3 Mar 2023 17:48:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A82410E710;
...
Subject: [Freedreno] [PATCH v2 3/4] drm/msm/adreno: drop bogus
