...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C7584D55A1
	for <lists+freedreno@lfdr.de>; Fri, 11 Mar 2022 00:45:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8872610E1E8;
...
Subject: [Freedreno] [PATCH 2/3] drm/msm/gpu: Park scheduler threads for
 system suspend
