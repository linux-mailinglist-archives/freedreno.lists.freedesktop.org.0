...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA7E2765E01
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 23:23:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9CCF10E607;
...
Subject: [Freedreno] [PATCH v2 10/13] drm/msm/adreno: Add helper for
 formating chip-id
