...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDFCD60A02A
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:20:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19B7D10E395;
...
Subject: [Freedreno] [PATCH v2 02/21] drm/mcde: Don't set struct
