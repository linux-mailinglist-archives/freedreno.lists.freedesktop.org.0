...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CBCB76B6187
	for <lists+freedreno@lfdr.de>; Sat, 11 Mar 2023 23:41:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5479710E21F;
	Sat, 11 Mar 2023 22:41:04 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mail-pf1-x42c.google.com (mail-pf1-x42c.google.com
 [IPv6:2607:f8b0:4864:20::42c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0999310E21F;
 Sat, 11 Mar 2023 22:41:02 +0000 (UTC)
Received: by mail-pf1-x42c.google.com with SMTP id c10so5656058pfv.13;
 Sat, 11 Mar 2023 14:41:02 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20210112; t=1678574462;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=HFyV8omGLx8IJq66iddk0kMwnbvLh4eKJJCDBepomp0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1678574462;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=HFyV8omGLx8IJq66iddk0kMwnbvLh4eKJJCDBepomp0=;
 b=
X-Gm-Message-State: AO0yUKUjzHGkoPmwSS7cQ98bmJxeNKfThpUUZHRgWn3XB5a8XTJ6a8L9
 FFtwd9lsDHGHopSGB9qCwHQTf7iWtGK40HqxJBg=
X-Google-Smtp-Source: AK7set/EUNI2+h2RnZ82opH2ff0NbqOZB7ktKYuXo8ZtghfHOkXV8iRE+WM9ClA98ejvQrogMWwjIw85HNGWbyQs05Q=
X-Received: by 2002:a63:9319:0:b0:503:7bdf:df4b with SMTP id
 b25-20020a639319000000b005037bdfdf4bmr10548752pge.3.1678574462251; Sat, 11
 Mar 2023 14:41:02 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <f887b4a7-3f37-fe1a-5352-cbc8bab669e0@linaro.org>
From: Adam Ford <aford173@gmail.com>
Date: Sat, 11 Mar 2023 16:40:50 -0600
Message-ID: <CAHCN7x+B-72PDFOqh9tu1rAJgoGBLfV-ujwD2yfu5vhPUAks0g@mail.gmail.com>
...
> >> "Hi Abhinav,
> >>
> >> On Sat, 11 Mar 2023 at 23:18, Abhinav Kumar <quic_abhinavk@quicinc.com=
> wrote:
> >>>
> >>> Hi Adam
> >>>
> >>> On 3/11/2023 9:28 AM, Adam Ford wrote:
> >>>> On Thu, Oct 13, 2022 at 3:39=E2=80=AFAM Robert Foss <robert.foss@lin=
aro.org> wrote:
> >>>>>
> >>>>> On Tue, 11 Oct 2022 at 23:11, Abhinav Kumar <quic_abhinavk@quicinc.=
com> wrote:
> >>>>>>
> >>>>>> adv7533 bridge tries to dynamically switch lanes based on the
> >>>>>> mode by detaching and attaching the mipi dsi device.
> >>>>>>
> >>>>>> This approach is incorrect because this method of dynamic switch o=
f
> >>>>>> detaching and attaching the mipi dsi device also results in removi=
ng
...
> >>>>>>
> >>>>>> Fixes: 62b2f026cd8e ("drm/bridge: adv7533: Change number of DSI la=
nes dynamically")
> >>>>>> Closes: https://gitlab.freedesktop.org/drm/msm/-/issues/16
> >>>>>> Suggested-by: Dmitry Baryshkov <dmitry.baryshkov@linaro.org>
> >>>>>> Signed-off-by: Abhinav Kumar <quic_abhinavk@quicinc.com>
> >>>>>> Reviewed-by: Robert Foss <robert.foss@linaro.org>
> >>>>>> Link: https://lore.kernel.org/r/1661797363-7564-1-git-send-email-q=
uic_abhinavk@quicinc.com
> >>>>>> ---
...
> >>>>>>
> >>>>>> diff --git a/drivers/gpu/drm/bridge/adv7511/adv7511.h b/drivers/gp=
u/drm/bridge/adv7511/adv7511.h
> >>>>>> index a031a0cd1f18..1053d185b24c 100644
> >>>>>> --- a/drivers/gpu/drm/bridge/adv7511/adv7511.h
> >>>>>> +++ b/drivers/gpu/drm/bridge/adv7511/adv7511.h
> >>>>>> @@ -405,7 +405,8 @@ static inline int adv7511_cec_init(struct devi=
ce *dev, struct adv7511 *adv7511)
> >>>>>>
> >>>>>>    void adv7533_dsi_power_on(struct adv7511 *adv);
> >>>>>>    void adv7533_dsi_power_off(struct adv7511 *adv);
> >>>>>> -void adv7533_mode_set(struct adv7511 *adv, const struct drm_displ=
ay_mode *mode);
...
> >>>>>> @@ -791,9 +791,6 @@ static void adv7511_mode_set(struct adv7511 *a=
dv7511,
> >>>>>>           regmap_update_bits(adv7511->regmap, 0x17,
> >>>>>>                   0x60, (vsync_polarity << 6) | (hsync_polarity <<=
 5));
> >>>>>>
> >>>>>> -       if (adv7511->type =3D=3D ADV7533 || adv7511->type =3D=3D A=
DV7535)
...
> >>>>>>
> >>>>>>           /*
> >>>>>> @@ -913,6 +910,18 @@ static void adv7511_bridge_mode_set(struct dr=
m_bridge *bridge,
> >>>>>>           adv7511_mode_set(adv, mode, adj_mode);
> >>>>>>    }
> >>>>>>
> >>>>>> +static enum drm_mode_status adv7511_bridge_mode_valid(struct drm_=
bridge *bridge,
> >>>>>> +                                                     const struct=
...
ags)
> >>>>>>    {
> >>>>>> @@ -960,6 +969,7 @@ static const struct drm_bridge_funcs adv7511_b=
ridge_funcs =3D {
...
> >>>>>> diff --git a/drivers/gpu/drm/bridge/adv7511/adv7533.c b/drivers/gp=
u/drm/bridge/adv7511/adv7533.c
> >>>>>> index ef6270806d1d..258c79d4dab0 100644
> >>>>>> --- a/drivers/gpu/drm/bridge/adv7511/adv7533.c
> >>>>>> +++ b/drivers/gpu/drm/bridge/adv7511/adv7533.c
> >>>>>> @@ -100,26 +100,27 @@ void adv7533_dsi_power_off(struct adv7511 *a=
dv)
...
> >>>>
> >>>
> >>> Looks like this condition is not tracking how low the bridge can supp=
ort
> >>> with 4 lanes but how high you can support with 3 lanes. Thats the iss=
ue.
> >>>
...
> >>> with 3 lanes you cannot support a higher one. So that needs to be han=
dled.
> >>>
> >>> The extra conditional's intention was to make sure that if you try to
> >>> switch to a mode which has a different number of lanes than what was =
set
...
> >>>          return MODE_BAD;
> >>>
> >>> I think that should fix your issue. You can set the number of lanes t=
o 4
...
> >>      return MODE_CLOCK_HIGH;
> >>
> >> See https://www.analog.com/media/en/technical-documentation/data-sheet=
s/adv7533.pdf
> >
...
> >>>>>> -               if (ret)
> >>>>>> -                       dev_err(&dsi->dev, "failed to change host =
lanes\n");
> >>>>>> -       }
> >>>>>> +       /*
> >>>>>> +        * TODO: add support for dynamic switching of lanes
> >>>>>> +        * by using the bridge pre_enable() op . Till then filter
> >>>>>> +        * out the modes which shall need different number of lane=
s
...
> >>>>>> +
> >>>>
> >>>> My board doesn't currently support dynamic switching, but I'd like t=
o
...
> >>>>   > I was thinking I could add a flag to disable dynamic switching. =
 If
...
> >>>          return MODE_BAD;
> >>>
> >>> So lets say some user tried to set number of lanes to 3 but tries a m=
ode
> >>> needing > 80000 clock then fail.
> >>>
> >>> That way we still dont support dynamic mode switch but also dont limi=
t
