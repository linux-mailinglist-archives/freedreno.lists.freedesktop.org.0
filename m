...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19EF61B3732
	for <lists+freedreno@lfdr.de>; Wed, 22 Apr 2020 08:08:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 335DF6E2E6;
	Wed, 22 Apr 2020 06:08:48 +0000 (UTC)
...
Subject: [Freedreno] [v3] dt-bindings: msm: disp: add yaml schemas for DPU
 and DSI bindings
