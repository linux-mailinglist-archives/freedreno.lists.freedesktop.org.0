...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E132E5A7598
	for <lists+freedreno@lfdr.de>; Wed, 31 Aug 2022 07:19:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E015310E1BF;
...
Subject: [Freedreno] [PATCH v6 4/6] clk: qcom: gpucc-sc7280: Add cx collapse
 reset support
