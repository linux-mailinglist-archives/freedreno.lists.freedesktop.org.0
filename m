...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64B0F6943FF
	for <lists+freedreno@lfdr.de>; Mon, 13 Feb 2023 12:12:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DCEC10E55B;
...
Subject: [Freedreno] [PATCH v4 2/4] drm/msm/dpu: add DSPPs into reservation
 upon a CTM request
