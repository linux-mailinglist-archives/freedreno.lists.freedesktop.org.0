...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C98A626A7F4
	for <lists+freedreno@lfdr.de>; Tue, 15 Sep 2020 17:00:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 707E86E8C7;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 11/21] drm/pl111: Introduce GEM object
 functions
