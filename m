...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C944746C814
	for <lists+freedreno@lfdr.de>; Wed,  8 Dec 2021 00:15:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D9306E1B1;
...
Subject: [Freedreno] [PATCH v6] drm/msm/dp: employ bridge mechanism for
