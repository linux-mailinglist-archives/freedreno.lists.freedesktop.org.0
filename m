...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6029BE9010
	for <lists+freedreno@lfdr.de>; Fri, 17 Oct 2025 15:48:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C1CA10EC3F;
	Fri, 17 Oct 2025 13:48:51 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.b="Z5nIxx93";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 35D3210EC3B;
...
Subject: Patch "minmax: add in_range() macro" has been added to the
 5.10-stable tree
To: 20230206140639.538867-5-fengwei.yin@intel.com,
	...
	jejb@linux.ibm.co, m@freedesktop.org, jmaloy@redhat.com,
	...
	sakari.ailus@linux.int, el.com@freedesktop.org, sashal@kernel.org,
