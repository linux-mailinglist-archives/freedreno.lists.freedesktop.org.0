...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89BC9407999
	for <lists+freedreno@lfdr.de>; Sat, 11 Sep 2021 18:39:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C3756EC03;
...
Subject: [Freedreno] [PATCH v2 1/2] drm/msm/dpu: Add a function to retrieve
 the current CTL status
