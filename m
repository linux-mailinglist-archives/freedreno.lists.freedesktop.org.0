...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AFVfFOGMqWk2/gAAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:09 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D3CD212EDC
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B9ED10EBFF;
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[vladimir.oltean.nxp.com:server fail,maarten.lankhorst.linux.intel.com:server fail,jonas.kwiboo.se:server fail,simona.ffwll.ch:server fail];
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,nxp.com:dkim,nxp.com:email,nxp.com:mid,suse.de:email,ffwll.ch:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,kwiboo.se:email]
