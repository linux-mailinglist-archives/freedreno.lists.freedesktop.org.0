...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56C316F214F
	for <lists+freedreno@lfdr.de>; Sat, 29 Apr 2023 01:45:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 212F810EDF3;
	Fri, 28 Apr 2023 23:45:45 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 6/7] drm/msm/dpu: save dpu topology
 configuration
