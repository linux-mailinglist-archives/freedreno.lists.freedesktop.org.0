...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CBE132406AC
	for <lists+freedreno@lfdr.de>; Mon, 10 Aug 2020 15:38:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D81E89FD7;
...
Subject: [Freedreno] [PATCH 2/2] dt-bindings: msm/dp: add bindings of
...
Cc: robh@kernel.org, linux-kernel@vger.kernel.org,
 ...
 nganji@codeaurora.org, seanpaul@chromium.org, kalyan_t@codeaurora.org,
