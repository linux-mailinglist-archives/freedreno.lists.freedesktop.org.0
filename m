...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 219BCBA2DA
	for <lists+freedreno@lfdr.de>; Sun, 22 Sep 2019 16:15:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF6FF6E338;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 4vNQ==
Subject: [Freedreno] [PATCH 4/5] drm/msm/dsi: Add configuration for 8x56
