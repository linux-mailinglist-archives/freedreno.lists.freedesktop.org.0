...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FFAF765DE9
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 23:22:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A80710E607;
...
Subject: [Freedreno] [PATCH v2 02/13] drm/msm/adreno: Remove redundant gmem
 size param
