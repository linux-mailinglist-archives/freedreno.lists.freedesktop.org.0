...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF138425C42
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:39:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6B066F4F6;
...
Subject: [Freedreno] [PATCH v3 19/20] drm: cleanup: remove
