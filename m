...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B743C4E71E6
	for <lists+freedreno@lfdr.de>; Fri, 25 Mar 2022 12:06:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64F0F10E9E2;
...
Subject: [Freedreno] [PATCH v5 08/13] drm/msm/dpu: don't use merge_3d if DSC
 merge topology is used
