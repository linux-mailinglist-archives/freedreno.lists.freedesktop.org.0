...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B96D8169C3
	for <lists+freedreno@lfdr.de>; Tue,  7 May 2019 20:02:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A3206E818;
...
Subject: [Freedreno] [PATCH v1 1/3] drm/msm/adreno: Enable 64 bit mode by
