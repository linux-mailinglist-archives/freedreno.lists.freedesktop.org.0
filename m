...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 68A414BDA5C
	for <lists+freedreno@lfdr.de>; Mon, 21 Feb 2022 15:52:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6E4C10E5D0;
...
Subject: [Freedreno] [PATCH v2 0/4] Add PSR support for eDP
