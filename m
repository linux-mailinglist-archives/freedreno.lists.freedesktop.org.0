...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 864246E026F
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 01:25:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82F3110E9E7;
...
Subject: [Freedreno] [PATCH v6 7/7] drm/msm/dsi: Fix calculation for
 pkt_per_line
