...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 77EC853BED4
	for <lists+freedreno@lfdr.de>; Thu,  2 Jun 2022 21:33:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A713112E2B;
...
Subject: Re: [Freedreno] [PATCH v2 6/7] drm/msm/dpu: constify struct
 dpu_mdss_cfg
