...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F9426A2C21
	for <lists+freedreno@lfdr.de>; Sat, 25 Feb 2023 23:55:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1925710E64A;
...
Subject: Re: [Freedreno] [PATCH v2 08/50] drm/msm/dpu: correct sm8450 scaler
