...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 758516DFE75
	for <lists+freedreno@lfdr.de>; Wed, 12 Apr 2023 21:10:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 559C910E93E;
...
Subject: [Freedreno] [PATCH v5 8/8] drm/msm/dsi: Fix calculation for
 pkt_per_line
