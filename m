...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E94347F884
	for <lists+freedreno@lfdr.de>; Fri,  2 Aug 2019 15:21:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A01256EE34;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.2 41/76] drm/msm/dpu: Correct dpu
 encoder spinlock initialization
