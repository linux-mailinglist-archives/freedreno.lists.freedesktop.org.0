...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F029961824F
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:18:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 956DA10E6CF;
...
Subject: [Freedreno] [PATCH v3 23/23] drm/fb-helper: Clarify use of
