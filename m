...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 50F5B4BDA5D
	for <lists+freedreno@lfdr.de>; Mon, 21 Feb 2022 15:52:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2624910E570;
...
Subject: [Freedreno] [PATCH v2 3/4] drm/msm/disp/dpu1: use atomic
