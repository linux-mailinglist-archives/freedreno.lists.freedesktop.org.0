...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD2E480136F
	for <lists+freedreno@lfdr.de>; Fri,  1 Dec 2023 20:12:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4557710E937;
...
Subject: Re: [Freedreno] [PATCH v3 01/13] drm/msm/dpu: cleanup
