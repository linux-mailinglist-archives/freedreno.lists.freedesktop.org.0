...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D30E354170
	for <lists+freedreno@lfdr.de>; Mon,  5 Apr 2021 13:13:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5012988007;
...
Subject: [Freedreno] [PATCH v15 2/4] dt-bindings: msm: dsi: add yaml schemas
 for DSI bindings
