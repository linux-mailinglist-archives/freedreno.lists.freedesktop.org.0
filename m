...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA8103F01CF
	for <lists+freedreno@lfdr.de>; Wed, 18 Aug 2021 12:36:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21C306E51C;
...
Subject: [Freedreno] [PATCH v1 1/4] dt-bindings: msm: add DT bindings for
 sc7280
