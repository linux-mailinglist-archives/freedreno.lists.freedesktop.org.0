...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC8D4EADB6
	for <lists+freedreno@lfdr.de>; Thu, 31 Oct 2019 11:44:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 774FC6EE1A;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 6ebw==
Subject: [Freedreno] [PATCH v4 3/7] drm/msm/mdp5: Add configuration for
 msm8x76
