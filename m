...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0740E6FE6DF
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:08:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3B6810E55B;
...
Subject: [Freedreno] [PATCH v6 2/8] drm/msm/dpu: add DPU_PINGPONG_DSC
