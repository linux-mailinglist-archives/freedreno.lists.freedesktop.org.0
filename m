...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D12BA630C56
	for <lists+freedreno@lfdr.de>; Sat, 19 Nov 2022 06:58:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 998A710E24C;
...
Subject: [Freedreno] [PATCH] drm/msm/dpu: check for null return of
