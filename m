...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A887C7021F4
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 05:03:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BAAB10E120;
...
Subject: [Freedreno] [PATCH 2/3] drm/msm/dp: Clean up logs dp_power module
