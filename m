...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[vladimir.oltean.nxp.com:server fail,jonas.kwiboo.se:server fail,simona.ffwll.ch:server fail,maarten.lankhorst.linux.intel.com:server fail];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,linaro.org:email,suse.de:email,intel.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,ffwll.ch:email]
