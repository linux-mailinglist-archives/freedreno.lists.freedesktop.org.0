...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E9A878BBD5
	for <lists+freedreno@lfdr.de>; Tue, 29 Aug 2023 02:06:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97CDC10E383;
...
Subject: [Freedreno] [PATCH RFC v6 04/10] drm/atomic: Add pixel source to
 plane state dump
