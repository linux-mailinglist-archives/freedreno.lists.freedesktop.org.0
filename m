...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8758850CED9
	for <lists+freedreno@lfdr.de>; Sun, 24 Apr 2022 05:20:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78D051126F3;
...
Subject: [Freedreno] [PATCH v2] drm: msm: fix error check return value of
