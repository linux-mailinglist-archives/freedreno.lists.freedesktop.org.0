...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F39DD801968
	for <lists+freedreno@lfdr.de>; Sat,  2 Dec 2023 02:24:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE1BF10E13B;
...
Subject: Re: [Freedreno] [PATCH 16/17] drm/msm/mdp4: use drmm-managed
 allocation for mdp4_plane
