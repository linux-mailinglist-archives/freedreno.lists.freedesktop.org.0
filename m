...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A11915818F2
	for <lists+freedreno@lfdr.de>; Tue, 26 Jul 2022 19:50:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5523B963D1;
...
Subject: [Freedreno] [PATCH v3 07/15] drm/msm/gem: Consolidate pin/unpin
 paths
