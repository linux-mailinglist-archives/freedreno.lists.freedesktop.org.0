...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B4F025EA06
	for <lists+freedreno@lfdr.de>; Sat,  5 Sep 2020 22:04:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E44176E27C;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v17 08/20] drm/msm: Add support to create a
 local pagetable
