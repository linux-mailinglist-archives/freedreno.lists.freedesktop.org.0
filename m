...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE89B561EB4
	for <lists+freedreno@lfdr.de>; Thu, 30 Jun 2022 17:04:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9473210F39E;
	Thu, 30 Jun 2022 15:04:48 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v3 3/4] drm/msm/a6xx: Add speedbin support
 for A619 GPU
...
Cc: Sean Paul <sean@poorly.run>, Jonathan Marek <jonathan@marek.ca>,
 ...
 Crouse <jordan@cosmicpenguin.net>, Rob Clark <robdclark@gmail.com>,
 martin.botka@somainline.org, dri-devel@lists.freedesktop.org, Daniel
 Vetter <daniel@ffwll.ch>, angelogioacchino.delregno@somainline.org,
