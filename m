...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BA4A4F1942
	for <lists+freedreno@lfdr.de>; Mon,  4 Apr 2022 18:34:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B15810E238;
...
Subject: [Freedreno] [PATCH v6 00/14] drm/msm: Add Display Stream
 Compression Support
