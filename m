...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 105A6570393
	for <lists+freedreno@lfdr.de>; Mon, 11 Jul 2022 14:57:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DBDA8E542;
...
Subject: [Freedreno] [PATCH v6 07/10] drm/bridge: add psr support for panel
 bridge callbacks
