...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E0406A9C14
	for <lists+freedreno@lfdr.de>; Fri,  3 Mar 2023 17:48:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F046910E70F;
...
Subject: [Freedreno] [PATCH v2 2/4] drm/msm/adreno: fix runtime PM imbalance
 at gpu load
