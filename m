...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0E5829750A
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 18:50:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDAC16F901;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 17/23] drm/msm: Remove obj->gpu
