...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41A586A9C19
	for <lists+freedreno@lfdr.de>; Fri,  3 Mar 2023 17:48:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCBD210E711;
	Fri,  3 Mar 2023 16:48:29 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 4/4] drm/msm/adreno: clean up component ops
 indentation
