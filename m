...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59C185A7592
	for <lists+freedreno@lfdr.de>; Wed, 31 Aug 2022 07:19:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 41A9310E1AB;
...
Subject: [Freedreno] [PATCH v6 1/6] dt-bindings: clk: qcom: Support gpu cx
 gdsc reset
