...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 349DC502F1F
	for <lists+freedreno@lfdr.de>; Fri, 15 Apr 2022 21:10:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B060210E274;
...
Subject: [Freedreno] [PATCH] drm/msm: remove unused hotplug and edid macros
 from msm_drv.h
