...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5595A80191C
	for <lists+freedreno@lfdr.de>; Sat,  2 Dec 2023 01:49:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0543D10E002;
...
Subject: Re: [Freedreno] [PATCH 12/17] drm/msm/mdp4: use drmm-managed
 allocation for mdp4_crtc
