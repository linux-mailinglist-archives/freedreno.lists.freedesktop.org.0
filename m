...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 964B1A7BBD8
	for <lists+freedreno@lfdr.de>; Fri,  4 Apr 2025 13:56:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D40B410EBCE;
	Fri,  4 Apr 2025 11:56:17 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=quicinc.com header.i=@quicinc.com header.b="ko51JKvY";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com
 [205.220.180.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BABBF10EBAB;
...
Subject: [PATCH v3 03/10] dt-bindings: display: msm: document DSI controller
 and phy on SA8775P
...
X-Authority-Analysis: v=2.4 cv=MqFS63ae c=1 sm=1 tr=0 ts=67efc8c6 cx=c_pps
 ...
 a=XR8D0OoHHMoA:10 a=COk6AnOGAAAA:8 a=1_X3neIigW5RjHwRquYA:9
