...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 107AA200C38
	for <lists+freedreno@lfdr.de>; Fri, 19 Jun 2020 16:45:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADDCD6E0F1;
...
Subject: Re: [Freedreno] [PATCH v7 13/36] drm: msm: fix common struct
