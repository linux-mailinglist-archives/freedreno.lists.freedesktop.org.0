...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AF114F5A35
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F8E210F281;
...
Subject: [Freedreno] [PATCH v7 11/14] drm/msm/disp/dpu1: Add DSC support in
 RM
