...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 421E4605DCA
	for <lists+freedreno@lfdr.de>; Thu, 20 Oct 2022 12:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5197010EB4A;
...
Subject: [Freedreno] [PATCH 15/21] drm/fb-helper: Disconnect damage worker
 from update logic
