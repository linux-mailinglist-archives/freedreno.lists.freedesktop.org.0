...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D505758A0E
	for <lists+freedreno@lfdr.de>; Wed, 19 Jul 2023 02:26:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8FAC10E3E8;
...
Subject: Re: [Freedreno] [PATCH v2 03/13] drm/msm/dpu: use devres-managed
