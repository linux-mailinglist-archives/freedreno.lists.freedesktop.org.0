...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF7568E041
	for <lists+freedreno@lfdr.de>; Thu, 15 Aug 2019 00:02:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0954C6E864;
	Wed, 14 Aug 2019 22:02:36 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 RmDw==
Subject: [Freedreno] [PATCH 0/6] drm+dma: cache support for arm, etc
