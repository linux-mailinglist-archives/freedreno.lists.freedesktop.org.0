...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C617B2E8CCE
	for <lists+freedreno@lfdr.de>; Sun,  3 Jan 2021 16:25:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DFF1898B7;
...
Subject: [Freedreno] [PATCH 27/31] PM / devfreq: rk3399_dmc: convert to use
 devm_pm_opp_* API
