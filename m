...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82078784923
	for <lists+freedreno@lfdr.de>; Tue, 22 Aug 2023 20:02:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C97510E3C4;
...
Subject: [Freedreno] [PATCH v5 10/11] drm/sched: Add (optional) fence
