...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1E6A28ABCB
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7764789CF8;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 22/22] drm/msm: Don't implicit-sync if only a
 single ring
