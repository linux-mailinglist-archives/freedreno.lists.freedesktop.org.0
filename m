...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A0D2574901C
	for <lists+freedreno@lfdr.de>; Wed,  5 Jul 2023 23:45:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E6C210E192;
...
Subject: Re: [Freedreno] [PATCH v2 1/5] drm/msm: Update dev core dump to not
 print backwards
