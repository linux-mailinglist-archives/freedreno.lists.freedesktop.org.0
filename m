...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3D6976F0B7
	for <lists+freedreno@lfdr.de>; Thu,  3 Aug 2023 19:34:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 237FF10E64C;
...
Subject: [Freedreno] [PATCH] drm/msm/a6xx: Fix GMU lockdep splat
