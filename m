...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B22BE38957C
	for <lists+freedreno@lfdr.de>; Wed, 19 May 2021 20:35:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 217EF6EDB4;
...
MIME-Version: 1.0
Subject: [Freedreno] [RFC 1/3] dma-fence: Add boost fence op
