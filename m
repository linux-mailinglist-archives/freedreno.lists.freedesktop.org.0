...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7360C4F34E7
	for <lists+freedreno@lfdr.de>; Tue,  5 Apr 2022 15:42:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD94D10E920;
...
Subject: [Freedreno] [PATCH v7 2/2] drm/msm/disp/dpu1: add inline rotation
 support for sc7280
