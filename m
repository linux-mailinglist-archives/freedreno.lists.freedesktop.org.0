...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7F394C5095
	for <lists+freedreno@lfdr.de>; Fri, 25 Feb 2022 22:23:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12AED10E9CE;
	Fri, 25 Feb 2022 21:23:36 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v12 2/4] drm/msm/dpu: replace BIT(x) with
