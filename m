...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 08AD6507E59
	for <lists+freedreno@lfdr.de>; Wed, 20 Apr 2022 03:46:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D40A310EF5C;
...
Subject: [Freedreno] [PATCH v2 15/17] drm/msm/dpu: initialize dpu encoder
