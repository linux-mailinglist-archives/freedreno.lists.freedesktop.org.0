...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE76D520294
	for <lists+freedreno@lfdr.de>; Mon,  9 May 2022 18:37:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E6E910F39A;
...
Subject: Re: [Freedreno] [pull] drm/msm: drm-msm-next-2022-05-09 for v5.19
