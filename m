...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2866877478B
	for <lists+freedreno@lfdr.de>; Tue,  8 Aug 2023 21:16:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF7C610E0F8;
...
Subject: Re: [Freedreno] [PATCH v3 3/3] usb: typec: nb7vpq904m: switch to
 DRM_SIMPLE_BRIDGE
