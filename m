...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C585647247D
	for <lists+freedreno@lfdr.de>; Mon, 13 Dec 2021 10:37:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 557FD10E714;
...
Subject: [Freedreno] [PATCH 3/3] drm/dp: Move DisplayPort helpers into
