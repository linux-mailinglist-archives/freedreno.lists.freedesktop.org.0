...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B174337E5F
	for <lists+freedreno@lfdr.de>; Thu, 11 Mar 2021 20:45:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F06316EBAC;
...
Subject: Re: [Freedreno] [PATCH v2 07/14] spi: spi-geni-qcom: Convert to use
...
Content-Type: multipart/mixed; boundary="===============1270790093=="
