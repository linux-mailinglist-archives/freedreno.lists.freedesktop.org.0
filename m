...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 832654F8850
	for <lists+freedreno@lfdr.de>; Thu,  7 Apr 2022 22:27:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9B8410EC85;
...
Subject: [Freedreno] [PATCH] drm/msm: Fix range size vs end confusion
