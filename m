...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6B9566A5DF
	for <lists+freedreno@lfdr.de>; Fri, 13 Jan 2023 23:23:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAF1D10E035;
	Fri, 13 Jan 2023 22:23:32 +0000 (UTC)
...
Subject: Re: [Freedreno] [RFC PATCH 4/4] drm/msm/mdss: add the sdm845 data
 for completeness
