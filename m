...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDF25337666
	for <lists+freedreno@lfdr.de>; Thu, 11 Mar 2021 16:02:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 793176EDB0;
...
Subject: [Freedreno] 2021 X.Org Foundation Membership renewal period
 extended to Mar 18
