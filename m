...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA675282D20
	for <lists+freedreno@lfdr.de>; Sun,  4 Oct 2020 21:21:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8563C89FAC;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 14/14] drm/msm: Don't implicit-sync if only a
 single ring
