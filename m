...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DCC3150C079
	for <lists+freedreno@lfdr.de>; Fri, 22 Apr 2022 21:45:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4FF7010E57E;
...
Subject: [Freedreno] [PATCH v2 2/3] drm/msm/dpu: add wb_idx to existing DRM
