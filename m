...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F821502D39
	for <lists+freedreno@lfdr.de>; Fri, 15 Apr 2022 17:41:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 919CA10E1F1;
...
Subject: [Freedreno] [PATCH v6] drm/msm/dp: stop event kernel thread when DP
 unbind
