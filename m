...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 758FA46F5A6
	for <lists+freedreno@lfdr.de>; Thu,  9 Dec 2021 22:11:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E37810E370;
...
Subject: Re: [Freedreno] [PATCH v1 5/8] drm/msm/dpu: stop manually removing
