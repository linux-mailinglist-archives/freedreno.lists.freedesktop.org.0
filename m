...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C3E79507E67
	for <lists+freedreno@lfdr.de>; Wed, 20 Apr 2022 03:47:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33A0910EF5C;
...
Subject: [Freedreno] [PATCH v2 10/17] drm/msm/dpu: make changes to
