...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A5A46E0278
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 01:25:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EA4110E9F6;
...
Subject: [Freedreno] [PATCH v6 6/7] drm/msm/dsi: update hdisplay calculation
