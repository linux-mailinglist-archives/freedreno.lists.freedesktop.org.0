...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA3AF6181CB
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:16:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A943810E650;
...
Subject: [Freedreno] [PATCH v3 06/23] drm/ingenic: Don't set struct
