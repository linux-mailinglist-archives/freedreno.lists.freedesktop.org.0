...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B9C5F5A5A0A
	for <lists+freedreno@lfdr.de>; Tue, 30 Aug 2022 05:33:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21AC010E8B4;
...
Subject: [Freedreno] [RFC PATCH 0/3] Limit pluggable display modes
