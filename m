...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E72DC4E71DC
	for <lists+freedreno@lfdr.de>; Fri, 25 Mar 2022 12:06:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9015110EB3E;
...
Subject: [Freedreno] [PATCH v5 07/13] drm/msm/disp/dpu1: Add support for DSC
 in encoder
