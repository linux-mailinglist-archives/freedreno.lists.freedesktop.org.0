...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F035845CF2E
	for <lists+freedreno@lfdr.de>; Wed, 24 Nov 2021 22:37:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 523406EDD5;
...
Subject: [Freedreno] [PATCH 2/7] drm/msm/gpu: Name GMU bos
