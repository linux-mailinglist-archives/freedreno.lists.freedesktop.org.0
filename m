...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C1CD6950FC
	for <lists+freedreno@lfdr.de>; Mon, 13 Feb 2023 20:48:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6145010E0B1;
	Mon, 13 Feb 2023 19:48:37 +0000 (UTC)
...
Subject: [Freedreno] [RFC PATCH v3 0/4] Move TE setup to
 prepare_for_kickoff()
