...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5201A54BA8D
	for <lists+freedreno@lfdr.de>; Tue, 14 Jun 2022 21:32:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFA10112C00;
...
Subject: [Freedreno] [PATCH 2/3] drm/msm/dpu: fix maxlinewidth for writeback
 block
