...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 849413E9B86
	for <lists+freedreno@lfdr.de>; Thu, 12 Aug 2021 02:14:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1FA26E203;
...
Subject: [Freedreno] [PATCH v1 0/2] Add support for eDP on SC7280
