...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B49DD743196
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:25:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79D8E10E40E;
...
Subject: [Freedreno] [PATCH RFC v4 2/7] drm: Introduce pixel_source DRM
 plane property
