...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC9E413C00D
	for <lists+freedreno@lfdr.de>; Wed, 15 Jan 2020 13:17:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47DDE6E987;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 08/21] drm/nouveau: Convert to struct
