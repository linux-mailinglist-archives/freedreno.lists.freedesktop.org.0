...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD409605DD7
	for <lists+freedreno@lfdr.de>; Thu, 20 Oct 2022 12:41:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2E2B10E748;
...
Subject: [Freedreno] [PATCH 17/21] drm/fb-helper: Perform all fbdev I/O with
