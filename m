...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26C51406FFE
	for <lists+freedreno@lfdr.de>; Fri, 10 Sep 2021 18:51:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34D5B6EA44;
...
Subject: [Freedreno] [PATCH] dt-bindings: More use 'enum' instead of 'oneOf'
 plus 'const' entries
