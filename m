...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D0AF24798C
	for <lists+freedreno@lfdr.de>; Tue, 18 Aug 2020 00:02:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE0706E0B6;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 07/20] drm/msm: set adreno_smmu as gpu's drvdata
