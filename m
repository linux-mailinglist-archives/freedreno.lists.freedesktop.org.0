...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D362E6B0D9D
	for <lists+freedreno@lfdr.de>; Wed,  8 Mar 2023 16:54:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C55410E687;
...
Subject: [Freedreno] [PATCH v10 10/15] drm/vblank: Add helper to get next
 vblank time
...
Cc: Rob Clark <robdclark@chromium.org>,
 Mario Kleiner <mario.kleiner.de@gmail.com>, Daniel Vetter <daniel@ffwll.ch>,
