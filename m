...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F150769BC2E
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A519810E576;
...
Subject: [Freedreno] [PATCH v4 08/14] drm/scheduler: Add fence deadline
 support
