...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BB3465AFCE
	for <lists+freedreno@lfdr.de>; Mon,  2 Jan 2023 11:49:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EE9610E309;
...
Subject: [Freedreno] [PATCH v5 5/5] drm/msm/a6xx: Use genpd notifier to
