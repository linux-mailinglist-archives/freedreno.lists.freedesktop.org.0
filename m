...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26F436B81A2
	for <lists+freedreno@lfdr.de>; Mon, 13 Mar 2023 20:21:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6995F10E134;
...
Subject: Re: [Freedreno] [Linaro-mm-sig] Re: [PATCH 2/2] drm/msm: Embed the
 hw_fence in msm_gem_submit
