...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D3494FC711
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 23:58:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6C1010E298;
...
Subject: [Freedreno] [PATCH v4 08/10] drm/msm/gem: Split vma lookup and pin
