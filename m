...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5F076938A3
	for <lists+freedreno@lfdr.de>; Sun, 12 Feb 2023 17:30:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90D9910E2D0;
...
Subject: [Freedreno] [PATCH v13 08/13] drm/msm/dp: use atomic callbacks for
 DP bridge ops
