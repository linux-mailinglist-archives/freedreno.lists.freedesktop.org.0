...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A66B4BDA5B
	for <lists+freedreno@lfdr.de>; Mon, 21 Feb 2022 15:52:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEB0C10E55A;
...
Subject: [Freedreno] [PATCH v2 2/4] drm/bridge: use atomic enable/disable
 for bridge callbacks
