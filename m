...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FEA54CC67C
	for <lists+freedreno@lfdr.de>; Thu,  3 Mar 2022 20:49:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90E9E10EC28;
...
Subject: [Freedreno] [PATCH 3/4] drm/msm: Add SYSPROF param
