...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF0DF53672D
	for <lists+freedreno@lfdr.de>; Fri, 27 May 2022 20:54:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 319C810EEDC;
	Fri, 27 May 2022 18:54:41 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 3/3] drm/msm/dpu: Add interface support for CRC
 debugfs
