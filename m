...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8EB2250804
	for <lists+freedreno@lfdr.de>; Mon, 24 Aug 2020 20:42:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4ED5D6E466;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 05/20] iommu: add private interface for
 adreno-smmu
