...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6FEA6BF66B
	for <lists+freedreno@lfdr.de>; Sat, 18 Mar 2023 00:36:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 832D410E434;
	Fri, 17 Mar 2023 23:36:34 +0000 (UTC)
...
Subject: [Freedreno] [PATCH] dt-bindings: display: Drop unneeded quotes
