...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7780F5528C1
	for <lists+freedreno@lfdr.de>; Tue, 21 Jun 2022 02:50:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7679D10E9A5;
	Tue, 21 Jun 2022 00:50:52 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 4/4] drm/msm/dpu: Add interface support for
 CRC debugfs
