...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C548CE5B6A
	for <lists+freedreno@lfdr.de>; Sat, 26 Oct 2019 15:23:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BB5C6E0A6;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.4 10/17] drm/msm/dsi: Implement reset
 correctly
