...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 119B34DA611
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 00:12:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0853610E336;
...
Subject: [Freedreno] [PATCH v2 3/6] drm/vkms: pass possible_crtcs as
