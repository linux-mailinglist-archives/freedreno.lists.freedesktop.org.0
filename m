...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB067425BD8
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:38:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70A156F4BA;
...
Subject: [Freedreno] [PATCH v3 06/20] drm/tegra: cleanup:
