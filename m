...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 423BB4A38CA
	for <lists+freedreno@lfdr.de>; Sun, 30 Jan 2022 20:57:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B51EB11381E;
...
Subject: [Freedreno] [v4 0/3] drm/msm/dsi: Add 10nm dsi phy tuning
