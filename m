...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5FB46950FF
	for <lists+freedreno@lfdr.de>; Mon, 13 Feb 2023 20:48:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D6CD10E6F2;
...
Subject: [Freedreno] [RFC PATCH v3 1/4] drm/msm/dpu: Move TE setup to
 prepare_for_kickoff()
