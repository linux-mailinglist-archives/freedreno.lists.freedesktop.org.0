...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F06A0275AFA
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B9456E9D8;
...
Subject: [Freedreno] [PATCH v3 05/22] drm/gma500: Introduce GEM object
 functions
