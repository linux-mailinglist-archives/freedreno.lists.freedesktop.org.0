...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96DF65100AC
	for <lists+freedreno@lfdr.de>; Tue, 26 Apr 2022 16:42:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70EF510E084;
	Tue, 26 Apr 2022 14:42:08 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v6 01/19] drm: allow passing possible_crtcs to
