...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC43C40ECD4
	for <lists+freedreno@lfdr.de>; Thu, 16 Sep 2021 23:43:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D005D6E940;
...
Subject: [Freedreno] [PATCH 15/15] doc: drm: remove TODO entry regarding
