...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3937772C41
	for <lists+freedreno@lfdr.de>; Mon,  7 Aug 2023 19:12:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BCF410E330;
...
Subject: [Freedreno] [PATCH v4 5/9] PM / QoS: Teach lockdep about
