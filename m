...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6116270C7B6
	for <lists+freedreno@lfdr.de>; Mon, 22 May 2023 21:32:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3954810E2FB;
...
Subject: [Freedreno] [PATCH v12 10/10] drm/msm/dpu: tear down DSC data path
 when DSC disabled
