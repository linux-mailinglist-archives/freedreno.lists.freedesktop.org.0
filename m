...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 253C2772C48
	for <lists+freedreno@lfdr.de>; Mon,  7 Aug 2023 19:12:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2A3610E326;
	Mon,  7 Aug 2023 17:12:20 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v4 6/9] interconnect: Fix locking for runpm vs
 reclaim
