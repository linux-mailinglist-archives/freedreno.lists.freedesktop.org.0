...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D2F66B89A0
	for <lists+freedreno@lfdr.de>; Tue, 14 Mar 2023 05:30:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2C4410E6D8;
...
Subject: Re: [Freedreno] [PATCH v5 26/32] drm/msm/dpu: split pipe handling
