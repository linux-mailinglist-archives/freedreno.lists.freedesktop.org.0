...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D759744C6A1
	for <lists+freedreno@lfdr.de>; Wed, 10 Nov 2021 19:05:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7D9D6EDCF;
...
Subject: [Freedreno] [PATCH 3/3] drm/msm: some features need to be forced to
 rely on COMMON_CLK
