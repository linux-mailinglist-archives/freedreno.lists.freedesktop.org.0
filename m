...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE9EC417C9C
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 22:54:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01FC06E270;
...
Subject: Re: [Freedreno] [PATCH 1/4] dma-buf: add dma_fence_describe and
 dma_resv_describe
