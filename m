...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C8316D2C3D
	for <lists+freedreno@lfdr.de>; Sat,  1 Apr 2023 03:03:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3702410F35C;
	Sat,  1 Apr 2023 01:03:27 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v3 03/38] drm/msm/dpu: mark remaining pp
 data as const
