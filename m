...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C72B4756BF
	for <lists+freedreno@lfdr.de>; Wed, 15 Dec 2021 11:43:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C1DA10E4D1;
...
Subject: [Freedreno] [PATCH v2 5/5] drm/dp: Move DisplayPort AUX bus helpers
 into dp/
