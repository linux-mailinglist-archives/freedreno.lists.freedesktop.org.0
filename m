...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90CD56A4B18
	for <lists+freedreno@lfdr.de>; Mon, 27 Feb 2023 20:36:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4902210E47A;
...
Subject: [Freedreno] [PATCH v7 10/15] drm/vblank: Add helper to get next
 vblank time
