...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C21FF59DB
	for <lists+freedreno@lfdr.de>; Fri,  8 Nov 2019 22:29:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28EE66FA90;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 EdhQ==
Subject: [Freedreno] [PATCH] drm/msm/dsi: Delay drm_panel_enable() until
