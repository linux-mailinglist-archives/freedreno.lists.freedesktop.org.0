...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 555FF11ED24
	for <lists+freedreno@lfdr.de>; Fri, 13 Dec 2019 22:47:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF0226EDE0;
...
Subject: Re: [Freedreno] [PATCH v1 1/2] dt-bindings: display: add sc7180
 panel variant
