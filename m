...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20B735F515B
	for <lists+freedreno@lfdr.de>; Wed,  5 Oct 2022 11:07:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 440DF10E202;
...
Subject: [Freedreno] [PATCH v7 2/6] clk: qcom: Allow custom reset ops
