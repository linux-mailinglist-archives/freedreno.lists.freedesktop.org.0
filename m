...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3138B70775
	for <lists+freedreno@lfdr.de>; Mon, 22 Jul 2019 19:37:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 853E589D58;
...
Subject: Re: [Freedreno] [PATCH v3 2/6] dt-bindings: display: msm: gmu: add
