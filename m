...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F0FF4F8544
	for <lists+freedreno@lfdr.de>; Thu,  7 Apr 2022 18:51:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA6DD10EBBF;
...
Subject: [Freedreno] [PATCH] drm/msm/dp: add fail safe mode outside of
 event_mutex context
