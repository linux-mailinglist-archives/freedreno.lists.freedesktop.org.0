...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7759E26A7EF
	for <lists+freedreno@lfdr.de>; Tue, 15 Sep 2020 17:00:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 114686E8C2;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 09/21] drm/nouveau: Introduce GEM object
 functions
