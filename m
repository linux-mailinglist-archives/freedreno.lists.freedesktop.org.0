...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D60E52F514
	for <lists+freedreno@lfdr.de>; Fri, 20 May 2022 23:28:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99B8410EFB6;
...
Subject: [Freedreno] [PATCH v11 1/3] phy: qcom-edp: add regulator_set_load
 to edp phy
