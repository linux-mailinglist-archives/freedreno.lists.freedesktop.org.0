...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B80FF674265
	for <lists+freedreno@lfdr.de>; Thu, 19 Jan 2023 20:12:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70E4610E233;
...
Subject: [Freedreno] [PATCH v3 3/3] drm: Convert users of
