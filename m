...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3D0E64C6B8
	for <lists+freedreno@lfdr.de>; Wed, 14 Dec 2022 11:08:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCBA210E3B5;
	Wed, 14 Dec 2022 10:07:11 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v9 08/15] drm/bridge: add psr support for panel
 bridge callbacks
