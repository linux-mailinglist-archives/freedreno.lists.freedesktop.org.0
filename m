...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 442E2422BFD
	for <lists+freedreno@lfdr.de>; Tue,  5 Oct 2021 17:12:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C85B96EB87;
	Tue,  5 Oct 2021 15:11:59 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 1/3] iommu/io-pgtable-arm: Add way to debug
 pgtable walk
