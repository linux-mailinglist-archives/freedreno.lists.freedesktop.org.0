...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D05D64DD6D
	for <lists+freedreno@lfdr.de>; Thu, 15 Dec 2022 16:12:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4789710E244;
	Thu, 15 Dec 2022 15:11:56 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 4/5] drm/msm/a6xx: Remove cx gdsc polling using
 'reset'
