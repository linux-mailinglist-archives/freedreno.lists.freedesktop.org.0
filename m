...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 533F46FD228
	for <lists+freedreno@lfdr.de>; Wed, 10 May 2023 00:07:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26F6110E3F0;
...
Subject: [Freedreno] [PATCH v7 6/8] drm/msm/dpu: Fix slice_last_group_size
 calculation
