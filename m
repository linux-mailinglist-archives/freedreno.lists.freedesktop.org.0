...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 730195B56C2
	for <lists+freedreno@lfdr.de>; Mon, 12 Sep 2022 10:52:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C86C310E32B;
...
Subject: Re: [Freedreno] [PATCH v1 7/7] drm/bridge_connector: drop
