...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44BBE6D44B6
	for <lists+freedreno@lfdr.de>; Mon,  3 Apr 2023 14:45:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42DBD10E459;
...
Subject: [Freedreno] [PATCH v2 7/8] drm/msm: Initialize fbdev DRM client
