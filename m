...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D62D0642F1B
	for <lists+freedreno@lfdr.de>; Mon,  5 Dec 2022 18:45:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1FD3810E27E;
...
Subject: [Freedreno] [PATCH v4 10/13] drm/msm/dp: Rely on hpd_enable/disable
 callbacks
