...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2341B4910F
	for <lists+freedreno@lfdr.de>; Mon, 17 Jun 2019 22:13:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8EE06E096;
	Mon, 17 Jun 2019 20:13:35 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mail-qt1-x844.google.com (mail-qt1-x844.google.com
 [IPv6:2607:f8b0:4864:20::844])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E01216E09A
 for <freedreno@lists.freedesktop.org>; Mon, 17 Jun 2019 20:13:33 +0000 (UTC)
Received: by mail-qt1-x844.google.com with SMTP id w17so6001186qto.10
 for <freedreno@lists.freedesktop.org>; Mon, 17 Jun 2019 13:13:33 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=Jxs1S2d2hEiLW82WrQt+RxzLo4SztRkqjbe0RaFo6/s=;
 b=
X-Gm-Message-State: APjAAAXIVmitJNx/yB/rwoXX/oKoA+lGY/YfD+kskdGMsIoc/snqp6+v
 9mul/kAAKCEx+1l7adNx0+6n0g==
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 k03g==
Subject: [Freedreno] [PATCH 08/13] drm/msm/dsi: Don't store dsi host
 mode_flags in msm_dsi
