...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A68243B4FA1
	for <lists+freedreno@lfdr.de>; Sat, 26 Jun 2021 18:52:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38A9D6E067;
...
Subject: [Freedreno] [v8 3/6] drm/panel-simple: Support for delays between
 GPIO & regulator
