...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D73EB1369DE
	for <lists+freedreno@lfdr.de>; Fri, 10 Jan 2020 10:22:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8CE1C6E9F0;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 18/23] drm/sti: Convert to CRTC VBLANK callbacks
