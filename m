...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 535C550B33D
	for <lists+freedreno@lfdr.de>; Fri, 22 Apr 2022 10:50:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5AAC10EB85;
...
Subject: [Freedreno] [PATCH] drm/msm/dp: fix error check return value of
