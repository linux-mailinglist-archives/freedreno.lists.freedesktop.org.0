...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C1B270755F
	for <lists+freedreno@lfdr.de>; Thu, 18 May 2023 00:27:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42B9010E2D9;
...
Subject: [Freedreno] [PATCH v12 1/9] drm/display/dsc: Add flatness and
