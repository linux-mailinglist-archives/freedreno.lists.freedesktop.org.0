...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3B527021F5
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 05:03:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74BD110E126;
...
Subject: [Freedreno] [PATCH 3/3] drm/msm/dp: Clean up pdev/dev duplication
 in dp_power
