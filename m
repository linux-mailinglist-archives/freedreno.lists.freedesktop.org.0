...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BAC8D355743
	for <lists+freedreno@lfdr.de>; Tue,  6 Apr 2021 17:05:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF8C46E840;
...
Subject: Re: [Freedreno] [PATCH][next] drm/msm: Fix spelling mistake
 "Purgable" -> "Purgeable"
