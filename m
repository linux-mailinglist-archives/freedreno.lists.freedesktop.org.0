...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C6CC42E8556
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FCFC895CA;
	Fri,  1 Jan 2021 18:55:17 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 07/31] serial: qcom_geni_serial: convert to use
 devm_pm_opp_* API
