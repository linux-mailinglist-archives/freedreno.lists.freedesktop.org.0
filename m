...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1ECB507E5C
	for <lists+freedreno@lfdr.de>; Wed, 20 Apr 2022 03:46:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1533F10EFEF;
...
Subject: [Freedreno] [PATCH v2 11/17] drm/msm/dpu: add encoder operations to
