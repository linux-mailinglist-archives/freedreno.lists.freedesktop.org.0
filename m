...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C9A2800127
	for <lists+freedreno@lfdr.de>; Fri,  1 Dec 2023 02:41:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2484610E7AB;
	Fri,  1 Dec 2023 01:41:28 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 2/2] drm/msm/dpu: Add mutex lock in control
 vblank irq
