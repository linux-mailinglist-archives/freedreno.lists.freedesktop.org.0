...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BED2AF0EF
	for <lists+freedreno@lfdr.de>; Tue, 10 Sep 2019 20:15:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C42336E94C;
	Tue, 10 Sep 2019 18:15:35 +0000 (UTC)
...
X-Mailman-Approved-At: Tue, 10 Sep 2019 18:15:33 +0000
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 dFjA==
Subject: Re: [Freedreno] [PATCH v7 0/7] qcom: add OCMEM support
...
Cc: mark.rutland@arm.com, devicetree@vger.kernel.org, jonathan@marek.ca,
 ...
 robh+dt@kernel.org, jcrouse@codeaurora.org, agross@kernel.org,
 dri-devel@lists.freedesktop.org, daniel@ffwll.ch,
 freedreno@lists.freedesktop.org
Content-Type: multipart/mixed; boundary="===============1158952219=="
