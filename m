...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D7BC754325
	for <lists+freedreno@lfdr.de>; Fri, 14 Jul 2023 21:18:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0DCC10E8D4;
...
Subject: Re: [Freedreno] [PATCH v3 2/3] drm/msm: Fix IS_ERR() vs NULL check
