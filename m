...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3096F69BC21
	for <lists+freedreno@lfdr.de>; Sat, 18 Feb 2023 22:16:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86BA610E095;
...
Subject: [Freedreno] [PATCH v4 04/14] dma-buf/dma-resv: Add a way to set
 fence deadline
