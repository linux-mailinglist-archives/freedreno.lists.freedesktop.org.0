...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4ACE01038C9
	for <lists+freedreno@lfdr.de>; Wed, 20 Nov 2019 12:34:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B87BE6E264;
	Wed, 20 Nov 2019 11:34:15 +0000 (UTC)
...
Subject: [Freedreno] [PATCH] msm: disp: dpu1: add support to access hw irqs
