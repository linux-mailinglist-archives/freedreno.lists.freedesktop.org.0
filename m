...
Received: from gabe.freedesktop.org (unknown [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 416B45FC4CE
	for <lists+freedreno@lfdr.de>; Wed, 12 Oct 2022 14:03:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D2D310E441;
...
Subject: [Freedreno] [PATCH v8 02/15] drm: add helper functions to retrieve
 old and new crtc
