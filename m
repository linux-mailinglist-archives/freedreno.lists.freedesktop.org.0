...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BEF32FF0FE
	for <lists+freedreno@lfdr.de>; Thu, 21 Jan 2021 17:51:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 440996E912;
...
Subject: [Freedreno] [PATCH v2 04/11] drm/atomic: Pass the full state to
 planes atomic_check
