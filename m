...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24A5D6A6304
	for <lists+freedreno@lfdr.de>; Tue, 28 Feb 2023 23:58:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B241310E13E;
...
Subject: [Freedreno] [PATCH v8 05/16] dma-buf/sync_file: Surface sync-file
 uABI
