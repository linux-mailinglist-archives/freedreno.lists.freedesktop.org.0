...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E2CBF60A131
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:22:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B5FC10E45D;
...
Subject: [Freedreno] [PATCH v2 14/21] drm/fb-helper: Rename
