...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9C3E4EF086
	for <lists+freedreno@lfdr.de>; Fri,  1 Apr 2022 16:35:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 91BCA10EFC6;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.16 057/109] drm/msm/dsi: Remove
