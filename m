...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F7DC28ABBB
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E473389CF8;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 14/22] drm/msm: Protect ring->submits with
 it's own lock
