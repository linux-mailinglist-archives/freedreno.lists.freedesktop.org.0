...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1CE171F001
	for <lists+freedreno@lfdr.de>; Thu,  1 Jun 2023 19:00:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49C9C10E587;
...
Subject: [Freedreno] [PATCH v3 3/7] dt-bindings: display/msm: qcom,
