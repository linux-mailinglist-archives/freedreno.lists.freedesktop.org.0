...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3E6450D637
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 02:32:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78F4210E80F;
...
Subject: [Freedreno] [PATCH v5 10/19] drm/msm/dpu: make changes to
