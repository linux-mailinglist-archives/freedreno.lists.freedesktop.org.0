...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8A413436C6
	for <lists+freedreno@lfdr.de>; Mon, 22 Mar 2021 03:50:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7CAF389F53;
...
Subject: Re: [Freedreno] [PATCH] dt-bindings: display: Fix a typo
