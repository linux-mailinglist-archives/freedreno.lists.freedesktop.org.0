...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 045C2474B6
	for <lists+freedreno@lfdr.de>; Sun, 16 Jun 2019 15:29:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E65B8917E;
...
Subject: [Freedreno] [PATCH 4/6] firmware: qcom: scm: add OCMEM lock/unlock
 interface
