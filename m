...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E4E255AD0B
	for <lists+freedreno@lfdr.de>; Sun, 26 Jun 2022 00:55:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FD4C10E350;
...
Subject: [Freedreno] [PATCH 02/15] drm/msm: Make enable_eviction flag static
