...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7E39507E5F
	for <lists+freedreno@lfdr.de>; Wed, 20 Apr 2022 03:46:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6792810F029;
...
Subject: [Freedreno] [PATCH v2 05/17] drm/msm/dpu: add reset_intf_cfg
