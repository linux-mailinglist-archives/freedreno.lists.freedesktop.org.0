...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E97040ECD0
	for <lists+freedreno@lfdr.de>; Thu, 16 Sep 2021 23:43:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76BE36E936;
...
Subject: [Freedreno] [PATCH 07/15] drm/shmobile: cleanup:
