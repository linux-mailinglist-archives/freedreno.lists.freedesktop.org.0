...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AB1434FC70C
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 23:58:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52C2810E31C;
...
Subject: [Freedreno] [PATCH v4 07/10] drm/msm/gem: Rework vma lookup and pin
