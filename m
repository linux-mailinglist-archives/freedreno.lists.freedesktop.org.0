...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4433D71183
	for <lists+freedreno@lfdr.de>; Tue, 23 Jul 2019 07:59:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97FAE899FF;
...
Subject: Re: [Freedreno] [PATCH v4 13/23] drm: zte: Provide ddc symlink in
