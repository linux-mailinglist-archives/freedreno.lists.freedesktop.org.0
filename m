...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A5A1160A10A
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:21:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2231610E427;
...
Subject: [Freedreno] [PATCH v2 08/21] drm/rockchip: Don't set struct
