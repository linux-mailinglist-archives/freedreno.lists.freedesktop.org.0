...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96CF27D28FD
	for <lists+freedreno@lfdr.de>; Mon, 23 Oct 2023 05:23:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97A2410E02D;
...
Subject: [Freedreno] [PATCH] drm/sched: Convert the GPU scheduler to
