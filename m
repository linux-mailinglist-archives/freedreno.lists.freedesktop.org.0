...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CFD758597A
	for <lists+freedreno@lfdr.de>; Sat, 30 Jul 2022 11:18:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45F3710FBD2;
...
Subject: [Freedreno] [PATCH 4/5] clk: qcom: gdsc: Add a reset op to poll
 gdsc collapse
