...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7ABA44B269
	for <lists+freedreno@lfdr.de>; Tue,  9 Nov 2021 19:06:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D14A89CD7;
...
Subject: [Freedreno] [PATCH 5/5] drm/msm: Add debugfs to disable hw err
 handling
