...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9F357A2997
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 23:38:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B519910E68E;
	Fri, 15 Sep 2023 21:38:47 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 2/7] drm/msm/dp: replace is_connected with
 link_ready
