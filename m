...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C39577F225A
	for <lists+freedreno@lfdr.de>; Tue, 21 Nov 2023 01:40:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1C4D10E216;
...
Subject: [Freedreno] [PATCH v2 4/7] drm/msm/gem: Split out
