...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D4FF4B0CED
	for <lists+freedreno@lfdr.de>; Thu, 10 Feb 2022 12:58:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01AFA10E826;
...
Subject: [Freedreno] [PATCH v4 2/5] arm64: dts: qcom: sc7280: Add support
