...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 702CF28ABAC
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D43136E216;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 07/22] drm/msm: Do rpm get sooner in the
 submit path
