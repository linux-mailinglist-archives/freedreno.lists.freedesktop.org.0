...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B281F34FE67
	for <lists+freedreno@lfdr.de>; Wed, 31 Mar 2021 12:57:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B5A806EA4F;
	Wed, 31 Mar 2021 10:57:45 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mail-lj1-x234.google.com (mail-lj1-x234.google.com
 [IPv6:2a00:1450:4864:20::234])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 354D46EA4E
 for <freedreno@lists.freedesktop.org>; Wed, 31 Mar 2021 10:57:43 +0000 (UTC)
Received: by mail-lj1-x234.google.com with SMTP id 184so23280904ljf.9
 for <freedreno@lists.freedesktop.org>; Wed, 31 Mar 2021 03:57:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=oDdd/hp4bAY5EmzviwCXQAmm/NxjOGKUh0fglabyj3E=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=oDdd/hp4bAY5EmzviwCXQAmm/NxjOGKUh0fglabyj3E=;
 b=
X-Gm-Message-State: AOAM531CIE7T5Shs1it3vSAxVzqO+RbARvhdIj1889eD2aV501/Wg79l
 PUmWAVAVy2yraPZ7REvnFNgSGg==
X-Google-Smtp-Source: ABdhPJwWxuHs6GMW2l56WLTMayYG3MdpoPPrBZ9dAaMd3Ly1XNNZXXAwwH13UqjLtKidJVolGW/+sA==
X-Received: by 2002:a2e:b896:: with SMTP id r22mr1641676ljp.174.1617188260848; 
 Wed, 31 Mar 2021 03:57:40 -0700 (PDT)
Received: from eriador.lan ([37.153.55.125])
 by smtp.gmail.com with ESMTPSA id h3sm184359ljc.67.2021.03.31.03.57.39
...
Message-Id: <20210331105735.3690009-5-dmitry.baryshkov@linaro.org>
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 04/24] drm/msm/dsi: fuse dsi_pll_* code into
 dsi_phy_* code
