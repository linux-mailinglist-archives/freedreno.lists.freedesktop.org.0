...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D814250D638
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 02:32:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4260810EBCF;
...
Subject: [Freedreno] [PATCH v5 11/19] drm/msm/dpu: add encoder operations to
