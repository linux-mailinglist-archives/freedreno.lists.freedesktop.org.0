...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C28C4805E6D
	for <lists+freedreno@lfdr.de>; Tue,  5 Dec 2023 20:14:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BED310E502;
...
Subject: [Freedreno] [PATCH] drm/msm: Expose syncobj timeline support
