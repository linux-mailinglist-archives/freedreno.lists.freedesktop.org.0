...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFB8A6C1526
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:45:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E302D10E5AB;
	Mon, 20 Mar 2023 14:44:57 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 12/23] drm/msm/gpu: Move fw loading out of
 hw_init() path
