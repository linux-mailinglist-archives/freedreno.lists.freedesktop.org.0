...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74DA54C0603
	for <lists+freedreno@lfdr.de>; Wed, 23 Feb 2022 01:28:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B4B010E30B;
...
Subject: [Freedreno] [PATCH v10 3/4] drm/msm/dpu: revise timing engine
