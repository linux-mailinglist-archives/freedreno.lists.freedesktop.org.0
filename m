...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BC666B014
	for <lists+freedreno@lfdr.de>; Tue, 16 Jul 2019 21:52:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66A5B6E0EB;
...
Subject: Re: [Freedreno] [PATCH v2 2/3] drm: plumb attaching dev thru to
 prime_pin/unpin
