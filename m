...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 766F180175F
	for <lists+freedreno@lfdr.de>; Sat,  2 Dec 2023 00:13:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8CD010E183;
...
Subject: Re: [Freedreno] [PATCH 08/17] drm/msm/mdp5: use drmm-managed
 allocation for mdp5_crtc
