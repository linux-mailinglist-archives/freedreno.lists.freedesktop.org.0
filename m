...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60E6C560B89
	for <lists+freedreno@lfdr.de>; Wed, 29 Jun 2022 23:19:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7640C10E626;
...
Subject: [Freedreno] [PATCH 1/2] drm/msm/gpu: Capture all BO addr+size in
 devcore
