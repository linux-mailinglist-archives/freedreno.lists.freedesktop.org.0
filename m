...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F45025EA04
	for <lists+freedreno@lfdr.de>; Sat,  5 Sep 2020 22:04:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA5846E24B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v17 07/20] drm/msm: Set the global virtual
