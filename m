...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB19743419D
	for <lists+freedreno@lfdr.de>; Wed, 20 Oct 2021 00:50:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CAC756E0AD;
...
Subject: Re: [Freedreno] [PATCH v3 01/13] gpu/drm: make drm_add_edid_modes()
