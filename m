...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9DF66F5FBD
	for <lists+freedreno@lfdr.de>; Wed,  3 May 2023 22:11:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55FE610E35A;
...
Subject: [Freedreno] [PATCH v4 1/7] drm/msm/dpu: add dsc blocks for
