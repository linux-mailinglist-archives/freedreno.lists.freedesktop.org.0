...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF1034B0CDE
	for <lists+freedreno@lfdr.de>; Thu, 10 Feb 2022 12:57:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B6F910E826;
...
Subject: [Freedreno] [PATCH v4 0/5] Add support for the eDP panel on sc7280
 CRD
