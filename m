...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 925B374FC97
	for <lists+freedreno@lfdr.de>; Wed, 12 Jul 2023 03:20:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55D2910E477;
...
Subject: [Freedreno] [PATCH v5 1/5] drm/msm/dpu: re-introduce dpu core
