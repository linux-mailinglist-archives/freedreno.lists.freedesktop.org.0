...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CA106B0D9F
	for <lists+freedreno@lfdr.de>; Wed,  8 Mar 2023 16:54:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF1D710E671;
...
Subject: [Freedreno] [PATCH v10 12/15] drm/msm: Add deadline based boost
 support
