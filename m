...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 50D5F7475B3
	for <lists+freedreno@lfdr.de>; Tue,  4 Jul 2023 17:55:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1905910E2D0;
...
Subject: Re: [Freedreno] [PATCH v2 06/14] drm/msm/dpu: rework core_perf
 debugfs overrides
