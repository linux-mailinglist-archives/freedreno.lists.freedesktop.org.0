...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74AF57FDEB0
	for <lists+freedreno@lfdr.de>; Wed, 29 Nov 2023 18:47:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 04C7010E653;
...
Subject: [Freedreno] [PATCH v8 5/7] drm/msm/dp: incorporate pm_runtime
