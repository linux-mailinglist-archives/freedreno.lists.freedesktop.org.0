...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 049456D70F4
	for <lists+freedreno@lfdr.de>; Wed,  5 Apr 2023 01:56:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE11010E7EC;
...
Subject: [Freedreno] [PATCH v3 6/6] drm/msm/dsi: Fix calculations
 pkt_per_line
