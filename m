...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D41D04FE2C6
	for <lists+freedreno@lfdr.de>; Tue, 12 Apr 2022 15:36:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7662410E0B6;
...
Subject: Re: [Freedreno] [PATCH v5 06/10] drm/i915/hdcp: Retain hdcp_capable
 return codes
