...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 35A07752E40
	for <lists+freedreno@lfdr.de>; Fri, 14 Jul 2023 02:22:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CE6B10E05E;
...
Subject: [Freedreno] [PATCH v2] drm/msm/dsi: Enable DATABUS_WIDEN for DSI
 command mode
