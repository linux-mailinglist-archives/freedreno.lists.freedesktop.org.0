...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C081A28ABC1
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 474DC6E1E0;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 17/22] drm/msm: Drop struct_mutex from the
 retire path
