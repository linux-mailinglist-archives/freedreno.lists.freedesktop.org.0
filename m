...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 07D685B4963
	for <lists+freedreno@lfdr.de>; Sat, 10 Sep 2022 23:19:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6AA6E10E2DE;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.19 1/8] drm/msm/rd: Fix FIFO-full
 deadlock
