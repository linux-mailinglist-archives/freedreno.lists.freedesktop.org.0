...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BCD3D5A3F49
	for <lists+freedreno@lfdr.de>; Sun, 28 Aug 2022 21:22:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C03010EFC0;
...
Subject: [Freedreno] [PATCH v5 2/6] clk: qcom: Allow custom reset ops
