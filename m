...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13D4D5B91B
	for <lists+freedreno@lfdr.de>; Mon,  1 Jul 2019 12:34:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9559B895B2;
	Mon,  1 Jul 2019 10:34:24 +0000 (UTC)
...
X-Mailman-Approved-At: Mon, 01 Jul 2019 10:34:23 +0000
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 jvig==
Subject: [Freedreno] [PATCH 1/4] gpu: Use dev_get_drvdata()
...
Cc: David Airlie <airlied@linux.ie>, dri-devel@lists.freedesktop.org,
 ...
 Chandan Uddaraju <chandanu@codeaurora.org>, Rob Herring <robh@kernel.org>,
 ...
 Jordan Crouse <jcrouse@codeaurora.org>, Thomas Gleixner <tglx@linutronix.de>,
 Sean Paul <sean@poorly.run>, Tomeu Vizoso <tomeu.vizoso@collabora.com>,
 Greg Kroah-Hartman <gregkh@linuxfoundation.org>, linux-kernel@vger.kernel.org,
 Rob Clark <robdclark@gmail.com>, Daniel Mack <daniel@zonque.org>,
