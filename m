...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3626B4AA338
	for <lists+freedreno@lfdr.de>; Fri,  4 Feb 2022 23:37:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD84110ED1A;
...
Subject: Re: [Freedreno] [v5 1/3] dt-bindings: msm/dsi: Add 10nm dsi phy
 tuning properties
