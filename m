...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32EEB6FD211
	for <lists+freedreno@lfdr.de>; Wed, 10 May 2023 00:07:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2B5110E3DE;
...
Subject: [Freedreno] [PATCH v7 1/8] drm/display/dsc: Add flatness and
