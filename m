...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E0B04399ED
	for <lists+freedreno@lfdr.de>; Mon, 25 Oct 2021 17:16:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EBDD6E0CC;
...
Subject: [Freedreno] [PATCH v6 07/21] drm/bridge: lt9611: Switch to devm
 MIPI-DSI helpers
