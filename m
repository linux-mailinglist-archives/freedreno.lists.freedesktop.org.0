...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2C6074A597
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 23:11:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1EB410E4CB;
...
Subject: [Freedreno] [PATCH 04/12] drm/msm/adreno: Use quirk identify
 hw_apriv
