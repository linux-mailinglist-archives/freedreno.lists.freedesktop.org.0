...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EFD4F51E2D6
	for <lists+freedreno@lfdr.de>; Sat,  7 May 2022 03:00:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C03A10EFE4;
	Sat,  7 May 2022 01:00:26 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mail-lj1-x236.google.com (mail-lj1-x236.google.com
 [IPv6:2a00:1450:4864:20::236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 374CF10EFE2
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=ngE+uUnpqy2X2QZyw0O6g/YBVbGSsViwtHRZu1XP7Rs=;
 b=
X-Gm-Message-State: AOAM530Uy0tzgOwJF5TF064Vcl/F1ZxMhTZu1TaXrv0FH6nVs0wsC2vs
 4vv7NxxnNJAx+bew1jVl4KTLvQ==
...
Subject: [Freedreno] [PATCH 1/2] drm/msm: don't free the IRQ if it was not
 requested
