...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 604C444B264
	for <lists+freedreno@lfdr.de>; Tue,  9 Nov 2021 19:06:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7A4B89395;
...
Subject: [Freedreno] [PATCH 3/5] drm/msm: Remove struct_mutex usage
