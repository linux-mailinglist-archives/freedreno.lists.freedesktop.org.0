...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 789DE3A129A
	for <lists+freedreno@lfdr.de>; Wed,  9 Jun 2021 13:25:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB08D6E978;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 8/9] drm/rockchip: Implement mmap as GEM object
 function
