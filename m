...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 165E46A22EB
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 21:03:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B86FD10ECFD;
...
Subject: [Freedreno] [PATCH v6 15/15] drm/i915: Add deadline based boost
 support
