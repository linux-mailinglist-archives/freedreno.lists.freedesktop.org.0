...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D62E4ADC52
	for <lists+freedreno@lfdr.de>; Tue,  8 Feb 2022 16:19:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EB7110E62A;
...
Subject: [Freedreno] [PATCH v2 3/4] drm/panel-edp: Add eDP sharp panel
 support
