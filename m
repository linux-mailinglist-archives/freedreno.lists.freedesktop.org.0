...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E11950C07B
	for <lists+freedreno@lfdr.de>; Fri, 22 Apr 2022 21:45:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BBE610E5D9;
...
Subject: [Freedreno] [PATCH v2 1/3] drm/msm/dpu: introduce a wb_idx to be
