...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1ABF2EADB7
	for <lists+freedreno@lfdr.de>; Thu, 31 Oct 2019 11:44:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 960E66EE20;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 XLWg==
Subject: [Freedreno] [PATCH v4 2/7] dt-bindings: msm/mdp5: Document optional
