...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F1BFC64F35B
	for <lists+freedreno@lfdr.de>; Fri, 16 Dec 2022 22:45:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C1CF10E641;
...
Subject: [Freedreno] [PATCH v15 3/5] drm/msm/dp: parse data-lanes as
