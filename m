...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FD1750C283
	for <lists+freedreno@lfdr.de>; Sat, 23 Apr 2022 01:07:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8895B10EC80;
...
Subject: [Freedreno] [PATCH v4 06/20] drm/msm/dpu: rename
