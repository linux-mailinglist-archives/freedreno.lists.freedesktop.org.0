...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4898B60A150
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:22:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BC8710E4C3;
...
Subject: [Freedreno] [PATCH v2 20/21] drm/fb-helper: Move generic fbdev
