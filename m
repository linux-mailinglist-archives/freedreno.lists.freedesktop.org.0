...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECF056D44A7
	for <lists+freedreno@lfdr.de>; Mon,  3 Apr 2023 14:45:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6352D10E46B;
...
Subject: [Freedreno] [PATCH v2 0/8] drm/msm: Convert fbdev to DRM client
