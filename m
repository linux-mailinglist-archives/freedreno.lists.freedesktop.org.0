...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 332C54B00E
	for <lists+freedreno@lfdr.de>; Wed, 19 Jun 2019 04:32:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC50C6E280;
...
Subject: [Freedreno] [PATCH v2 1/6] dt-bindings: soc: qcom: add On Chip
