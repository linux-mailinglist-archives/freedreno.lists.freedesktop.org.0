...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C45B869C3E3
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 02:04:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5AB010E10C;
...
Subject: [Freedreno] [PATCH v2] drm/msm: DEVFREQ_GOV_SIMPLE_ONDEMAND is no
 longer needed
