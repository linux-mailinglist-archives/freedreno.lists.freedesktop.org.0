...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79927369C4C
	for <lists+freedreno@lfdr.de>; Fri, 23 Apr 2021 23:55:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F0586EC9B;
...
Subject: [Freedreno] [v2 2/2] backlight: Add DisplayPort aux backlight driver
