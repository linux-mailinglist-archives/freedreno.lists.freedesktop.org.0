...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5E986A639D
	for <lists+freedreno@lfdr.de>; Wed,  1 Mar 2023 00:05:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76D8810E0B1;
...
Subject: Re: [Freedreno] [PATCH v2 11/50] drm/msm/dpu: drop DPU_DIM_LAYER
