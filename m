...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88F3A76DABC
	for <lists+freedreno@lfdr.de>; Thu,  3 Aug 2023 00:22:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFB4910E587;
...
Subject: [Freedreno] [PATCH 3/4] drm/msm: Take lru lock once per
 submit_pin_objects()
