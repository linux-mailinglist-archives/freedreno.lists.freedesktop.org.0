...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 08E616A226C
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 20:41:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C32D10ECEE;
	Fri, 24 Feb 2023 19:41:15 +0000 (UTC)
...
Subject: [Freedreno] [RFC PATCH 2/2] drm/msm/dsi: use new
