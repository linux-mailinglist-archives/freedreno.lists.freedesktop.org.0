...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3BB5BF036
	for <lists+freedreno@lfdr.de>; Thu, 26 Sep 2019 12:53:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77AD66ECFF;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 BTqQ==
Subject: [Freedreno] [PATCH v2 1/5] drm/msm/mdp5: Add optional TBU and
 TBU_RT clocks
