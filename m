...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A2A4297523
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 18:51:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B5AD16F900;
	Fri, 23 Oct 2020 16:51:13 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 22/23] drm/msm: Drop struct_mutex in shrinker
 path
