...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CCD886A370C
	for <lists+freedreno@lfdr.de>; Mon, 27 Feb 2023 03:06:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D93810E306;
...
Subject: [Freedreno] [PATCH AUTOSEL 6.1 18/58] drm/msm/dp: Remove INIT_SETUP
 delay
