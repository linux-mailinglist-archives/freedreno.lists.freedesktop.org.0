...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9931A6A4B1B
	for <lists+freedreno@lfdr.de>; Mon, 27 Feb 2023 20:36:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EDD510E51A;
...
Subject: [Freedreno] [PATCH v7 12/15] drm/msm: Add deadline based boost
 support
