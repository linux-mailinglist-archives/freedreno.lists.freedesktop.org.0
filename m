...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D833561E90
	for <lists+freedreno@lfdr.de>; Thu, 30 Jun 2022 16:59:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97E0210ECD9;
...
Subject: Re: [Freedreno] [PATCH v3 1/4] drm/msm/adreno: Remove dead code
