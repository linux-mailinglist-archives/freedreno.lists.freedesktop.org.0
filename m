...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C4D9A501C77
	for <lists+freedreno@lfdr.de>; Thu, 14 Apr 2022 22:17:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6466110E26A;
...
Subject: Re: [Freedreno] [RFC PATCH v2 5/5] drm/msm/dp: remove extra
 wrappers and public functions
