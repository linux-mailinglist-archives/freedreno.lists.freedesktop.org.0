...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA12BFA0B7
	for <lists+freedreno@lfdr.de>; Wed, 13 Nov 2019 02:52:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37E026EC49;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.19 079/209] msm/gpu/a6xx: Force
 of_dma_configure to setup DMA for GMU
