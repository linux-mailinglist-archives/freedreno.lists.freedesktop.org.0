...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E298E6543A3
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 16:05:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5BE010E52A;
...
Subject: [Freedreno] [PATCH v10 01/15] drm/msm/disp/dpu: cache crtc obj in
 the dpu_encoder during initialization
