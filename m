...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB44B3DE96A
	for <lists+freedreno@lfdr.de>; Tue,  3 Aug 2021 11:07:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 189E76E7EA;
...
Subject: [Freedreno] [PATCH v2 12/14] drm/vc4: Convert to Linux IRQ
 interfaces
