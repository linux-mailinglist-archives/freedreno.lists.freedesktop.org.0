...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BAC8C758704
	for <lists+freedreno@lfdr.de>; Tue, 18 Jul 2023 23:25:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC87C10E3E2;
...
X-Mailer: b4 0.12.3
Subject: [Freedreno] [PATCH v3 14/15] arm64: dts: qcom: sm6125: Add display
 hardware nodes
