...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DB8229750C
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 18:50:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0BCC6F8FF;
	Fri, 23 Oct 2020 16:50:57 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 18/23] drm/msm: Drop struct_mutex from the
 retire path
