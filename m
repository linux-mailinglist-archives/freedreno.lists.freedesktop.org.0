...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 0I+QAMUNn2neYgQAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Wed, 25 Feb 2026 15:57:09 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5203D199107
	for <lists+freedreno@lfdr.de>; Wed, 25 Feb 2026 15:57:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B3AE910E7B9;
...
X-Spamd-Result: default: False [1.89 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[ben.dooks@codethink.co.uk,freedreno-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];
	ARC_NA(0.00)[];
	TO_DN_NONE(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[codethink.co.uk:url,codethink.co.uk:mid,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns]
X-Rspamd-Queue-Id: 5203D199107
