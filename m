...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D151425BDC
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:38:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F7966F4BD;
...
Subject: [Freedreno] [PATCH v3 07/20] drm/shmobile: cleanup:
