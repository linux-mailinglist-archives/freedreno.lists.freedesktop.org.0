...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED46769C660
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 09:16:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0A7210E113;
...
Subject: Re: [Freedreno] [PATCH v4 04/14] dma-buf/dma-resv: Add a way to set
 fence deadline
