...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB6357E6CBC
	for <lists+freedreno@lfdr.de>; Thu,  9 Nov 2023 15:59:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F01E88CBF;
...
Subject: [Freedreno] [PATCH 11/20] drm/sched: Convert the GPU scheduler to
