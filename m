...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DEF3D6FE6E7
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:08:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B54BA10E563;
...
Subject: [Freedreno] [PATCH v6 5/8] drm/msm/dpu: add support for DSC encoder
 v1.2 engine
