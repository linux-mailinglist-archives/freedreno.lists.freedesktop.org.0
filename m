...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5A884CB85B
	for <lists+freedreno@lfdr.de>; Thu,  3 Mar 2022 09:08:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3294510EEA3;
...
Subject: [Freedreno] [PATCH v3 0/3] Update mdp clk to max supported value to
