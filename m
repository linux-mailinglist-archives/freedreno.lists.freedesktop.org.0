...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0285560C85
	for <lists+freedreno@lfdr.de>; Thu, 30 Jun 2022 00:53:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E18E10F070;
...
Subject: [Freedreno] [PATCH v3 01/11] clk: divider: Introduce
