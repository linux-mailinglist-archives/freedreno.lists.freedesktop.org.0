...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0709A70F25D
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 11:22:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EA0A10E63E;
...
Subject: [Freedreno] [PATCH v4 08/13] drm/msm: Use regular fbdev I/O helpers
