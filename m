...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66A78691082
	for <lists+freedreno@lfdr.de>; Thu,  9 Feb 2023 19:44:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A1B510E26C;
...
Subject: [Freedreno] [RFC PATCH v2 0/4] Move TE setup to
 prepare_for_kickoff()
