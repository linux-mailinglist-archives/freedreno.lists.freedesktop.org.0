...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9A504EE511
	for <lists+freedreno@lfdr.de>; Fri,  1 Apr 2022 02:12:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5259910E366;
...
Subject: [Freedreno] [PATCH v6 2/4] drm: introduce
