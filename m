...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8ED5B784921
	for <lists+freedreno@lfdr.de>; Tue, 22 Aug 2023 20:02:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0188910E3D6;
...
Subject: [Freedreno] [PATCH v5 09/11] drm/msm: Move runpm enable in submit
 path
