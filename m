...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 69C86BC867
	for <lists+freedreno@lfdr.de>; Tue, 24 Sep 2019 15:00:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97D1C89E33;
...
Subject: [Freedreno] [PATCH v2 6/9] drm/msm: use drm_debug_enabled() to
