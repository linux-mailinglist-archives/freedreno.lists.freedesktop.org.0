...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F1A4E673BB0
	for <lists+freedreno@lfdr.de>; Thu, 19 Jan 2023 15:26:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B97410E954;
...
Subject: [Freedreno] [PATCH Resend v11 00/15] Add PSR support for eDP
