...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C2A4A67785C
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 11:06:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 295ED882D0;
...
Subject: [Freedreno] [PATCH 03/10] drm/fb-helper: Introduce
