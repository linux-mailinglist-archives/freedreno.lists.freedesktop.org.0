...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 080BD430458
	for <lists+freedreno@lfdr.de>; Sat, 16 Oct 2021 20:43:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7E106E4AE;
...
Subject: [Freedreno] [PATCH v2 03/13] drm/radeon: replace
