...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 419897A2876
	for <lists+freedreno@lfdr.de>; Fri, 15 Sep 2023 22:48:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12F8810E682;
...
Subject: [Freedreno] [PATCH v2 2/7] drm/msm/dp: replace is_connected with
 link_ready
