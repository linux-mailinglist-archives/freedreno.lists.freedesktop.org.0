...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AC613B4FA2
	for <lists+freedreno@lfdr.de>; Sat, 26 Jun 2021 18:52:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B3736E090;
...
Subject: [Freedreno] [v8 2/6] drm/panel-simple: Support DP AUX backlight
