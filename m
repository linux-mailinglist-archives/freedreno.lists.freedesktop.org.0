...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F26AF6FE7B0
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:55:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A1AC10E57B;
...
Subject: [Freedreno] [PATCH v9 7/8] drm/msm/dsi: Use MSM and DRM DSC helper
 methods
