...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 33574221443
	for <lists+freedreno@lfdr.de>; Wed, 15 Jul 2020 20:29:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A49D6EBEA;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH] drm/msm/adreno: fix gpu probe if no
 interconnect-names
