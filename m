...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E3E44B0AB3
	for <lists+freedreno@lfdr.de>; Thu, 10 Feb 2022 11:34:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F2CC10E7D0;
...
Subject: [Freedreno] [REPOST PATCH v4 01/13] drm/msm/dsi: add support for
 dsc data
