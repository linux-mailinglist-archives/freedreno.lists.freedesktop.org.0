...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB4A259E47C
	for <lists+freedreno@lfdr.de>; Tue, 23 Aug 2022 15:32:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B646611349C;
...
Subject: [Freedreno] [PATCH] disp/dpu1: fix repeated words in comments
