...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E6D8765E0D
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 23:23:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D5B3110E618;
...
Subject: [Freedreno] [PATCH v2 13/13] drm/msm/adreno: Switch to chip-id for
 identifying GPU
...
Cc: Ulf Hansson <ulf.hansson@linaro.org>,
 ...
 Rob Herring <robh@kernel.org>, Liu Ying <victor.liu@nxp.com>,
