...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B353488505
	for <lists+freedreno@lfdr.de>; Sat,  8 Jan 2022 18:42:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42ACC10E19F;
...
Subject: [Freedreno] [PATCH v2 0/2] drm/msm/gpu: System suspend fixes
