...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC53070A16F
	for <lists+freedreno@lfdr.de>; Fri, 19 May 2023 23:17:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4BD510E61C;
...
Subject: [Freedreno] [PATCH v3 4/5] drm/msm/dpu: Set DATA_COMPRESS for
 command mode
