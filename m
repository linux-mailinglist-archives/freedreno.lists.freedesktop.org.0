...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 70687567504
	for <lists+freedreno@lfdr.de>; Tue,  5 Jul 2022 19:01:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4253E926C2;
...
Subject: [Freedreno] [PATCH v4 4/7] drm/bridge: use atomic enable/disable
