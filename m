...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6HPyGvEar2lIOAIAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:09:37 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2AA523F335
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:09:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA82A10E5C3;
	Mon,  9 Mar 2026 19:09:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=nxp.com header.i=@nxp.com header.b="nrQGSFy2";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from DU2PR03CU002.outbound.protection.outlook.com
 (mail-northeuropeazon11011024.outbound.protection.outlook.com [52.101.65.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4686710E58C;
 Mon,  9 Mar 2026 19:09:34 +0000 (UTC)
...
Subject: [PATCH v3 phy-next 11/24] drm/msm/dp: remove debugging prints with
...
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:AM9PR04MB8585.eurprd04.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(19092799006)(1800799024)(366016)(10070799003)(7416014)(376014);
 DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 2
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?fkpA5UTPbZKIEBQIZQ7Ra4pv3sXRj+XFYMHOyC/jgXF7YTfn4ZuWVyvPph2D?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Mar 2026 19:09:31.1266 (UTC)
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,linux.dev:email,ffwll.ch:email,nxp.com:dkim,nxp.com:email,nxp.com:mid,qualcomm.com:email,somainline.org:email]
