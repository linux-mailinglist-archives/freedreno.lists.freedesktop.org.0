...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB71C38C4C9
	for <lists+freedreno@lfdr.de>; Fri, 21 May 2021 12:28:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB3C5892A5;
...
Subject: [Freedreno] [PATCH v17 1/4] dt-bindings: msm: disp: add yaml
