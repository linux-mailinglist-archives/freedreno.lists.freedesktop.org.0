...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B53E6176B30
	for <lists+freedreno@lfdr.de>; Tue,  3 Mar 2020 03:49:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4453E6E965;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.19 12/32] drm/msm/dsi/pll: call vco
 set rate explicitly
