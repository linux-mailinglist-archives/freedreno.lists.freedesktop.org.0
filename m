...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4346B474B7
	for <lists+freedreno@lfdr.de>; Sun, 16 Jun 2019 15:29:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D277E891B7;
...
Subject: [Freedreno] [PATCH 3/6] firmware: qcom: scm: add support to restore
 secure config
