...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1451D292FDC
	for <lists+freedreno@lfdr.de>; Mon, 19 Oct 2020 22:46:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54AAA6EAC0;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 18/23] drm/msm: Drop struct_mutex from the
 retire path
