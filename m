...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B82BF645F79
	for <lists+freedreno@lfdr.de>; Wed,  7 Dec 2022 17:58:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43E9510E406;
...
Subject: [Freedreno] [PATCH v10 2/5] dt-bindings: msm/dp: add data-lanes and
