...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A25286E9FDB
	for <lists+freedreno@lfdr.de>; Fri, 21 Apr 2023 01:25:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F067B10ED40;
...
Subject: [Freedreno] [PATCH v1 3/5] drm/msm/dpu: save dpu topology
 configuration
