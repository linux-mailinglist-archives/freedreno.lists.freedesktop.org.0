...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2622B70114E
	for <lists+freedreno@lfdr.de>; Fri, 12 May 2023 23:32:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 695D210E2F8;
...
Subject: [Freedreno] [PATCH v10 4/8] drm/msm: Add MSM-specific DSC helper
 methods
