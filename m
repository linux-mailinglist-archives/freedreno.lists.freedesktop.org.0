...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DA677431A5
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F87F10E426;
	Fri, 30 Jun 2023 00:26:07 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v4 3/7] drm/atomic: Move framebuffer checks
 to helper
