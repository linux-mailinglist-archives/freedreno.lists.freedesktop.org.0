...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D0A9765E09
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 23:23:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F05610E616;
...
Subject: [Freedreno] [PATCH v2 12/13] dt-bindings: drm/msm/gpu: Extend
