...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BB7BA50A2B2
	for <lists+freedreno@lfdr.de>; Thu, 21 Apr 2022 16:37:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C0C810E41B;
...
Subject: [Freedreno] [PATCH v8 2/4] drm/msm/dp: Support only IRQ_HPD and
