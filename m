...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46B2E8E1FA
	for <lists+freedreno@lfdr.de>; Thu, 15 Aug 2019 02:49:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D4BD6E884;
...
Subject: [Freedreno] [PATCH 03/11] drm/bridge: analogix-anx78xx: silence
