...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F1C5A6F7017
	for <lists+freedreno@lfdr.de>; Thu,  4 May 2023 18:47:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 051BE10E4F3;
	Thu,  4 May 2023 16:47:10 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v5 2/7] drm/msm/dpu: add DPU_PINGPONG_DSC
 feature bit
