...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C3B16E54D5
	for <lists+freedreno@lfdr.de>; Tue, 18 Apr 2023 00:55:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C202310E632;
...
Subject: [Freedreno] [PATCH] drm/msm: Move cmdstream dumping out of sched
 kthread
