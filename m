...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A24BB6AA1B7
	for <lists+freedreno@lfdr.de>; Fri,  3 Mar 2023 22:42:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66F8810E765;
...
Subject: [Freedreno] [PATCH] dt-bindings: yamllint: Require a space after a
 comment '#'
