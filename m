...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13645292FB6
	for <lists+freedreno@lfdr.de>; Mon, 19 Oct 2020 22:45:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A82D96EA9D;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 05/23] drm/msm/gem: Add some _locked() helpers
