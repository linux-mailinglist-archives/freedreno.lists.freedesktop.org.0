...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE34052F094
	for <lists+freedreno@lfdr.de>; Fri, 20 May 2022 18:27:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 318F410E92C;
...
Subject: [Freedreno] [PATCH v8 2/3] phy: qcom-qmp: add regulator_set_load to
 dp phy
