...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 460536F35FD
	for <lists+freedreno@lfdr.de>; Mon,  1 May 2023 20:45:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AF8710E241;
...
Subject: [Freedreno] [PATCH v3 1/9] drm/docs: Fix usage stats typos
