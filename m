...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10FA54A38CD
	for <lists+freedreno@lfdr.de>; Sun, 30 Jan 2022 20:57:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BB2A11381F;
...
Subject: [Freedreno] [v4 1/3] dt-bindings: msm/dsi: Add 10nm dsi phy tuning
 properties
