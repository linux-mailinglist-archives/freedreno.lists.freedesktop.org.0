...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E019488533
	for <lists+freedreno@lfdr.de>; Sat,  8 Jan 2022 19:08:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BF1F10F2A9;
...
Subject: [Freedreno] [PATCH v2] dt-bindings: display/msm: hdmi: split and
 convert to yaml
