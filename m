...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7E5D146A3C
	for <lists+freedreno@lfdr.de>; Thu, 23 Jan 2020 15:00:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E51CA6FCEC;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 07/22] drm/i915: Convert to CRTC VBLANK
 callbacks
