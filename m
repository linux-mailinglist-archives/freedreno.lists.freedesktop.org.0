...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACD345B6A06
	for <lists+freedreno@lfdr.de>; Tue, 13 Sep 2022 10:58:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7576F10E664;
...
Subject: [Freedreno] [PATCH v2 02/10] drm/msm/dp: fix memory corruption with
 too many bridges
