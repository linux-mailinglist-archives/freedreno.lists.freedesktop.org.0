...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9282A4DCBB2
	for <lists+freedreno@lfdr.de>; Thu, 17 Mar 2022 17:51:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2BC410E03B;
...
Subject: [Freedreno] [PATCH v2 0/3] drm/msm: Add comm/cmdline override
