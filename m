...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AD0B35F9EC
	for <lists+freedreno@lfdr.de>; Wed, 14 Apr 2021 19:36:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE9BC6E4CD;
	Wed, 14 Apr 2021 17:36:09 +0000 (UTC)
...
Subject: [Freedreno] [v1 0/3] drm: Add support for backlight control of eDP
