...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E425D625BBB
	for <lists+freedreno@lfdr.de>; Fri, 11 Nov 2022 14:56:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C07F10E822;
...
Subject: [Freedreno] [v1] drm/msm/disp/dpu1: pin 1 crtc to 1 encoder
