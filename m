...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A44CE3A3635
	for <lists+freedreno@lfdr.de>; Thu, 10 Jun 2021 23:44:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4586F6EDFF;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v5 3/5] drm/msm: Improve the a6xx page fault
 handler
