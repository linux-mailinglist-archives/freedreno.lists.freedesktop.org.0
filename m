...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 808272436AC
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 10:38:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCB336E9E3;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 18/20] drm/xen: Introduce GEM object functions
