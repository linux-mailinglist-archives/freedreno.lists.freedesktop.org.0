...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2207C4EC916
	for <lists+freedreno@lfdr.de>; Wed, 30 Mar 2022 18:03:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA74910E6F6;
...
Subject: [Freedreno] [PATCH v6 3/8] drm/msm/dp: Support only IRQ_HPD and
