...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4936CBC59F1
	for <lists+freedreno@lfdr.de>; Wed, 08 Oct 2025 17:32:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 285F310E128;
	Wed,  8 Oct 2025 15:32:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=amazon.com header.i=@amazon.com header.b="qOB8Bsg3";
	dkim-atps=neutral
...
Received: from pdx-out-001.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 [44.245.243.92])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E58D10E128;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 LLY0JiC841GCT3Z2j1V/LiMJPntwssovSNHpO0KMhkULgneTwd7IBBHWF g==;
...
Received: from ip-10-5-9-48.us-west-2.compute.internal (HELO
 ...
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Oct 2025 15:32:40 +0000
...
Subject: [PATCH v3 10/19 5.15.y] minmax: simplify min()/max()/clamp()
 implementation
