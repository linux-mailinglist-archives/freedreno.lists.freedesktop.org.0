...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E7CA218B9F
	for <lists+freedreno@lfdr.de>; Wed,  8 Jul 2020 17:42:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A6946E46C;
...
Subject: [Freedreno] [PATCH AUTOSEL 4.19 1/8] drm/msm: fix potential memleak
 in error branch
