...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10E476943FB
	for <lists+freedreno@lfdr.de>; Mon, 13 Feb 2023 12:11:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C809610E55C;
...
Subject: [Freedreno] [PATCH v4 0/4] Reserve DSPPs based on user request
