...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA59B71668D
	for <lists+freedreno@lfdr.de>; Tue, 30 May 2023 17:13:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2E7910E3CB;
...
Subject: [Freedreno] [PATCH v5 01/13] fbdev: Add Kconfig options to select
