...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3659063ADF5
	for <lists+freedreno@lfdr.de>; Mon, 28 Nov 2022 17:39:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B484010E2F8;
...
Subject: [Freedreno] [pull] drm/msm: drm-msm-next-2022-11-28 for v6.2
