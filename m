...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 847684F194E
	for <lists+freedreno@lfdr.de>; Mon,  4 Apr 2022 18:35:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30C8710E562;
...
Subject: [Freedreno] [PATCH v6 06/14] drm/msm/disp/dpu1: Add DSC support in
 hw_ctl
