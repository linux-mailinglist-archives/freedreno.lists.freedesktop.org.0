...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC8A974A595
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 23:11:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2A6710E4AC;
...
Subject: [Freedreno] [PATCH 03/12] drm/msm/adreno: Remove redundant revn
 param
