...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C4A222F93F
	for <lists+freedreno@lfdr.de>; Mon, 27 Jul 2020 21:41:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C573489F6B;
...
Subject: Re: [Freedreno] [v6] dt-bindings: msm: disp: add yaml schemas for
