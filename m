...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D10F126615B
	for <lists+freedreno@lfdr.de>; Fri, 11 Sep 2020 16:40:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76B3E6EA7E;
	Fri, 11 Sep 2020 14:40:21 +0000 (UTC)
...
Subject: [Freedreno] [PATCHv4 5/6] iommu: arm-smmu-impl: Use table to list
