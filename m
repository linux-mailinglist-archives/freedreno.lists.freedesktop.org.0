...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E799758A97
	for <lists+freedreno@lfdr.de>; Wed, 19 Jul 2023 03:03:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6018410E075;
...
Subject: Re: [Freedreno] [PATCH v2 04/13] drm/msm/dpu: use devres-managed
