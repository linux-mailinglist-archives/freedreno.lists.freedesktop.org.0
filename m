...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 279BE4C05FE
	for <lists+freedreno@lfdr.de>; Wed, 23 Feb 2022 01:28:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40C1E10E291;
...
Subject: [Freedreno] [PATCH v10 2/4] drm/msm/dpu: replace BIT(x) with
