...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 201C2714F4B
	for <lists+freedreno@lfdr.de>; Mon, 29 May 2023 20:20:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D29EC10E2D9;
	Mon, 29 May 2023 18:20:47 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH 3/7] dt-bindings: display/msm: qcom,
 mdp5: Add msm8226 compatible
