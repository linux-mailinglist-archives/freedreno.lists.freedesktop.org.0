...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 152013DAAFC
	for <lists+freedreno@lfdr.de>; Thu, 29 Jul 2021 20:35:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADAFA6EE1E;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH] drm/msm: Disable frequency clamping on a630
