...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DD77282886
	for <lists+freedreno@lfdr.de>; Tue,  6 Aug 2019 02:23:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A53B6E2CE;
...
Subject: [Freedreno] [PATCH v5 2/7] dt-bindings: display: msm: gmu: add
