...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8722660A14C
	for <lists+freedreno@lfdr.de>; Mon, 24 Oct 2022 13:22:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DD0710E47C;
...
Subject: [Freedreno] [PATCH v2 15/21] drm/fb-helper: Disconnect damage
