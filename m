...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73B8C439A1E
	for <lists+freedreno@lfdr.de>; Mon, 25 Oct 2021 17:16:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFEC06E153;
...
Subject: [Freedreno] [PATCH v6 19/21] drm/bridge: tc358775: Register and
