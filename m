...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B738D72DA
	for <lists+freedreno@lfdr.de>; Tue, 15 Oct 2019 12:11:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A48EA89998;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 XGRg==
Subject: [Freedreno] [PATCH v3 1/7] drm/msm/mdp5: Add optional TBU and
 TBU_RT clocks
