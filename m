...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 780E2416C2A
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6EA26EE38;
...
Subject: [Freedreno] [PATCH v2 13/17] drm/i915: cleanup:
