...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18809259491
	for <lists+freedreno@lfdr.de>; Tue,  1 Sep 2020 17:41:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85ACB6E873;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 1/3] drm/msm/gpu: Add GPU freq_change traces
