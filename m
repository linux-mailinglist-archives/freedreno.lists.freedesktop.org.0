...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 37C2A13C012
	for <lists+freedreno@lfdr.de>; Wed, 15 Jan 2020 13:17:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2880D6E963;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 09/21] drm/nouveau: Convert to CRTC VBLANK
 callbacks
