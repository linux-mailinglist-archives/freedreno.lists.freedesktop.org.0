...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RSPAMD_URIBL_FAIL(0.00)[somainline.org:query timed out];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[vladimir.oltean.nxp.com:server fail,simona.ffwll.ch:server fail];
	DBL_BLOCKED_OPENRESOLVER(0.00)[ffwll.ch:email,qualcomm.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,linux.dev:email]
