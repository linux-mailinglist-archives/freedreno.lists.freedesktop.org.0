...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06DD3707734
	for <lists+freedreno@lfdr.de>; Thu, 18 May 2023 03:14:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB60710E4C1;
...
Subject: [Freedreno] [PATCH v13 1/9] drm/display/dsc: Add flatness and
