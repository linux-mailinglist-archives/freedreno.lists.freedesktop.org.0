...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B2857FFEB8
	for <lists+freedreno@lfdr.de>; Thu, 30 Nov 2023 23:48:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD0E410E755;
...
Subject: [Freedreno] [PATCH v3] drm/msm/dpu: Capture dpu snapshot when
