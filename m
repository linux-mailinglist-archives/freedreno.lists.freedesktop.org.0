...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64C2E6784AA
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:25:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C442610E539;
...
Subject: [Freedreno] [PATCH v1 05/14] drm/msm/dp: upgrade tu calculation
