...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 337CA5B5E28
	for <lists+freedreno@lfdr.de>; Mon, 12 Sep 2022 18:24:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C86E10E600;
...
Subject: [Freedreno] [PATCH v5 2/3] drm/msm/dp: replace variable err with
 len at dp_aux_link_power_up()
