...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E6C970290C
	for <lists+freedreno@lfdr.de>; Mon, 15 May 2023 11:41:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B96AA10E1BC;
...
Subject: [Freedreno] [PATCH v2 04/12] drm/gma500: Use regular fbdev I/O
 helpers
