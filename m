...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30F1C6C151C
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:44:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 218C210E5A0;
...
Subject: [Freedreno] [PATCH v2 04/23] drm/msm: Decouple vma tracking from
 obj lock
