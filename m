...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 062F2FBFE9
	for <lists+freedreno@lfdr.de>; Thu, 14 Nov 2019 06:55:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EA3F6E0A0;
	Thu, 14 Nov 2019 05:55:49 +0000 (UTC)
...
Subject: [Freedreno] [v1] msm: disp: dpu1: add support to access hw irqs
