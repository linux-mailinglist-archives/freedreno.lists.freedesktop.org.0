...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CA3A2B4DDC
	for <lists+freedreno@lfdr.de>; Mon, 16 Nov 2020 18:47:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52C656EA0F;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 1/3] drm/msm: Protect obj->active_count under
 obj lock
