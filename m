...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30A3E661C51
	for <lists+freedreno@lfdr.de>; Mon,  9 Jan 2023 03:20:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2283B10E24E;
	Mon,  9 Jan 2023 02:20:51 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2] drm/msm: Add missing check and destroy for
