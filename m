...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B0304FE233
	for <lists+freedreno@lfdr.de>; Tue, 12 Apr 2022 15:20:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EA0010E9A5;
...
Subject: Re: [Freedreno] [PATCH v5 02/10] drm/hdcp: Avoid changing crtc
