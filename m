...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60ED2142515
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 09:24:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3F8A6E7D7;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 03/22] drm: Add get_vblank_timestamp() to
