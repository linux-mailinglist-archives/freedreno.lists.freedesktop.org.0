...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71243666784
	for <lists+freedreno@lfdr.de>; Thu, 12 Jan 2023 01:16:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD36A10E83F;
	Thu, 12 Jan 2023 00:16:24 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 2/2] drm/msm/dsi: implement opp table based
