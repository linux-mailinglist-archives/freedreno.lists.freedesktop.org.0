...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4ED65656D98
	for <lists+freedreno@lfdr.de>; Tue, 27 Dec 2022 18:45:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 094E510E2F3;
...
Subject: [Freedreno] [PATCH v16 2/5] dt-bindings: msm/dp: add data-lanes and
