...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5ACE708C5C
	for <lists+freedreno@lfdr.de>; Fri, 19 May 2023 01:34:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D83810E590;
...
Subject: [Freedreno] [PATCH v11 4/9] drm/msm/dpu: Introduce PINGPONG_NONE to
