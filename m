...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E900253BE91
	for <lists+freedreno@lfdr.de>; Thu,  2 Jun 2022 21:20:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0E4010F106;
...
Subject: Re: [Freedreno] [PATCH v2 4/7] drm/msm/dpu: change catalog->perf to
 be a const pointer
