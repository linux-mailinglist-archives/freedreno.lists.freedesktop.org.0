...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A0E0128ABC7
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5049D6E1A4;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 20/22] drm/msm: drop struct_mutex in madvise
 path
