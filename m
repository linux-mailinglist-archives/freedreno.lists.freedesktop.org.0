...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8795772C32
	for <lists+freedreno@lfdr.de>; Mon,  7 Aug 2023 19:12:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 153BB10E32B;
...
Subject: [Freedreno] [PATCH v4 0/9] drm/msm+PM+icc: Make job_run()
 reclaim-safe
