...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A4957CB85C
	for <lists+freedreno@lfdr.de>; Tue, 17 Oct 2023 04:19:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1860410E253;
...
Subject: [Freedreno] [PATCH v4 5/6] drm/msm/dpu: Add hw revision 4.1 (SDM670)
