...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B51D07CB852
	for <lists+freedreno@lfdr.de>; Tue, 17 Oct 2023 04:18:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC19910E23F;
...
Subject: [Freedreno] [PATCH v4 2/6] dt-bindings: display/msm: sdm845-dpu:
 Describe SDM670
