...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F59250D63A
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 02:32:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25FE210EBFE;
...
Subject: [Freedreno] [PATCH v5 12/19] drm/msm/dpu: move
