...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64D727002D0
	for <lists+freedreno@lfdr.de>; Fri, 12 May 2023 10:42:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAE4410E647;
...
Subject: [Freedreno] [PATCH 07/11] drm/omapdrm: Use regular fbdev I/O helpers
