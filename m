...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 29317772C4A
	for <lists+freedreno@lfdr.de>; Mon,  7 Aug 2023 19:12:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97DFA10E334;
...
Subject: [Freedreno] [PATCH v4 9/9] drm/msm: Enable fence signalling
 annotations
