...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24E7942CBDF
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 22:50:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A19986EB5E;
...
Subject: [Freedreno] [PATCH v4 18/20] drm/amd: cleanup:
