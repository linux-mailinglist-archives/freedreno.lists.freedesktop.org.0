...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D27B6C25C1
	for <lists+freedreno@lfdr.de>; Tue, 21 Mar 2023 00:38:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E97E910E678;
...
Subject: [Freedreno] [PATCH v2] dt-bindings: display: Drop unneeded quotes
