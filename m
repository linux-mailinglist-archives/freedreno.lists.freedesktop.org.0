...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 54C0850D645
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 02:32:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A85F110F0B5;
...
Subject: [Freedreno] [PATCH v5 14/19] drm/msm/dpu: add the writeback
 connector layer
