...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 093D02E8564
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8433189789;
...
Subject: [Freedreno] [PATCH 09/31] spi: spi-qcom-qspi: fix potential mem
