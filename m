...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27F4D56A79C
	for <lists+freedreno@lfdr.de>; Thu,  7 Jul 2022 18:12:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A14511B28C;
...
Subject: [Freedreno] [PATCH 7/7] drm/msm/a6xx: Handle GMU prepare-slumber
 hfi failure
