...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54DD7764280
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 01:24:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0594010E036;
...
Subject: Re: [Freedreno] [PATCH 6/6] drm/msm/dpu: drop UBWC configuration
