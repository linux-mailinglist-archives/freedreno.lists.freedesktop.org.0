...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KLdSCuWMqWk2/gAAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:13 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0AC8212F12
	for <lists+freedreno@lfdr.de>; Thu, 05 Mar 2026 15:02:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73E8810EC0B;
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[claudiu.beznea.tuxon.dev:server fail];
