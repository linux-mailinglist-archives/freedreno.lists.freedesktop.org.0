...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ED63338E5B6
	for <lists+freedreno@lfdr.de>; Mon, 24 May 2021 13:45:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF5A86E21C;
...
Subject: [Freedreno] [PATCH v18 2/4] dt-bindings: msm: dsi: add yaml schemas
 for DSI bindings
