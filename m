...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04A0F53B77E
	for <lists+freedreno@lfdr.de>; Thu,  2 Jun 2022 12:50:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EA7B10E2C2;
...
Subject: [Freedreno] [PATCH v1] dt-bindings: msm: update maintainers list
 with proper id
