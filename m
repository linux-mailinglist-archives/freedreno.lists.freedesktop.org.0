...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84227350BCD
	for <lists+freedreno@lfdr.de>; Thu,  1 Apr 2021 03:23:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17EC76EBFB;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 0/4] drm/msm: Shrinker (and related) fixes
