...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DACDB73AD6D
	for <lists+freedreno@lfdr.de>; Fri, 23 Jun 2023 01:50:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 147B710E5C6;
	Thu, 22 Jun 2023 23:50:37 +0000 (UTC)
...
Subject: [Freedreno] [PATCH 1/6] drm/msm: Update dev core dump to not print
 backwards
