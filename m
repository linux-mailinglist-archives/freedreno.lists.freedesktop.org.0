...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9029282D0F
	for <lists+freedreno@lfdr.de>; Sun,  4 Oct 2020 21:21:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0897889F5B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 09/14] drm/msm: Drop struct_mutex from the
 retire path
