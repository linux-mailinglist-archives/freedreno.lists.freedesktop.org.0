...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A5AA56930D
	for <lists+freedreno@lfdr.de>; Wed,  6 Jul 2022 22:08:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C68311B93E;
...
Subject: Re: [Freedreno] [PATCH v3 1/3] drm/msm/dpu: index dpu_kms->hw_vbif
 using vbif_idx
