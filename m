...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D1FC6A22DC
	for <lists+freedreno@lfdr.de>; Fri, 24 Feb 2023 21:02:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBE4E10ED27;
	Fri, 24 Feb 2023 20:02:37 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v6 14/15] drm/msm/atomic: Switch to vblank_start
 helper
