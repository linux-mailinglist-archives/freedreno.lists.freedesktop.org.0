...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 851EA7431A9
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A2E810E42E;
...
Subject: [Freedreno] [PATCH RFC v4 7/7] drm/msm/dpu: Use DRM solid_fill
 property
