...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9F2511AA6E
	for <lists+freedreno@lfdr.de>; Wed, 11 Dec 2019 13:04:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D1C66EB1F;
...
Subject: [Freedreno] [PATCH v2] drm: Remove drm_bridge->dev
