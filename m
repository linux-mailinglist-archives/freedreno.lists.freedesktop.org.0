...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E078B4FC287
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 18:37:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D6B210EB43;
...
Subject: [Freedreno] [PATCH v8 1/2] drm/msm/disp/dpu1: add inline function
