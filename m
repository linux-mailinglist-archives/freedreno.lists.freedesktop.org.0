...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5073461C71
	for <lists+freedreno@lfdr.de>; Mon, 29 Nov 2021 18:04:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E4816E428;
...
Subject: [Freedreno] [PATCH v5] drm/msm/dp: employ bridge mechanism for
