...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 298DF654840
	for <lists+freedreno@lfdr.de>; Thu, 22 Dec 2022 23:15:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8800F10E594;
...
Subject: [Freedreno] [RFC PATCH v2 0/3] Support for Solid Fill Planes
