...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04829BF035
	for <lists+freedreno@lfdr.de>; Thu, 26 Sep 2019 12:53:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E3DF6ED00;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 DX/w==
Subject: [Freedreno] [PATCH v2 0/5] DRM/MSM: Add support for MSM8956 and
 Adreno 510
