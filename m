...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B5E93DE950
	for <lists+freedreno@lfdr.de>; Tue,  3 Aug 2021 11:07:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0746E6E509;
...
Subject: [Freedreno] [PATCH v2 02/14] drm/arm/hdlcd: Convert to Linux IRQ
 interfaces
