...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED16B50DF33
	for <lists+freedreno@lfdr.de>; Mon, 25 Apr 2022 13:45:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D4E810E50C;
...
Subject: [Freedreno] [PATCH v10 4/4] drm/msm/dp: Support the eDP modes given
 by panel
