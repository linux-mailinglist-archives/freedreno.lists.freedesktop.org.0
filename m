...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1194859B5EF
	for <lists+freedreno@lfdr.de>; Sun, 21 Aug 2022 20:19:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54E748FAAF;
...
Subject: [Freedreno] [PATCH 2/5] iommu/arm-smmu-qcom: Provide way to access
 current TTBR0
