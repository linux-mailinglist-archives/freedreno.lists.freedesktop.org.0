...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2ECCF74A51B
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 22:49:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F58210E4AC;
...
Subject: [Freedreno] [PATCH v4 1/6] drm/msm: Update dev core dump to not
 print backwards
