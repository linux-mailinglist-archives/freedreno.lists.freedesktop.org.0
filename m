...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 105AB806A3
	for <lists+freedreno@lfdr.de>; Sat,  3 Aug 2019 16:20:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE7816E52C;
...
Subject: [Freedreno] [PATCH v4 4/6] firmware: qcom: scm: add support to
