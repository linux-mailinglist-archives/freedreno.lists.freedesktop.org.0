...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AC59D4DB820
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 19:48:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A44C10E95A;
...
Subject: [Freedreno] [PATCH v3 0/3] Allow drm_writeback_connector to accept
