...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EBE8441EDFD
	for <lists+freedreno@lfdr.de>; Fri,  1 Oct 2021 14:58:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B2D76ECB5;
...
Subject: [Freedreno] [PATCH] drm/msm/a4xx: fix error handling in
 a4xx_gpu_init()
