...
X-Spamd-Result: default: False [0.79 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DKIM_MIXED(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,pengutronix.de:email,synopsys.com:dkim,synopsys.com:email,synopsys.com:mid];
	...
	FROM_NEQ_ENVFROM(0.00)[Thinh.Nguyen@synopsys.com,freedreno-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];
