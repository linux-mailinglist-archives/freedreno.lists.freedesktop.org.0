...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C16D16B89C2
	for <lists+freedreno@lfdr.de>; Tue, 14 Mar 2023 05:44:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BD1F10E6E2;
...
Subject: Re: [Freedreno] [PATCH v5 32/32] drm/msm/dpu: remove unused
