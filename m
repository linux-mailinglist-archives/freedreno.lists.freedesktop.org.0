...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3B3C68A316
	for <lists+freedreno@lfdr.de>; Fri,  3 Feb 2023 20:34:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B2BF510E8BE;
...
Subject: Re: [Freedreno] [PATCH v3 05/27] drm/msm/dpu: move pipe_hw to
 dpu_plane_state
