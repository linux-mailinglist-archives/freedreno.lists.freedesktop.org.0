...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BD087777CA
	for <lists+freedreno@lfdr.de>; Thu, 10 Aug 2023 14:04:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13E3510E50F;
...
Subject: [Freedreno] [PATCH -next] drm/msm/adreno: adreno_gpu: Switch to
