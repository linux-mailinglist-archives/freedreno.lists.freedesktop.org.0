...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99203679987
	for <lists+freedreno@lfdr.de>; Tue, 24 Jan 2023 14:40:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2496010E68B;
...
Subject: [Freedreno] [PATCH v2 04/10] drm/fbdev-generic: Initialize
