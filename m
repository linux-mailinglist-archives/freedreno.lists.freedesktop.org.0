...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8C9E76F541
	for <lists+freedreno@lfdr.de>; Fri,  4 Aug 2023 00:02:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66F5210E67D;
...
Subject: [Freedreno] [PATCH v3 0/9] drm/msm+PM+icc: Make job_run()
 reclaim-safe
