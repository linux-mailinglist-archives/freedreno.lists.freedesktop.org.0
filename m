...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66BEF61822A
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:17:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9394110E6AD;
...
Subject: [Freedreno] [PATCH v3 16/23] drm/fb-helper: Call fb_sync in I/O
 functions
