...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 77B377BC199
	for <lists+freedreno@lfdr.de>; Fri,  6 Oct 2023 23:52:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BBD510E035;
	Fri,  6 Oct 2023 21:52:56 +0000 (UTC)
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com
 [205.220.180.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E81A10E575
 for <freedreno@lists.freedesktop.org>; Fri,  6 Oct 2023 21:52:53 +0000 (UTC)
Received: from pps.filterd (m0279869.ppops.net [127.0.0.1])
 by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id
 396LOYfM007126
 for <freedreno@lists.freedesktop.org>; Fri, 6 Oct 2023 21:52:52 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com;
 h=message-id : date :
 mime-version : subject : to : references : from : in-reply-to :
 content-type : content-transfer-encoding; s=qcppdkim1;
 bh=URUuCtWbltWYfgDWP2No3RRNXbqUw/8hs4fMqIEC9FE=;
 b= Og== 
Received: from nalasppmta04.qualcomm.com (Global_NAT1.qualcomm.com
 [129.46.96.20])
 by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3tjrt086e7-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT)
 for <freedreno@lists.freedesktop.org>; Fri, 06 Oct 2023 21:52:52 +0000
Received: from nalasex01a.na.qualcomm.com (nalasex01a.na.qualcomm.com
 [10.47.209.196])
 by NALASPPMTA04.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTPS id 396LqpgV010345
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT)
 for <freedreno@lists.freedesktop.org>; Fri, 6 Oct 2023 21:52:51 GMT
Received: from [10.110.44.20] (10.80.80.8) by nalasex01a.na.qualcomm.com
 ...
 2023 14:52:50 -0700
Message-ID: <20126c15-216f-cf5a-0fe0-e6df94a71dfd@quicinc.com>
Date: Fri, 6 Oct 2023 14:52:50 -0700
MIME-Version: 1.0
...
References: <1696628318-15095-1-git-send-email-quic_khsieh@quicinc.com>
 ...
 <69a74260-556c-4e34-8381-82677c335b97@linaro.org>
From: Kuogee Hsieh <quic_khsieh@quicinc.com>
In-Reply-To: <69a74260-556c-4e34-8381-82677c335b97@linaro.org>
...
X-Proofpoint-Virus-Version: vendor=nai engine=6200 definitions=5800
 signatures=585085
X-Proofpoint-GUID: F4WRiBJONJg0BKRmfc5cFr1GUkwEWKV_
X-Proofpoint-ORIG-GUID: F4WRiBJONJg0BKRmfc5cFr1GUkwEWKV_
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0
 ...
 engine=8.12.0-2309180000 definitions=main-2310060168
Subject: Re: [Freedreno] [PATCH v6 5/7] drm/msm/dp: incorporate pm_runtime
...
On 10/6/2023 2:49 PM, Dmitry Baryshkov wrote:
...
>> respectively.
>>
>> Please noted that there are different implementations between 
>> external DP
>> and eDP. For external DP, DP controller and HPD block are initialized 
>> with
>> HPD irq enabled after dp_pm_runtime_resume() and then start waiting 
>> for HPD
>> plugin interrupt. Once HDP plugin interrupt received, 
>> dp_hpd_plugin_handle()
...
>> disabled after dp_pm_runtime_resume() since HPD interrupt is not 
>> required.
>
> Ugh. Your original comment in the email was easier to parse. Can we 
> just have it instead? And I thought that it would be a better fit for 
> the source code comment rather than for the commit message.
>
>>
>> Changes in v6:
>> -- delete dp_power_client_deinit(dp->power);
>> -- remove if (!dp->dp_display.is_edp) condition checkout at 
>> dp_hpd_plug_handle()
>> -- remove if (!dp->dp_display.is_edp) condition checkout at 
>> dp_hpd_unplug_handle()
>> -- add IRQF_NO_AUTOEN to devm_request_irq()
>> -- add enable_irq() and disable_irq() to pm_runtime_resume() and 
>> pm_runtime_suspend()
...
>>   };
>>     enum {
>> @@ -310,10 +309,6 @@ static void dp_display_unbind(struct device 
...
>> @@ -558,7 +553,7 @@ static int dp_hpd_plug_handle(struct 
...
>>           return 0;
>>       }
>> @@ -575,6 +570,12 @@ static int dp_hpd_plug_handle(struct 
>> dp_display_private *dp, u32 data)
>>           return 0;
>>       }
...
>> @@ -657,6 +658,7 @@ static int dp_hpd_unplug_handle(struct 
>> dp_display_private *dp, u32 data)
>>               dp->dp_display.connector_type, state);
...
>>       return 0;
>>   }
>> @@ -672,7 +674,7 @@ static int dp_irq_hpd_handle(struct 
>> dp_display_private *dp, u32 data)
>>       drm_dbg_dp(dp->drm_dev, "Before, type=%d hpd_state=%d\n",
>>               dp->dp_display.connector_type, state);
>>   -    if (state == ST_DISPLAY_OFF || state == ST_SUSPENDED) {
...
>> @@ -1177,7 +1178,9 @@ static int dp_display_request_irq(struct 
...
>>                   dp->irq, rc);
>> @@ -1263,6 +1266,10 @@ static int dp_display_probe(struct 
...
>> @@ -1647,10 +1584,9 @@ void dp_bridge_atomic_post_disable(struct 
...
>>   @@ -1663,6 +1599,8 @@ void dp_bridge_atomic_post_disable(struct 
>> drm_bridge *drm_bridge,
>>       }
...
>>       mutex_unlock(&dp_display->event_mutex);
>>   }
>>   @@ -1702,6 +1640,12 @@ void dp_bridge_hpd_enable(struct drm_bridge 
>> *bridge)
