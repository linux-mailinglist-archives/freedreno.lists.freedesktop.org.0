...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62C906A4B04
	for <lists+freedreno@lfdr.de>; Mon, 27 Feb 2023 20:36:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32AA510E41D;
...
Subject: [Freedreno] [PATCH v7 05/15] dma-buf/sync_file: Add SET_DEADLINE
 ioctl
