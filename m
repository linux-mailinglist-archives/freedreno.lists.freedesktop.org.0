...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F3D549D658
	for <lists+freedreno@lfdr.de>; Thu, 27 Jan 2022 00:46:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B73C310EE0A;
...
Subject: [Freedreno] [PATCH v2] drm/msm/dp: add connector type to enhance
 debug messages
