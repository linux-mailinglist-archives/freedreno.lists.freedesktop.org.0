...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 70065389581
	for <lists+freedreno@lfdr.de>; Wed, 19 May 2021 20:35:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 055756EE52;
...
MIME-Version: 1.0
Subject: [Freedreno] [RFC 2/3] drm/atomic: Call dma_fence_boost() when we've
 missed a vblank
