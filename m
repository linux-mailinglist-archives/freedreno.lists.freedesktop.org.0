...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F69F44DC1A
	for <lists+freedreno@lfdr.de>; Thu, 11 Nov 2021 20:20:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 608806E916;
...
Subject: [Freedreno] [PATCH 2/2] drm/msm: Restore error return on invalid
 fence
