...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D9C276CF6D3
	for <lists+freedreno@lfdr.de>; Thu, 30 Mar 2023 01:19:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAB9A10E295;
...
Subject: [Freedreno] [PATCH RFC 2/5] drm/msm: Add MSM-specific DSC helper
 methods
