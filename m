...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 776E935463C
	for <lists+freedreno@lfdr.de>; Mon,  5 Apr 2021 19:42:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E542B89F1B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 8/8] drm/msm: Support evicting GEM objects to
 swap
