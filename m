...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B52B4765DFB
	for <lists+freedreno@lfdr.de>; Thu, 27 Jul 2023 23:23:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76C6610E605;
...
Subject: [Freedreno] [PATCH v2 08/13] drm/msm/adreno: Bring the a630 family
 together
