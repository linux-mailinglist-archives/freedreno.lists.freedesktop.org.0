...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B25D78D51C
	for <lists+freedreno@lfdr.de>; Wed, 30 Aug 2023 12:31:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8AEF210E4E9;
	Wed, 30 Aug 2023 10:31:40 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v2 3/6] drm/panfrost: Add fdinfo support for
 memory stats
