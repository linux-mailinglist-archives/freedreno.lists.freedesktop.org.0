...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3FFE6532F9
	for <lists+freedreno@lfdr.de>; Wed, 21 Dec 2022 16:10:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7189010E455;
...
Subject: [Freedreno] [PATCH v2 2/4] drm/msm: Fix failure paths in
 msm_drm_init()
...
Cc: Sean Paul <sean@poorly.run>, Akhil P Oommen <quic_akhilpo@quicinc.com>,
 ...
 Rob Clark <robdclark@gmail.com>, Duoming Zhou <duoming@zju.edu.cn>, Daniel
