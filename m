...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48D6578490F
	for <lists+freedreno@lfdr.de>; Tue, 22 Aug 2023 20:02:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A70C10E3D4;
...
Subject: [Freedreno] [PATCH v5 06/11] interconnect: Fix locking for runpm vs
 reclaim
