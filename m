...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E20543044C
	for <lists+freedreno@lfdr.de>; Sat, 16 Oct 2021 20:43:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFD506E4A5;
...
Subject: [Freedreno] [PATCH v2 01/13] gpu/drm: make drm_add_edid_modes()
