...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BE0B425BD0
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:38:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C59DC6F4B2;
	Thu,  7 Oct 2021 19:38:22 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 04/20] drm: cleanup: drm_modeset_lock_all()
