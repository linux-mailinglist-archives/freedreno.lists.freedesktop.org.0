...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E60BC275AEB
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77AC36E8C1;
...
Subject: [Freedreno] [PATCH v3 07/22] drm/imx/dcss: Initialize DRM driver
