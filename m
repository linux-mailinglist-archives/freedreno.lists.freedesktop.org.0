...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3E8169D4B7
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 21:19:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0644110E7A1;
...
Subject: [Freedreno] [PATCH v5 08/14] drm/scheduler: Add fence deadline
 support
