...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11DB0425C17
	for <lists+freedreno@lfdr.de>; Thu,  7 Oct 2021 21:39:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4147F6F4DB;
...
Subject: [Freedreno] [PATCH v3 13/20] drm/i915: cleanup:
