...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6F364B5D2C
	for <lists+freedreno@lfdr.de>; Mon, 14 Feb 2022 22:47:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C30410E2F7;
...
Subject: [Freedreno] [PATCH v2] drm/msm: populate intf_audio_select() base
