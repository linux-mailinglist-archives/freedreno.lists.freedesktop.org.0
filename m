...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 975BE28ABBF
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3EE1E89FF9;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 16/22] drm/msm: Remove obj->gpu
