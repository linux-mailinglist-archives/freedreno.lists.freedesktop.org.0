...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8276513C70C
	for <lists+freedreno@lfdr.de>; Wed, 15 Jan 2020 16:12:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE85A6EAD3;
...
Subject: Re: [Freedreno] [PATCH v2 07/21] drm/i915: Convert to CRTC VBLANK
 callbacks
