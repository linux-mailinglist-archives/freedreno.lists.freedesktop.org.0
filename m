...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 253B9435D8
	for <lists+freedreno@lfdr.de>; Thu, 13 Jun 2019 14:24:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4FF8899B3;
...
Subject: [Freedreno] [PATCH] msm: no need to check return value of
