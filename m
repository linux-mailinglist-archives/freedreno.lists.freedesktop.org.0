...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C60091387FD
	for <lists+freedreno@lfdr.de>; Sun, 12 Jan 2020 20:54:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 560D789EBB;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 0/4] drm/msm: use firmware-name to find zap fw
