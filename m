...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D05317BBC6
	for <lists+freedreno@lfdr.de>; Fri,  6 Mar 2020 12:37:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC9A56E146;
	Fri,  6 Mar 2020 11:37:09 +0000 (UTC)
...
Subject: [Freedreno] [v1] dt-bindings: msm: disp: add yaml schemas for DPU
 and DSI bindings
