...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1ACF43A1296
	for <lists+freedreno@lfdr.de>; Wed,  9 Jun 2021 13:25:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A90A66E969;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 5/9] drm/qxl: Remove empty qxl_gem_prime_mmap()
