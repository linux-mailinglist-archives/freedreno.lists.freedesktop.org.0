...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC18351E197
	for <lists+freedreno@lfdr.de>; Sat,  7 May 2022 00:25:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 53D9A10E43B;
...
Subject: Re: [Freedreno] [PATCH 11/25] drm/msm/dpu: use dpu_sw_pipe for
