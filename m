...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C3B7D62F456
	for <lists+freedreno@lfdr.de>; Fri, 18 Nov 2022 13:17:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EC9710E70D;
...
Subject: [Freedreno] [PATCH v3 1/3] drm/msm/disp/dpu1: pin 1 crtc to 1
 encoder
