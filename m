...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D770722E190
	for <lists+freedreno@lfdr.de>; Sun, 26 Jul 2020 19:09:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E86189F61;
...
Subject: Re: [Freedreno] [PATCH v10 08/13] drm/msm: Add a context pointer to
 the submitqueue
