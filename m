...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EF446EFD6F
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 00:38:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCB1810EA79;
...
X-Mailer: b4 0.12.2
Subject: [Freedreno] [PATCH v4 19/22] drm/msm/dpu: Add TEAR-READ-pointer
