...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E1779AEEE
	for <lists+freedreno@lfdr.de>; Fri, 23 Aug 2019 14:17:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA01F6EC85;
...
Subject: [Freedreno] [PATCH v7 4/7] firmware: qcom: scm: add support to
