...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DFAA278BBD6
	for <lists+freedreno@lfdr.de>; Tue, 29 Aug 2023 02:06:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A472810E38C;
...
Subject: [Freedreno] [PATCH RFC v6 06/10] drm/atomic: Move framebuffer
 checks to helper
