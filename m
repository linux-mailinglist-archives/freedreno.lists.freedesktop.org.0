...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83C0B7B0DB4
	for <lists+freedreno@lfdr.de>; Wed, 27 Sep 2023 22:54:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 16B3010E5B5;
	Wed, 27 Sep 2023 20:54:29 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v4 3/8] drm/msm/dp: use drm_bridge_hpd_notify()
