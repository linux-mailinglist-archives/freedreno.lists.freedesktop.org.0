...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 894CD26D4DF
	for <lists+freedreno@lfdr.de>; Thu, 17 Sep 2020 09:40:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F5C66EADF;
...
Subject: Re: [Freedreno] [PATCH v2 01/21] drm/amdgpu: Introduce GEM object
 functions
...
Content-Type: multipart/mixed; boundary="===============0141567987=="
