...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4397664FAE
	for <lists+freedreno@lfdr.de>; Wed, 11 Jan 2023 00:14:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A493410E68E;
	Tue, 10 Jan 2023 23:14:46 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 0/3] drm/msm/gpu: Devfreq fixes+tuning
