...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 898F8707550
	for <lists+freedreno@lfdr.de>; Thu, 18 May 2023 00:27:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A71510E2BE;
...
Subject: [Freedreno] [PATCH v12 2/9] drm/display/dsc: add helper to set
