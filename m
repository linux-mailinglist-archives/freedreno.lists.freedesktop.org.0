...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7958F643163
	for <lists+freedreno@lfdr.de>; Mon,  5 Dec 2022 20:15:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9104210E137;
...
Subject: [Freedreno] [PATCH v8 2/5] dt-bindings: msm/dp: add data-lanes and
