...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B4D16F3611
	for <lists+freedreno@lfdr.de>; Mon,  1 May 2023 20:45:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E56D10E356;
...
Subject: [Freedreno] [PATCH v3 7/9] drm/doc: Relax fdinfo string constraints
