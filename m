...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E93B6A8D8A
	for <lists+freedreno@lfdr.de>; Fri,  3 Mar 2023 00:54:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 633F410E5AC;
...
Subject: [Freedreno] [PATCH v9 12/15] drm/msm: Add deadline based boost
 support
