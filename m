...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D95D174A4D5
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 22:28:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2229D10E4AC;
...
Subject: [Freedreno] [PATCH v3 6/6] drm/msm/dpu: Update dev core dump to
