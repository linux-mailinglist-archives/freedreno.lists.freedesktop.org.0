...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD43D801391
	for <lists+freedreno@lfdr.de>; Fri,  1 Dec 2023 20:29:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75D2710E158;
...
Subject: Re: [Freedreno] [PATCH v3 13/13] drm/msm/dpu: use drmm-managed
