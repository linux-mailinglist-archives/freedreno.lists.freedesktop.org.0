...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5ACB6472708
	for <lists+freedreno@lfdr.de>; Mon, 13 Dec 2021 10:59:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0030710E62C;
...
Subject: Re: [Freedreno] [Intel-gfx] [PATCH 2/3] drm/dp: Move DP
 declarations into separate header file
