...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96411707560
	for <lists+freedreno@lfdr.de>; Thu, 18 May 2023 00:27:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5169C10E4A5;
...
Subject: [Freedreno] [PATCH v12 5/9] drm/msm: Add MSM-specific DSC helper
 methods
