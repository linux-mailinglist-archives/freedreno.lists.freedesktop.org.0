...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F7537FDEAB
	for <lists+freedreno@lfdr.de>; Wed, 29 Nov 2023 18:47:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CFB110E649;
...
Subject: [Freedreno] [PATCH v8 1/7] drm/msm/dp: tie dp_display_irq_handler()
 with dp driver
