...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DED1437AFF
	for <lists+freedreno@lfdr.de>; Fri, 22 Oct 2021 18:35:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 498916E7D1;
...
Subject: [Freedreno] [PATCH] drm/msm/a5xx: Add support for Adreno 506 GPU
