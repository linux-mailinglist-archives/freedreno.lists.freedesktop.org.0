...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD20661821F
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:17:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5338810E6BA;
...
Subject: [Freedreno] [PATCH v3 19/23] drm/fb-helper: Always initialize
