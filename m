...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D52D5586F3A
	for <lists+freedreno@lfdr.de>; Mon,  1 Aug 2022 19:05:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2731A14B0E6;
	Mon,  1 Aug 2022 17:04:45 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 1/3] dma-buf: Add ioctl to query mmap info
