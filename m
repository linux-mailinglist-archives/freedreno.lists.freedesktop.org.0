...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C820155AD0A
	for <lists+freedreno@lfdr.de>; Sun, 26 Jun 2022 00:55:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 344C710E312;
...
Subject: [Freedreno] [PATCH 01/15] drm/msm: Switch to pfn mappings
