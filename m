...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD24770FCFE
	for <lists+freedreno@lfdr.de>; Wed, 24 May 2023 19:46:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CEAF10E5B0;
...
Subject: [Freedreno] [PATCH v14 4/9] drm/msm/dsi: use DRM DSC helpers for
 DSC setup
