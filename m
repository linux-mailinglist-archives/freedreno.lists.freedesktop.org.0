...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DCB971F00A
	for <lists+freedreno@lfdr.de>; Thu,  1 Jun 2023 19:00:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFFF310E59A;
...
Subject: [Freedreno] [PATCH v3 1/7] dt-bindings: msm: dsi-phy-28nm: Document
 msm8226 compatible
