...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38A1E3A12AE
	for <lists+freedreno@lfdr.de>; Wed,  9 Jun 2021 13:26:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E01DD6E978;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 9/9] drm: Update documentation and TODO of
 gem_prime_mmap hook
