...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 479257431A8
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC76610E434;
...
Subject: [Freedreno] [PATCH RFC v4 4/7] drm/atomic: Loosen FB atomic checks
