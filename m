...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6B8860D9D7
	for <lists+freedreno@lfdr.de>; Wed, 26 Oct 2022 05:27:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE25B10E42A;
...
Subject: [Freedreno] [PATCH v3 10/12] arm64: dts: qcom: sc8280xp: Define
