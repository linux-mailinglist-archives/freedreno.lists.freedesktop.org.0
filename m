...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7564B4E71F2
	for <lists+freedreno@lfdr.de>; Fri, 25 Mar 2022 12:07:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D31C10EB66;
	Fri, 25 Mar 2022 11:07:04 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v5 12/13] drm/msm/dsi: add mode valid callback
 for dsi_mgr
