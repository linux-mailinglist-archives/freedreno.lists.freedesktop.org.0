...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 395AA3E15FF
	for <lists+freedreno@lfdr.de>; Thu,  5 Aug 2021 15:49:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A03476EA6D;
...
Subject: Re: [Freedreno] [PATCH v5 05/20] drm/sched: drop entity parameter
