...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D5C8587F74
	for <lists+freedreno@lfdr.de>; Tue,  2 Aug 2022 17:52:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A121C90638;
...
Subject: [Freedreno] [PATCH v4 11/15] drm/msm/gem: Unpin buffers earlier
