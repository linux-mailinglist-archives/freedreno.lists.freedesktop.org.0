...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51ACB4DA60E
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 00:12:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86DF889E9B;
...
Subject: [Freedreno] [PATCH v2 1/6] drm: allow real encoder to be passed for
