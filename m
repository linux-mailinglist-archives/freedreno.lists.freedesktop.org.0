...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D5836F0B81
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 19:54:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 04A7110E316;
...
Subject: [Freedreno] [PATCH v2 2/9] drm: Add common fdinfo helper
