...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4D04678494
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:24:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 853FE10E530;
...
Subject: [Freedreno] [PATCH v1 01/14] drm/msm/dp: add dpcd read of both dsc
 and fec capability
