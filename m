...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA5E728ABC5
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 661846E216;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 19/22] drm/msm: remove msm_gem_free_work
