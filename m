...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D45069D4CD
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 21:20:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03C7510E78F;
...
Subject: [Freedreno] [PATCH v5 14/14] drm/i915: Add deadline based boost
 support
