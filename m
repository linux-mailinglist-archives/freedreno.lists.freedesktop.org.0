...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 789F6374D11
	for <lists+freedreno@lfdr.de>; Thu,  6 May 2021 03:50:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D7546EC90;
...
Subject: Re: [Freedreno] [PATCH v1 2/3] drm/msm/edp: add support for next
 gen edp
