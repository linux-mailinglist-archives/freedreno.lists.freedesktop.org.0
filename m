...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6473E50D264
	for <lists+freedreno@lfdr.de>; Sun, 24 Apr 2022 16:47:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C34C10EB49;
...
Subject: Re: [Freedreno] [PATCH v4 02/20] drm: introduce
