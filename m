...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7F7968143E
	for <lists+freedreno@lfdr.de>; Mon, 30 Jan 2023 16:12:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4422C10E275;
...
Subject: [Freedreno] [PATCH v12 03/14] drm/msm/disp/dpu: wait for extra
