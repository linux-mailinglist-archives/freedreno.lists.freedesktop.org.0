...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BBAA6D7187
	for <lists+freedreno@lfdr.de>; Wed,  5 Apr 2023 02:42:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81F6F10E80F;
...
Subject: [Freedreno] [PATCH v4 3/6] drm/msm/dpu: Fix slice_last_group_size
 calculation
