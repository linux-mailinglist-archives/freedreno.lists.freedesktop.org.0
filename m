...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A95D8416C25
	for <lists+freedreno@lfdr.de>; Fri, 24 Sep 2021 08:51:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98E4E6EDF6;
...
Subject: [Freedreno] [PATCH v2 16/17] drm: cleanup: remove
