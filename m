...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 547FF3951D1
	for <lists+freedreno@lfdr.de>; Sun, 30 May 2021 17:57:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7C176E140;
...
Subject: [Freedreno] [v5 5/5] drm/panel-simple: Add Samsung ATNA33XC20
