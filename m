...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D1E4259A0D
	for <lists+freedreno@lfdr.de>; Tue,  1 Sep 2020 18:46:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D9CE6E880;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v16 06/20] drm/msm: Drop context arg to
 gpu->submit()
