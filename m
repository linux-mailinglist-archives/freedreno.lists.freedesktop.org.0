...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD33E47EFF8
	for <lists+freedreno@lfdr.de>; Fri, 24 Dec 2021 17:03:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69C4910E477;
...
Subject: [Freedreno] [PATCH v5 3/4] arm64: dts: qcom: sc7280: add edp
 display dt nodes
