...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B44CF7431A3
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4420110E429;
...
Subject: [Freedreno] [PATCH RFC v4 5/7] drm/msm/dpu: Add solid fill and
