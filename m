...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00ED853FCE8
	for <lists+freedreno@lfdr.de>; Tue,  7 Jun 2022 13:08:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A003F10E08A;
...
Subject: [Freedreno] [PATCH] drm/msm/mdp4: Fix refcount leak in
