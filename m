...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D48D2EAF7D
	for <lists+freedreno@lfdr.de>; Tue,  5 Jan 2021 16:56:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE5D46E1EC;
...
Subject: Re: [Freedreno] [PATCH 29/31] PM / devfreq: imx-bus: convert to use
 devm_pm_opp_* API
