...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3F9C28BEA
	for <lists+freedreno@lfdr.de>; Thu, 23 May 2019 22:53:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5D306E075;
	Thu, 23 May 2019 20:53:07 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v2 6/6] drm/msm/a6xx: Rename a6xx_gmu_probe
 to a6xx_gmu_init
