...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3B3350B3AB
	for <lists+freedreno@lfdr.de>; Fri, 22 Apr 2022 11:11:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51B1210F562;
...
Subject: [Freedreno] [PATCH v9 4/4] drm/msm/dp: Support the eDP modes given
 by panel
