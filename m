...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 426A6585978
	for <lists+freedreno@lfdr.de>; Sat, 30 Jul 2022 11:18:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D077B10FB3D;
...
Subject: [Freedreno] [PATCH 1/5] dt-bindings: clk: qcom: Support gpu cx gdsc
 reset
