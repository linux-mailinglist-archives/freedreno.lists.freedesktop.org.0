...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6093774A599
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 23:11:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6462310E4C9;
...
Subject: [Freedreno] [PATCH 05/12] drm/msm/adreno: Use quirk to identify
