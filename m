...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBB5B7BC28A
	for <lists+freedreno@lfdr.de>; Sat,  7 Oct 2023 00:55:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C5E710E578;
...
Subject: [Freedreno] [PATCH v7 0/7] incorporate pm runtime framework and eDP
 clean up
