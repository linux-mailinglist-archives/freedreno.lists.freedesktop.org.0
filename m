...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D13E6E020A
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 00:43:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF8FE10E9E5;
...
Subject: [Freedreno] [PATCH v4 4/6] drm/i915: Switch to fdinfo helper
