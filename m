...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0245F7DA373
	for <lists+freedreno@lfdr.de>; Sat, 28 Oct 2023 00:34:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09BD810EA62;
...
Subject: [Freedreno] [PATCH RFC v7 09/10] drm/msm/dpu: Use DRM solid_fill
 property
