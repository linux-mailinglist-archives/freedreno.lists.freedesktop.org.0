...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C734E70C654
	for <lists+freedreno@lfdr.de>; Mon, 22 May 2023 21:17:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C3F910E245;
...
Subject: [Freedreno] [PATCH] drm/msm: Use struct fb_info.screen_buffer
