...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A4FB7F059F
	for <lists+freedreno@lfdr.de>; Sun, 19 Nov 2023 12:28:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A32A10E1CC;
...
Subject: [Freedreno] [PATCH v3 RESEND 00/20] remove I2C_CLASS_DDC support
