...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B2BB7B851E
	for <lists+freedreno@lfdr.de>; Wed,  4 Oct 2023 18:27:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7A9410E390;
...
Subject: [Freedreno] [PATCH v5 1/7] drm/msm/dp: tie dp_display_irq_handler()
 with dp driver
