...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B71E4E3503
	for <lists+freedreno@lfdr.de>; Tue, 22 Mar 2022 00:57:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3F0510E4DF;
...
Subject: [Freedreno] [PATCH v5 4/4] drm: allow real encoder to be passed for
