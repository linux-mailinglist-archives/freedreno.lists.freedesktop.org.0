...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6B9973732F
	for <lists+freedreno@lfdr.de>; Tue, 20 Jun 2023 19:49:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8456310E24B;
...
Subject: [Freedreno] [PATCH v2 2/4] drm/msm/a3xx: Pass the revision
 information
