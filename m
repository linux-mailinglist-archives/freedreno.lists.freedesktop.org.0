...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 504935A0196
	for <lists+freedreno@lfdr.de>; Wed, 24 Aug 2022 20:50:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F06BC1CF8;
...
Subject: [Freedreno] [PATCH v2 2/5] clk: qcom: Allow custom reset ops
