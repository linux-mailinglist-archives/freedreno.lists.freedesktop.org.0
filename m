...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E333E40B635
	for <lists+freedreno@lfdr.de>; Tue, 14 Sep 2021 19:48:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48B9C6E520;
...
Subject: [Freedreno] [PATCH] drm/msm: Do not run snapshot on non-DPU devices
