...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 51BE36FE6EC
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:08:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AA4510E569;
...
Subject: [Freedreno] [PATCH v6 8/8] drm/msm/dpu: tear down DSC data path
 when DSC disabled
