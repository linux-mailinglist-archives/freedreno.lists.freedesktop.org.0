...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE6A66CFD0D
	for <lists+freedreno@lfdr.de>; Thu, 30 Mar 2023 09:41:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E17310ED19;
...
Subject: [Freedreno] [PATCH 1/6] drm/msm: Clear aperture ownership outside
 of fbdev code
