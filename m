...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EDDB6943FC
	for <lists+freedreno@lfdr.de>; Mon, 13 Feb 2023 12:11:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 177BC10E555;
...
Subject: [Freedreno] [PATCH v4 3/4] drm/msm/dpu: avoid unnecessary check in
 DPU reservations
