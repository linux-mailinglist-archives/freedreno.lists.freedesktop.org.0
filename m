...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D45CA57A4E6
	for <lists+freedreno@lfdr.de>; Tue, 19 Jul 2022 19:19:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6ED2C90FE9;
	Tue, 19 Jul 2022 17:19:08 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 10/13] drm/msm/gem: Convert to using
 drm_gem_lru
