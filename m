...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6DD3806160
	for <lists+freedreno@lfdr.de>; Tue,  5 Dec 2023 23:06:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 894E410E63D;
...
Subject: [Freedreno] [PATCH 3/5] drm/msm/adreno: Move hwcg regs to a6xx hw
 catalog
