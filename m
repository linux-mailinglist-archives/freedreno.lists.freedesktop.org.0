...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 07DC84DD284
	for <lists+freedreno@lfdr.de>; Fri, 18 Mar 2022 02:46:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 497D210E90F;
...
Subject: [Freedreno] [PATCH v4 1/4] drm: allow passing possible_crtcs to
