...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B6F42438C8
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 12:42:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29DCE6E9AB;
...
Subject: Re: [Freedreno] [PATCH 12/20] drm/radeon: Introduce GEM object
 functions
...
Content-Type: multipart/mixed; boundary="===============0313411273=="
