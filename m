...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 761FDFC767
	for <lists+freedreno@lfdr.de>; Thu, 14 Nov 2019 14:28:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19E256E959;
...
Subject: [Freedreno] [PATCH v1 2/2] drm/msm: add DSI config changes to
 support DSI version
