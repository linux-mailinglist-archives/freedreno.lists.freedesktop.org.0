...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EC7F6B0DA3
	for <lists+freedreno@lfdr.de>; Wed,  8 Mar 2023 16:54:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 922FB10E62E;
...
Subject: [Freedreno] [PATCH v10 13/15] drm/msm: Add wait-boost support
