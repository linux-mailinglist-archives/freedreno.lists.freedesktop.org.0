...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0F4B3DE95D
	for <lists+freedreno@lfdr.de>; Tue,  3 Aug 2021 11:07:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D9C76E5A0;
...
Subject: [Freedreno] [PATCH v2 08/14] drm/mxsfb: Convert to Linux IRQ
 interfaces
