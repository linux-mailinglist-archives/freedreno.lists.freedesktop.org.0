...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A2A06B8951
	for <lists+freedreno@lfdr.de>; Tue, 14 Mar 2023 05:11:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 11DE510E091;
...
Subject: Re: [Freedreno] [PATCH v5 20/32] drm/msm/dpu: add dpu_hw_sspp_cfg
 to dpu_plane_state
