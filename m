...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FF064DBBBD
	for <lists+freedreno@lfdr.de>; Thu, 17 Mar 2022 01:29:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D2C710EAC4;
...
Subject: [Freedreno] [PATCH 1/3] drm/msm: Add support for pointer params
