...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D47A6C152D
	for <lists+freedreno@lfdr.de>; Mon, 20 Mar 2023 15:45:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA4FC10E21D;
...
Subject: [Freedreno] [PATCH v2 14/23] drm/msm/a6xx: Move ioremap out of
 hw_init path
