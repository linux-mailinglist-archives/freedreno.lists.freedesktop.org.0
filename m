...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1697F6FD227
	for <lists+freedreno@lfdr.de>; Wed, 10 May 2023 00:07:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B31D10E3EF;
...
Subject: [Freedreno] [PATCH v7 2/8] drm/display/dsc: add helper to set
