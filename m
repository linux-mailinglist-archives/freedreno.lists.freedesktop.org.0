...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A0D7597CE7
	for <lists+freedreno@lfdr.de>; Thu, 18 Aug 2022 06:18:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 165E4AFFB7;
...
Subject: [Freedreno] [PATCH v4 5/7] drm/msm/a6xx: Ensure CX collapse during
 gpu recovery
