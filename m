...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F00D82974F1
	for <lists+freedreno@lfdr.de>; Fri, 23 Oct 2020 18:50:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D3DF6F8ED;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 05/23] drm/msm/gem: Add some _locked() helpers
