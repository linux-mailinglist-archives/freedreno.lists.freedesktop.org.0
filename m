...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32D1374A593
	for <lists+freedreno@lfdr.de>; Thu,  6 Jul 2023 23:11:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14B0410E4B3;
...
Subject: [Freedreno] [PATCH 02/12] drm/msm/adreno: Remove redundant gmem
 size param
