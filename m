...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DD3F79448B
	for <lists+freedreno@lfdr.de>; Wed,  6 Sep 2023 22:30:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 44E9810E716;
...
Subject: Re: [Freedreno] [PATCH v3 3/5] drm/msm: add trailing newlines to
 drm_dbg msgs
