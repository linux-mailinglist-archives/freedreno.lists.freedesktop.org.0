...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84FFD434ED9
	for <lists+freedreno@lfdr.de>; Wed, 20 Oct 2021 17:17:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 809956E9DC;
...
Subject: [Freedreno] [PATCH v2 0/2] Add support for eDP on SC7280
