...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E44A0176AC1
	for <lists+freedreno@lfdr.de>; Tue,  3 Mar 2020 03:46:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 402856E92F;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.5 13/66] drm: msm: Fix return type of
