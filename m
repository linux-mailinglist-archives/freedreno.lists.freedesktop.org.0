...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 55736598DBD
	for <lists+freedreno@lfdr.de>; Thu, 18 Aug 2022 22:22:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A42DA10EE76;
...
Subject: [Freedreno] [PATCH v5 0/7] Improve GPU Recovery
