...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C88380177E
	for <lists+freedreno@lfdr.de>; Sat,  2 Dec 2023 00:21:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4788810E97E;
...
Subject: [Freedreno] [PATCH v9 4/7] drm/msm/dp: move parser->parse() and
