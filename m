...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18548275AEE
	for <lists+freedreno@lfdr.de>; Wed, 23 Sep 2020 16:59:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9DAB26E981;
...
Subject: [Freedreno] [PATCH v3 09/22] drm/msm: Introduce GEM object funcs
