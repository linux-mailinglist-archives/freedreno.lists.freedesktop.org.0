...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FD9F7DA369
	for <lists+freedreno@lfdr.de>; Sat, 28 Oct 2023 00:34:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 88DC010EA5C;
...
Subject: [Freedreno] [PATCH RFC v7 06/10] drm/atomic: Move framebuffer
 checks to helper
