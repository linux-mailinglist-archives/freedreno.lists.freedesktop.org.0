...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E00F7D9E51
	for <lists+freedreno@lfdr.de>; Fri, 27 Oct 2023 18:59:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7681510EA1A;
...
Subject: [Freedreno] [PATCH 4/7] drm/msm/gem: Split out
