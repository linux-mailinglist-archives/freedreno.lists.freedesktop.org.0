...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A9B6A142EDF
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 16:38:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B8796E9C3;
...
Subject: Re: [Freedreno] [Intel-gfx] [PATCH v3 03/22] drm: Add
