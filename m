...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C60AF68A44C
	for <lists+freedreno@lfdr.de>; Fri,  3 Feb 2023 22:10:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF9B010E8E6;
	Fri,  3 Feb 2023 21:10:53 +0000 (UTC)
...
Subject: [Freedreno] [PATCH] firmware: qcom_scm: Move qcom_scm.h to
