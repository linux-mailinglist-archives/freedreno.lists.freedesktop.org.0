...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 708AD25E9FA
	for <lists+freedreno@lfdr.de>; Sat,  5 Sep 2020 22:04:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E960D6E265;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v17 05/20] drm/msm: Add a context pointer to the
 submitqueue
