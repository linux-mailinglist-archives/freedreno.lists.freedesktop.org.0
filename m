...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A087C28ABB7
	for <lists+freedreno@lfdr.de>; Mon, 12 Oct 2020 04:09:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F270E6E22B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 12/22] drm/msm: Add priv->mm_lock to protect
