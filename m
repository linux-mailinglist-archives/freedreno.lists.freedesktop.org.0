...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6OvXMGNpg2kbmgMAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Wed, 04 Feb 2026 16:44:35 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46617E9420
	for <lists+freedreno@lfdr.de>; Wed, 04 Feb 2026 16:44:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8510310E699;
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[vkoul@kernel.org,freedreno-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];
