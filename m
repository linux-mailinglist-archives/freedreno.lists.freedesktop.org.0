...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BE7CD38C70E
	for <lists+freedreno@lfdr.de>; Fri, 21 May 2021 14:51:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B1B06F637;
...
MIME-Version: 1.0
Subject: [Freedreno] [RFC PATCH 12/13] drm/msm/dsi: Add support for DSC
 configuration
