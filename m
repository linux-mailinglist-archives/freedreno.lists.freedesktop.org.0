...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49049767A69
	for <lists+freedreno@lfdr.de>; Sat, 29 Jul 2023 02:55:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E34B10E0A8;
...
Subject: Re: [Freedreno] [PATCH v2 10/13] drm/msm/dpu: use drmm-managed
