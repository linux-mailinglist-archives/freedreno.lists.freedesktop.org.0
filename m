...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DDF4697037
	for <lists+freedreno@lfdr.de>; Tue, 14 Feb 2023 22:58:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AECEA10E9B6;
...
Subject: Re: [Freedreno] [PATCH v2 00/14] GMU-less A6xx support (A610,
 A619_holi)
