...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28ED34F5A29
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A50FC10F2BA;
...
Subject: [Freedreno] [PATCH v7 05/14] drm/msm/disp/dpu1: Add DSC for SDM845
 to hw_catalog
