...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F1B0371668E
	for <lists+freedreno@lfdr.de>; Tue, 30 May 2023 17:13:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 346AE10E3D4;
...
Subject: [Freedreno] [PATCH v5 02/13] fbdev: Add initializer macros for
 struct fb_ops
