...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A126070BD82
	for <lists+freedreno@lfdr.de>; Mon, 22 May 2023 14:21:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57DF810E30C;
...
Subject: [Freedreno] [PATCH v3 01/12] fbdev: Add Kconfig options to select
