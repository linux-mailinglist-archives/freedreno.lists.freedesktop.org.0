...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0927752EE4
	for <lists+freedreno@lfdr.de>; Fri, 14 Jul 2023 03:48:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7635910E7C0;
	Fri, 14 Jul 2023 01:48:30 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v3 0/3] Fix IS_ERR() vs NULL check for drm
