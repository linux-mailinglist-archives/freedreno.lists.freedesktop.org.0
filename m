...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80DBD57A4E1
	for <lists+freedreno@lfdr.de>; Tue, 19 Jul 2022 19:18:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32F3E90FB3;
...
Subject: [Freedreno] [PATCH v2 06/13] drm/msm/gem: Rename to pin/unpin_pages
