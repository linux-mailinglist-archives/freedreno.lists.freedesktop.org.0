...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 52D7513BFD8
	for <lists+freedreno@lfdr.de>; Wed, 15 Jan 2020 13:17:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E41A6E93B;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 03/21] drm: Add get_vblank_timestamp() to
