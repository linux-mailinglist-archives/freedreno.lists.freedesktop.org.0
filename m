...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45C862E854C
	for <lists+freedreno@lfdr.de>; Fri,  1 Jan 2021 19:55:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 948A18934B;
...
Subject: [Freedreno] [PATCH 12/31] mmc: sdhci-msm: convert to use
 devm_pm_opp_* API
