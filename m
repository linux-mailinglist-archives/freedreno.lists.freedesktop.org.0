...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32726507723
	for <lists+freedreno@lfdr.de>; Tue, 19 Apr 2022 20:11:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C66610E805;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.17 02/34] drm/msm/gpu: Remove mutex
 from wait_event condition
...
Cc: Rob Clark <robdclark@chromium.org>, Sasha Levin <sashal@kernel.org>,
 ...
 sean@poorly.run, angelogioacchino.delregno@collabora.com
