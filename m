...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AF775B7271
	for <lists+freedreno@lfdr.de>; Tue, 13 Sep 2022 16:56:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2E5C10E750;
...
Subject: [Freedreno] [PATCH v7 14/15] drm/msm/disp/dpu: reset the datapath
