...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F1457475D0
	for <lists+freedreno@lfdr.de>; Tue,  4 Jul 2023 18:00:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB9A510E2DA;
...
Subject: Re: [Freedreno] [PATCH v2 14/14] drm/msm/dpu: drop
