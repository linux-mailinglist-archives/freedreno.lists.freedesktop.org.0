...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sDUrJhEbr2n2NwIAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:10:09 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CF8623F3C6
	for <lists+freedreno@lfdr.de>; Mon, 09 Mar 2026 20:10:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 05B8D10E5C7;
	Mon,  9 Mar 2026 19:10:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=nxp.com header.i=@nxp.com header.b="Z9DNt9VH";
	dkim-atps=neutral
X-Original-To: freedreno@lists.freedesktop.org
Delivered-To: freedreno@lists.freedesktop.org
Received: from DB3PR0202CU003.outbound.protection.outlook.com
 (mail-northeuropeazon11010052.outbound.protection.outlook.com [52.101.84.52])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A74C210E591;
...
Subject: [PATCH v3 phy-next 17/24] media: sunxi: a83-mips-csi2: include PHY
 provider header
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?ykxWCLEO9F2vzzu9HsgiDnKsV3zcu/QDAk8G68SVNomdIXZdTKSe0OclNIFK?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Mar 2026 19:10:03.6511 (UTC)
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[bootlin.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,nxp.com:dkim,nxp.com:email,nxp.com:mid,sholland.org:email]
