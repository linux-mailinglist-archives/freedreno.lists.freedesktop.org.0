...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87CFB5B285D
	for <lists+freedreno@lfdr.de>; Thu,  8 Sep 2022 23:19:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3369310E6D8;
	Thu,  8 Sep 2022 21:19:07 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v4 2/2] drm/msm/dp: retry 3 times if set sink to
