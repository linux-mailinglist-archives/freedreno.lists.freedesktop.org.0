...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 967626E0B81
	for <lists+freedreno@lfdr.de>; Thu, 13 Apr 2023 12:37:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9BD210EAB9;
...
Subject: Re: [Freedreno] [PATCH v4 3/6] drm/amdgpu: Switch to fdinfo helper
