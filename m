...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48DFCBA2DD
	for <lists+freedreno@lfdr.de>; Sun, 22 Sep 2019 16:15:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED4B06E831;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 N4yA==
Subject: [Freedreno] [PATCH 2/5] drm/msm/mdp5: Add configuration for msm8x56
