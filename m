...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EB6752BFCD
	for <lists+freedreno@lfdr.de>; Wed, 18 May 2022 18:43:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 103DC1134B2;
...
Subject: [Freedreno] [PATCH v2 1/2] phy/qcom: add regulator_set_load to
 edp/dp phy
