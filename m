...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5260067BBDE
	for <lists+freedreno@lfdr.de>; Wed, 25 Jan 2023 21:04:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 250E510E863;
...
Subject: [Freedreno] [PATCH v3 05/10] drm/fb-helper: Remove preferred_bpp
