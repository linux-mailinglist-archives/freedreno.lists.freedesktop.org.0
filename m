...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20EA16D44B8
	for <lists+freedreno@lfdr.de>; Mon,  3 Apr 2023 14:45:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83AB010E47F;
...
Subject: [Freedreno] [PATCH v2 5/8] drm/msm: Remove fbdev from struct
 msm_drm_private
