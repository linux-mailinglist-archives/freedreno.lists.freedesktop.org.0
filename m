...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0C006F0B88
	for <lists+freedreno@lfdr.de>; Thu, 27 Apr 2023 19:54:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E31A10EBA7;
...
Subject: [Freedreno] [PATCH v2 6/9] drm/msm: Add memory stats to fdinfo
