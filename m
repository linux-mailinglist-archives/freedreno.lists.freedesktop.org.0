...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F165F6DE61E
	for <lists+freedreno@lfdr.de>; Tue, 11 Apr 2023 23:05:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C8E310E675;
	Tue, 11 Apr 2023 21:05:15 +0000 (UTC)
...
Subject: [Freedreno] [PATCH] drm/msm/dpu: always program dsc active bits
