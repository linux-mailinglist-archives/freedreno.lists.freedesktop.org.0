...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B82B146A44
	for <lists+freedreno@lfdr.de>; Thu, 23 Jan 2020 15:00:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7762A6FD05;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 00/22] drm: Clean up VBLANK callbacks in
 struct drm_driver
