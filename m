...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0CF84FC6FF
	for <lists+freedreno@lfdr.de>; Mon, 11 Apr 2022 23:58:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48A5310E14C;
...
Subject: [Freedreno] [PATCH v4 03/10] drm/msm/gem: Convert some missed
 GEM_WARN_ON()s
