...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F82078D523
	for <lists+freedreno@lfdr.de>; Wed, 30 Aug 2023 12:35:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A476C10E11A;
	Wed, 30 Aug 2023 10:35:21 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v2 1/6] drm/panfrost: Add cycle count GPU
