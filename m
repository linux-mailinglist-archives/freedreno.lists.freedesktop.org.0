...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 029113926BD
	for <lists+freedreno@lfdr.de>; Thu, 27 May 2021 07:08:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95CEF6E48C;
...
Subject: [Freedreno] [v1] drm/msm/disp/dpu1: avoid perf update in frame done
 event
