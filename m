...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 314497BEF28
	for <lists+freedreno@lfdr.de>; Tue, 10 Oct 2023 01:34:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB1B110E1B6;
...
Subject: [Freedreno] [PATCH v3 1/6] dt-bindings: display/msm:
