...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F0F524369A
	for <lists+freedreno@lfdr.de>; Thu, 13 Aug 2020 10:37:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 250E76E9C0;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH 15/20] drm/vc4: Introduce GEM object functions
