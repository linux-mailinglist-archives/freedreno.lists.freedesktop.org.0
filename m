...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE2EDFCB9A
	for <lists+freedreno@lfdr.de>; Thu, 14 Nov 2019 18:15:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9988D6EE13;
...
Subject: Re: [Freedreno] [PATCH v1 0/2] Add suppport for rm69299 Visionox
 panel driver and add DSI config to support DSI version
