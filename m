...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75C5B6FE773
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:46:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB96E10E56A;
...
Subject: [Freedreno] [PATCH v8 1/8] drm/display/dsc: Add flatness and
