...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9424870BD91
	for <lists+freedreno@lfdr.de>; Mon, 22 May 2023 14:22:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48B3E10E31B;
...
Subject: [Freedreno] [PATCH v3 06/12] drm/fbdev-dma: Use regular fbdev I/O
 helpers
