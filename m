...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3FDE74319B
	for <lists+freedreno@lfdr.de>; Fri, 30 Jun 2023 02:26:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B48F110E422;
	Fri, 30 Jun 2023 00:26:01 +0000 (UTC)
...
Subject: [Freedreno] [PATCH RFC v4 6/7] drm/msm/dpu: Allow NULL FBs in
 atomic commit
