...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 641846814CC
	for <lists+freedreno@lfdr.de>; Mon, 30 Jan 2023 16:21:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A96BC89C46;
...
Subject: [Freedreno] [v1 2/3] drm/msm/disp/dpu1: add dspps into reservation
 if there is a ctm request
