...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDF7057A4E8
	for <lists+freedreno@lfdr.de>; Tue, 19 Jul 2022 19:19:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8636191029;
...
Subject: [Freedreno] [PATCH v2 09/13] drm/gem: Add LRU/shrinker helper
