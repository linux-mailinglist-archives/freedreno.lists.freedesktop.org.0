...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B899681447
	for <lists+freedreno@lfdr.de>; Mon, 30 Jan 2023 16:12:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D088A10E278;
	Mon, 30 Jan 2023 15:12:26 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v12 05/14] drm: add helper functions to retrieve
 old and new crtc
