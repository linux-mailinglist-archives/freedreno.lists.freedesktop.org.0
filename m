...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 113087F1F69
	for <lists+freedreno@lfdr.de>; Mon, 20 Nov 2023 22:46:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0F6A10E1B9;
...
Subject: [Freedreno] [PATCH v4 00/20] remove I2C_CLASS_DDC support
