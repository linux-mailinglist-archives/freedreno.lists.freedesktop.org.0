...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B31C6520F26
	for <lists+freedreno@lfdr.de>; Tue, 10 May 2022 09:53:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E236610E143;
...
Subject: [Freedreno] [PATCH v2 1/2] drm/msm/a6xx: Add support for a new 7c3
 sku
