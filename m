...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ACF3D563A52
	for <lists+freedreno@lfdr.de>; Fri,  1 Jul 2022 22:08:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 39BFC14A7E2;
...
Cc: freedreno@lists.freedesktop.org, krzysztof.kozlowski+dt@linaro.org,
 ...
 daniel@ffwll.ch, dmitry.baryshkov@linaro.org, bjorn.andersson@linaro.org,
 sean@poorly.run
