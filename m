...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B36F9507748
	for <lists+freedreno@lfdr.de>; Tue, 19 Apr 2022 20:12:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 228CF10EF08;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.17 19/34] drm/msm: Stop using
 iommu_present()
