...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 468F84DA612
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 00:12:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2537210E40C;
...
Subject: [Freedreno] [PATCH v2 6/6] drm/malidp: pass possible_crtcs as
