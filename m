...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48E635FC4E6
	for <lists+freedreno@lfdr.de>; Wed, 12 Oct 2022 14:03:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15F7110E47F;
...
Subject: [Freedreno] [PATCH v8 08/15] drm/bridge: add psr support for panel
 bridge callbacks
