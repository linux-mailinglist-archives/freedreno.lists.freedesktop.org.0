...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7199D748DD9
	for <lists+freedreno@lfdr.de>; Wed,  5 Jul 2023 21:32:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9932310E3B7;
...
Subject: [Freedreno] [PATCH v2 4/5] drm/msm/dpu: Remove redundant
