...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4291C3B4FA5
	for <lists+freedreno@lfdr.de>; Sat, 26 Jun 2021 18:52:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A351B6E0C5;
...
Subject: [Freedreno] [v8 4/6] drm/panel-simple: Update validation warnings
 for eDP panel description
