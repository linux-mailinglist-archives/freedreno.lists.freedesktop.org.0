...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7044C784887
	for <lists+freedreno@lfdr.de>; Tue, 22 Aug 2023 19:42:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 582E210E3BF;
...
Subject: [Freedreno] [PATCH v4 3/4] drm/msm/dsi: Add DATABUS_WIDEN MDP_CTRL2
 bit
