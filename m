...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E84C3DE96F
	for <lists+freedreno@lfdr.de>; Tue,  3 Aug 2021 11:07:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 120586E839;
...
Subject: [Freedreno] [PATCH v2 11/14] drm/tilcdc: Convert to Linux IRQ
 interfaces
