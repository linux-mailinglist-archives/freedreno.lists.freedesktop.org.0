...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF83B54CECC
	for <lists+freedreno@lfdr.de>; Wed, 15 Jun 2022 18:35:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7AD5310ED59;
...
Subject: [Freedreno] [PATCH] drm/msm: Fix %d vs %u
