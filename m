...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 978C63D84FF
	for <lists+freedreno@lfdr.de>; Wed, 28 Jul 2021 03:02:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D6696EBFB;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v4 03/13] drm/msm: drop
