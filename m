...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E194E6784B4
	for <lists+freedreno@lfdr.de>; Mon, 23 Jan 2023 19:25:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8834910E541;
...
Subject: [Freedreno] [PATCH v1 10/14] drm/msm/disp/dpu: add supports of DSC
 encoder v1.2 engine
