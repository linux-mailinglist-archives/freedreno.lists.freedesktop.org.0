...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB2DC70E5CA
	for <lists+freedreno@lfdr.de>; Tue, 23 May 2023 21:39:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B64BD10E4B6;
...
Subject: [Freedreno] [PATCH v5 0/2] enable HDP plug/unpulg interrupts at
 hpd_enable/disable
