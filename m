...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA640732300
	for <lists+freedreno@lfdr.de>; Fri, 16 Jun 2023 01:04:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3FA210E568;
...
Subject: Re: [Freedreno] [PATCH v2 06/22] drm/msm/dpu: simplify peer LM
 handling
