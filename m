...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 061A1618237
	for <lists+freedreno@lfdr.de>; Thu,  3 Nov 2022 16:18:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C4F10E67F;
...
Subject: [Freedreno] [PATCH v3 15/23] drm/fb-helper: Disconnect damage
