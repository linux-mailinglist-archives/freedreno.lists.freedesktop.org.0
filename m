...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CD49705A7D
	for <lists+freedreno@lfdr.de>; Wed, 17 May 2023 00:20:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 079B910E378;
...
Subject: [Freedreno] [PATCH v4 1/2] iommu/arm-smmu-qcom: Fix missing
 adreno_smmu's
