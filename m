...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6001A2F3A2A
	for <lists+freedreno@lfdr.de>; Tue, 12 Jan 2021 20:26:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B78889F19;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v2 5/7] drm/msm/dpu: Disable autorefresh in
 command mode
