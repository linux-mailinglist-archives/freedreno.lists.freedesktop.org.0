...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA0AC7B0DAB
	for <lists+freedreno@lfdr.de>; Wed, 27 Sep 2023 22:54:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6080C10E5B6;
...
Subject: [Freedreno] [PATCH v4 4/8] drm/msm/dp: move parser->parse() and
