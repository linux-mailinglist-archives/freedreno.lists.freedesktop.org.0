...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5FA56EEA8E
	for <lists+freedreno@lfdr.de>; Wed, 26 Apr 2023 01:06:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6032210E82C;
...
X-Mailer: b4 0.12.2
Subject: [Freedreno] [PATCH v3 09/21] drm/msm/dpu: Sort INTF registers
 numerically
