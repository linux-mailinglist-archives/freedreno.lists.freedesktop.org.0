...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FAD44DB753
	for <lists+freedreno@lfdr.de>; Wed, 16 Mar 2022 18:37:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 287BA10E8E8;
...
Subject: [Freedreno] [PATCH v5 6/9] drm/msm/dp: wait for hpd high before any
 sink interaction
