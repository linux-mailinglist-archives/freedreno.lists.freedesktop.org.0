...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AAFA34DA19
	for <lists+freedreno@lfdr.de>; Tue, 30 Mar 2021 00:22:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B74F6E527;
...
Subject: [Freedreno] [PATCH AUTOSEL 5.11 18/38] drm/msm: Ratelimit
