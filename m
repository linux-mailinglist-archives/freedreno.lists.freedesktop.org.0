...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 196986799A5
	for <lists+freedreno@lfdr.de>; Tue, 24 Jan 2023 14:40:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29F5210E6DB;
...
Subject: [Freedreno] [PATCH v2 07/10] drm/fbdev-generic: Minimize hotplug
 error handling
