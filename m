...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A65C4F6D37
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 23:46:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD8D010E626;
...
Subject: [Freedreno] [PATCH v3 04/10] drm/msm/gem: Split out inuse helper
