...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C48364F5A2B
	for <lists+freedreno@lfdr.de>; Wed,  6 Apr 2022 11:41:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BD0F10F2A9;
...
Subject: [Freedreno] [PATCH v7 06/14] drm/msm/disp/dpu1: Add DSC support in
 hw_ctl
