...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EBF7C6DFE71
	for <lists+freedreno@lfdr.de>; Wed, 12 Apr 2023 21:10:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F332410E93A;
	Wed, 12 Apr 2023 19:10:04 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v5 2/8] drm/msm: Add MSM-specific DSC helper
 methods
