...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BECF70D021
	for <lists+freedreno@lfdr.de>; Tue, 23 May 2023 03:09:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2592D10E3BD;
...
Subject: [Freedreno] [PATCH v5 3/5] drm/msm/dpu: Add DPU_INTF_DATA_COMPRESS
 feature flag for DPU >= 7.0
