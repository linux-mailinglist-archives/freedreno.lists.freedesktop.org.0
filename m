...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD50367D551
	for <lists+freedreno@lfdr.de>; Thu, 26 Jan 2023 20:26:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 661BD10E021;
...
Subject: Re: [Freedreno] [PATCH v2 01/27] drm/msm/dpu: set pdpu->is_rt_pipe
