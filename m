...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 258C15859C4
	for <lists+freedreno@lfdr.de>; Sat, 30 Jul 2022 11:41:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A1BC10EDA6;
...
Subject: [Freedreno] [PATCH v3 5/8] drm/msm/a6xx: Ensure CX collapse during
 gpu recovery
...
Cc: Philipp Zabel <p.zabel@pengutronix.de>, Jonathan Marek <jonathan@marek.ca>,
 ...
 Matthias
 Kaehlcke <mka@chromium.org>, Daniel Vetter <daniel@ffwll.ch>, Dmitry
