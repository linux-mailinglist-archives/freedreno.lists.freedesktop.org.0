...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00FD258F5E5
	for <lists+freedreno@lfdr.de>; Thu, 11 Aug 2022 04:31:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE2FD18A936;
	Thu, 11 Aug 2022 02:31:36 +0000 (UTC)
...
Subject: Re: [Freedreno] [PATCH v3] drm/msm: Make .remove and .shutdown HW
 shutdown consistent
