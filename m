...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 70CA069D4BF
	for <lists+freedreno@lfdr.de>; Mon, 20 Feb 2023 21:19:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6485E10E7A9;
	Mon, 20 Feb 2023 20:19:40 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v5 12/14] drm/msm: Add deadline based boost
 support
