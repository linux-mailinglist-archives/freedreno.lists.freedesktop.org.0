...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD52164F185
	for <lists+freedreno@lfdr.de>; Fri, 16 Dec 2022 20:12:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 642FA10E61A;
...
Subject: [Freedreno] [PATCH v14 0/5] Add data-lanes and link-frequencies to
 dp_out endpoint
