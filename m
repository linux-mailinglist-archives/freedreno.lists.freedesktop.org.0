...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46EE94A784F
	for <lists+freedreno@lfdr.de>; Wed,  2 Feb 2022 19:57:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B715A10E3C0;
...
Subject: [Freedreno] [PATCH v3 2/3] drm/msm/dp: enhance debug info related
 to dp phy
