...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 08B866FE775
	for <lists+freedreno@lfdr.de>; Thu, 11 May 2023 00:46:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBBC910E576;
...
Subject: [Freedreno] [PATCH v8 3/8] drm/msm/dsi: use DRM DSC helpers for DSC
 setup
