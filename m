...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D24F6E5171
	for <lists+freedreno@lfdr.de>; Mon, 17 Apr 2023 22:12:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9885B10E5CC;
...
Subject: [Freedreno] [RFC 3/3] drm/msm: Add comm/cmdline fields
