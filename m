...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 35EBD7247DA
	for <lists+freedreno@lfdr.de>; Tue,  6 Jun 2023 17:35:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECF7A10E377;
...
Subject: Re: [Freedreno] [PATCH v8 05/18] drm/msm/a6xx: Move
