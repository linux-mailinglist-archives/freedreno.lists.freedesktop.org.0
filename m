...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GMekIVECq2msZQEAu9opvQ
	(envelope-from <freedreno-bounces@lists.freedesktop.org>)
	for <lists+freedreno@lfdr.de>; Fri, 06 Mar 2026 17:35:29 +0100
X-Original-To: lists+freedreno@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D22522520C
	for <lists+freedreno@lfdr.de>; Fri, 06 Mar 2026 17:35:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F155110EDC4;
...
X-Spamd-Result: default: False [1.99 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[qualcomm.com:email,lists.freedesktop.org:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,igalia.com:mid,igalia.com:email]
