...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E35D314254F
	for <lists+freedreno@lfdr.de>; Mon, 20 Jan 2020 09:24:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BDC66FA5A;
...
MIME-Version: 1.0
Subject: [Freedreno] [PATCH v3 15/22] drm/stm: Convert to CRTC VBLANK
 callbacks
