...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CCCEE4A612B
	for <lists+freedreno@lfdr.de>; Tue,  1 Feb 2022 17:16:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DFBC10E6D3;
...
Subject: [Freedreno] [PATCH v2 1/2] drm/msm/gpu: Add ctx to get_param()
...
Cc: Rob Clark <robdclark@chromium.org>, Jonathan Marek <jonathan@marek.ca>,
 ...
 Daniel Vetter <daniel@ffwll.ch>, Yiwei Zhang <zzyiwei@chromium.org>,
