...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DC6575BD8B
	for <lists+freedreno@lfdr.de>; Mon,  1 Jul 2019 16:03:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84F4689C07;
...
Subject: Re: [Freedreno] [PATCH 1/4] dt-bindings: chosen: document panel-id
 binding
