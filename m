...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6FFC9AEEC
	for <lists+freedreno@lfdr.de>; Fri, 23 Aug 2019 14:16:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 737F16EC7E;
...
Subject: [Freedreno] [PATCH v7 2/7] dt-bindings: display: msm: gmu: add
