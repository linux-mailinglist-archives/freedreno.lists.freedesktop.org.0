...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8A2142CBA3
	for <lists+freedreno@lfdr.de>; Wed, 13 Oct 2021 22:49:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 701F46EB2E;
...
Subject: [Freedreno] [PATCH v4 08/20] drm/radeon: cleanup:
