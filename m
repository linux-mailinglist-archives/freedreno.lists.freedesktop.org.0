...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8A7D57A4D3
	for <lists+freedreno@lfdr.de>; Tue, 19 Jul 2022 19:18:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 746DC90F80;
	Tue, 19 Jul 2022 17:18:46 +0000 (UTC)
...
Subject: [Freedreno] [PATCH v2 02/13] drm/msm: Small submit cleanup
