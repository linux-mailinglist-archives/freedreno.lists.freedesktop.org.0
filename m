...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F8722E8CD6
	for <lists+freedreno@lfdr.de>; Sun,  3 Jan 2021 16:25:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A894899DE;
...
Subject: [Freedreno] [PATCH 25/31] memory: tegra30: convert to use
 devm_pm_opp_* API
